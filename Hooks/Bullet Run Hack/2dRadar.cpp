...
#include "Framework\UE3\2DRadar.h"

int Radar::calcdist(FVector v1,FVector v2)
{
	FVector v;
	v.X = v1.X - v2.X;
	v.Y = v1.Y - v2.Y;
...
FVector2D Radar::CalculateRadarCoordinate( FVector Location, FLOAT RadarX, FLOAT RadarY)
{
	FVector2D Return;
...
void inline Radar::DrawRadar( PawnInfo Pawn, UCanvas* Canvas, FColor Color ) 
{
