...
FColor CRender::MakeColor(int R, int G, int B, int A)
{
...
void CRender::DrawString( DrawUtils* pCanvas, float X, float Y, const FColor& Color, bool Center, wchar_t* String )
{
...
void CRender::DrawStringEx( DrawUtils* Canvas, float X, float Y, const FColor& Color, bool Center, wchar_t* String, ... )
{
...
void CRender::DrawRect( DrawUtils* Canvas, float X, float Y, float W, float H, const FLinearColor& Color )
{
	Canvas->CurX = X;
	Canvas->CurY = Y;
...
void CRender::DrawBox( DrawUtils* Canvas, float X, float Y, float W, float H, const FLinearColor& Color )
{
...
void CRender::DrawGradientBox(DrawUtils* pCanvas, float x, float y, float width, float height, FColor& Color, int SharpnessR, int SharpnessG, int SharpnessB)
{
