...
public:
	...
	static void ESP::Name(UCanvas* Canvas, PawnInfo Pawn, FColor DrawColor)
	{
		CRender::DrawString( Canvas, Pawn.ScreenPos.X, Pawn.ScreenPos.Y-50, DrawColor, true, Pawn.Rpi->PlayerName.Data );
	}

	static void ESP::Health(UCanvas* Canvas, PawnInfo Pawn, FColor DrawColor)
	{
		CRender::DrawStringEx( Canvas,  Pawn.ScreenPos.X, Pawn.ScreenPos.Y-50, DrawColor, 0, L"H: %i", Pawn.Pawn->Health );
	}

	static void ESP::Distance(UCanvas* Canvas, PawnInfo Pawn, FColor DrawColor)
	{
	...
	static void ESP::Boxes(UCanvas* pCanvas, PawnInfo Pawn, FColor Color)
	{
		//Valid Target Checks Here
		{
			...
			FBox Returned;
			Pawn.Pawn->GetComponentsBoundingBox(&Returned);
	...
	//static void ESP::BoneESP(UCanvas* Canvas, PawnInfo Pawn, FColor cColor)
	//{
	//	if(Target->Mesh != NULL)
	//	{
	//		if(strcmp(Pawn.Pawn->Mesh->GetBoneName(35).GetName(), "b_Head"))
	//		{
	//			BoneMESP(Canvas, Pawn, cColor);
	//		}
	//		else if(strcmp(Pawn.Pawn->Mesh->GetBoneName(14).GetName(), "b_Head"))
	//		{
	//			BoneFESP(Canvas, Pawn, cColor);
	//		}
	//	}
	//}
