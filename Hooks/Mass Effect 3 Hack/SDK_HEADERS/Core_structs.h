...
struct FBioRawDistributionRwVector3Base
{
	...
	TArray< struct FRwVector3 >                        LookupTable;                                      		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class UDistributionVector*                         Distribution;                                     		// 0x0020 (0x0004) [0x0000000006080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_NoClear | CPF_EditInline )
};
