...
struct FTimerData
{
	...
	float                                              Count;                                            		// 0x000C (0x0004) [0x0000000000000000]              
	float                                              TimerTimeDilation;                                		// 0x0010 (0x0004) [0x0000000000000000]              
	class UObject*                                     TimerObj;                                         		// 0x0014 (0x0004) [0x0000000000000000]              
	unsigned long                                      bLoop : 1;                                        		// 0x0018 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bPaused : 1;                                      		// 0x0018 (0x0004) [0x0000000000000000] [0x00000002] 
};
...
{
	struct FName                                       BoneName;                                         		// 0x0000 (0x0008) [0x0000000000100000]              
	class UMaterial*                                   Material;                                         		// 0x0008 (0x0004) [0x0000000000100000]              
	class UPhysicalMaterial*                           PhysMaterial;                                     		// 0x000C (0x0004) [0x0000000000100000]              
...
struct FImpactInfo
{
	struct FTraceHitInfo                               HitInfo;                                          		// 0x0000 (0x001C) [0x0000000000180000]              ( CPF_Component )
	struct FVector                                     HitLocation;                                      		// 0x001C (0x000C) [0x0000000000100000]              
	struct FVector                                     HitNormal;                                        		// 0x0028 (0x000C) [0x0000000000100000]              
	struct FVector                                     RayDir;                                           		// 0x0034 (0x000C) [0x0000000000100000]              
	struct FVector                                     StartTrace;                                       		// 0x0040 (0x000C) [0x0000000000100000]              
	class AActor*                                      HitActor;                                         		// 0x004C (0x0004) [0x0000000000100000]              
	float                                              PenetrationDepth;                                 		// 0x0050 (0x0004) [0x0000000000100000]              
};
...
{
	TArray< float >                                    ChannelWeights;                                   		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FName                                       SlotName;                                         		// 0x000C (0x0008) [0x0000000000100000]              
};
...
struct FBasedPosition
{
	...
	class AActor*                                      Base;                                             		// 0x0030 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FNavReference
{
	...
	class ANavigationPoint*                            Nav;                                              		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FSeqOpInputLink
{
	...
	struct FName                                       LinkAction;                                       		// 0x000C (0x0008) [0x0000000000000000]              
	int                                                QueuedActivations;                                		// 0x0014 (0x0004) [0x0000000000000000]              
	class USequenceOp*                                 LinkedOp;                                         		// 0x0018 (0x0004) [0x0000000000000000]              
	unsigned long                                      bHasImpulse : 1;                                  		// 0x001C (0x0004) [0x0000000000000000] [0x00000001] 
...
{
	struct FGuid                                       Guid;                                             		// 0x0000 (0x0010) [0x0000000000020003]              ( CPF_Edit | CPF_Const | CPF_EditConst )
	class AActor*                                      Actor;                                            		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	struct FString                                     PlayerName;                                       		// 0x0000 (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FKeyValuePair >                     PlayerInfo;                                       		// 0x000C (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                PlayerNum;                                        		// 0x0018 (0x0004) [0x0000000000100001]              ( CPF_Edit )
	int                                                PlayerID;                                         		// 0x001C (0x0004) [0x0000000000100001]              ( CPF_Edit )
	int                                                Ping;                                             		// 0x0020 (0x0004) [0x0000000000100001]              ( CPF_Edit )
	int                                                Score;                                            		// 0x0024 (0x0004) [0x0000000000100001]              ( CPF_Edit )
	int                                                StatsID;                                          		// 0x0028 (0x0004) [0x0000000000100001]              ( CPF_Edit )
};
...
{
	struct FString                                     IP;                                               		// 0x0000 (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     ServerName;                                       		// 0x000C (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     MapName;                                          		// 0x0018 (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     GameType;                                         		// 0x0024 (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FKeyValuePair >                     ServerInfo;                                       		// 0x0030 (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FPlayerResponseLine >               PlayerInfo;                                       		// 0x003C (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                ServerID;                                         		// 0x0048 (0x0004) [0x0000000000100001]              ( CPF_Edit )
	int                                                Port;                                             		// 0x004C (0x0004) [0x0000000000100001]              ( CPF_Edit )
	int                                                QueryPort;                                        		// 0x0050 (0x0004) [0x0000000000100001]              ( CPF_Edit )
	int                                                CurrentPlayers;                                   		// 0x0054 (0x0004) [0x0000000000100001]              ( CPF_Edit )
	int                                                MaxPlayers;                                       		// 0x0058 (0x0004) [0x0000000000100001]              ( CPF_Edit )
	int                                                Ping;                                             		// 0x005C (0x0004) [0x0000000000100001]              ( CPF_Edit )
};
...
struct FTViewTarget
{
	...
	class AActor*                                      Target;                                           		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AController*                                 Controller;                                       		// 0x0020 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
	struct FLUTBlender                                 ColorGradingLUT;                                  		// 0x0000 (0x0018) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FLinearColor                                RimShader_Color;                                  		// 0x0018 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DOF_FocusPosition;                                		// 0x0028 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     Scene_HighLights;                                 		// 0x0034 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     Scene_MidTones;                                   		// 0x0040 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     Scene_Shadows;                                    		// 0x004C (0x000C) [0x0000000000000001]              ( CPF_Edit )
	float                                              Bloom_Scale;                                      		// 0x0058 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Bloom_Threshold;                                  		// 0x005C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      Bloom_Tint;                                       		// 0x0060 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Bloom_ScreenBlendThreshold;                       		// 0x0064 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Bloom_InterpolationDuration;                      		// 0x0068 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DOF_FalloffExponent;                              		// 0x006C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DOF_BlurKernelSize;                               		// 0x0070 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DOF_BlurBloomKernelSize;                          		// 0x0074 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DOF_MaxNearBlurAmount;                            		// 0x0078 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DOF_MaxFarBlurAmount;                             		// 0x007C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      DOF_ModulateBlurColor;                            		// 0x0080 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DOF_FocusInnerRadius;                             		// 0x0084 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DOF_FocusDistance;                                		// 0x0088 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DOF_InterpolationDuration;                        		// 0x008C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MotionBlur_MaxVelocity;                           		// 0x0090 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MotionBlur_Amount;                                		// 0x0094 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MotionBlur_CameraRotationThreshold;               		// 0x0098 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MotionBlur_CameraTranslationThreshold;            		// 0x009C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MotionBlur_InterpolationDuration;                 		// 0x00A0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Scene_Desaturation;                               		// 0x00A4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Scene_InterpolationDuration;                      		// 0x00A8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              RimShader_InterpolationDuration;                  		// 0x00AC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UTexture*                                    ColorGrading_LookupTable;                         		// 0x00B0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              PP_DesaturationMultiplier;                        		// 0x00B4 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              PP_HighlightsMultiplier;                          		// 0x00B8 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              PP_MidTonesMultiplier;                            		// 0x00BC (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              PP_ShadowsMultiplier;                             		// 0x00C0 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned long                                      bOverride_EnableBloom : 1;                        		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bOverride_EnableDOF : 1;                          		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bOverride_EnableMotionBlur : 1;                   		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bOverride_EnableSceneEffect : 1;                  		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bOverride_AllowAmbientOcclusion : 1;              		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bOverride_OverrideRimShaderColor : 1;             		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bOverride_Bloom_Scale : 1;                        		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bOverride_Bloom_Threshold : 1;                    		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bOverride_Bloom_Tint : 1;                         		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bOverride_Bloom_ScreenBlendThreshold : 1;         		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bOverride_Bloom_InterpolationDuration : 1;        		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bOverride_DOF_FalloffExponent : 1;                		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bOverride_DOF_BlurKernelSize : 1;                 		// 0x00C4 (0x0004) [0x0000000000000000] [0x00001000] 
	unsigned long                                      bOverride_DOF_BlurBloomKernelSize : 1;            		// 0x00C4 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bOverride_DOF_MaxNearBlurAmount : 1;              		// 0x00C4 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bOverride_DOF_MaxFarBlurAmount : 1;               		// 0x00C4 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bOverride_DOF_ModulateBlurColor : 1;              		// 0x00C4 (0x0004) [0x0000000000000000] [0x00010000] 
	unsigned long                                      bOverride_DOF_FocusType : 1;                      		// 0x00C4 (0x0004) [0x0000000000000000] [0x00020000] 
	unsigned long                                      bOverride_DOF_FocusInnerRadius : 1;               		// 0x00C4 (0x0004) [0x0000000000000000] [0x00040000] 
	unsigned long                                      bOverride_DOF_FocusDistance : 1;                  		// 0x00C4 (0x0004) [0x0000000000000000] [0x00080000] 
	unsigned long                                      bOverride_DOF_FocusPosition : 1;                  		// 0x00C4 (0x0004) [0x0000000000000000] [0x00100000] 
	unsigned long                                      bOverride_DOF_InterpolationDuration : 1;          		// 0x00C4 (0x0004) [0x0000000000000000] [0x00200000] 
	unsigned long                                      bOverride_MotionBlur_MaxVelocity : 1;             		// 0x00C4 (0x0004) [0x0000000000000000] [0x00400000] 
	unsigned long                                      bOverride_MotionBlur_Amount : 1;                  		// 0x00C4 (0x0004) [0x0000000000000000] [0x00800000] 
	unsigned long                                      bOverride_MotionBlur_FullMotionBlur : 1;          		// 0x00C4 (0x0004) [0x0000000000000000] [0x01000000] 
	unsigned long                                      bOverride_MotionBlur_CameraRotationThreshold : 1; 		// 0x00C4 (0x0004) [0x0000000000000000] [0x02000000] 
	unsigned long                                      bOverride_MotionBlur_CameraTranslationThreshold : 1;		// 0x00C4 (0x0004) [0x0000000000000000] [0x04000000] 
	unsigned long                                      bOverride_MotionBlur_InterpolationDuration : 1;   		// 0x00C4 (0x0004) [0x0000000000000000] [0x08000000] 
	unsigned long                                      bOverride_Scene_Desaturation : 1;                 		// 0x00C4 (0x0004) [0x0000000000000000] [0x10000000] 
	unsigned long                                      bOverride_Scene_HighLights : 1;                   		// 0x00C4 (0x0004) [0x0000000000000000] [0x20000000] 
	unsigned long                                      bOverride_Scene_MidTones : 1;                     		// 0x00C4 (0x0004) [0x0000000000000000] [0x40000000] 
	unsigned long                                      bOverride_Scene_Shadows : 1;                      		// 0x00C4 (0x0004) [0x0000000000000000] [0x80000000] 
	unsigned long                                      bOverride_Scene_InterpolationDuration : 1;        		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bOverride_RimShader_Color : 1;                    		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bOverride_RimShader_InterpolationDuration : 1;    		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bEnableBloom : 1;                                 		// 0x00C8 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bEnableDOF : 1;                                   		// 0x00C8 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bEnableMotionBlur : 1;                            		// 0x00C8 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bEnableSceneEffect : 1;                           		// 0x00C8 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
	unsigned long                                      bAllowAmbientOcclusion : 1;                       		// 0x00C8 (0x0004) [0x0000000000000001] [0x00000080] ( CPF_Edit )
	unsigned long                                      bOverrideRimShaderColor : 1;                      		// 0x00C8 (0x0004) [0x0000000000000001] [0x00000100] ( CPF_Edit )
	unsigned long                                      bOverride_EnableFilmic : 1;                       		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bEnableFilmic : 1;                                		// 0x00C8 (0x0004) [0x0000000000000001] [0x00000400] ( CPF_Edit )
	unsigned long                                      bOverride_EnableVignette : 1;                     		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bEnableVignette : 1;                              		// 0x00C8 (0x0004) [0x0000000000000001] [0x00001000] ( CPF_Edit )
	unsigned long                                      bOverride_EnableFilmGrain : 1;                    		// 0x00C8 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bEnableFilmGrain : 1;                             		// 0x00C8 (0x0004) [0x0000000000000001] [0x00004000] ( CPF_Edit )
	unsigned long                                      MotionBlur_FullMotionBlur : 1;                    		// 0x00C8 (0x0004) [0x0000000000000001] [0x00008000] ( CPF_Edit )
	unsigned char                                      DOF_FocusType;                                    		// 0x00CC (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FSeqOpOutputLink
{
	...
	struct FName                                       LinkAction;                                       		// 0x0018 (0x0008) [0x0000000000000000]              
	class USequenceOp*                                 LinkedOp;                                         		// 0x0020 (0x0004) [0x0000000000000000]              
...
struct FSeqVarLink
{
	TArray< class USequenceVariable* >                 LinkedVariables;                                  		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     LinkDesc;                                         		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UClass*                                      ExpectedType;                                     		// 0x0018 (0x0004) [0x0000000000000000]              
	struct FName                                       LinkVar;                                          		// 0x001C (0x0008) [0x0000000000000000]              
	struct FName                                       PropertyName;                                     		// 0x0024 (0x0008) [0x0000000000000000]              
	int                                                MinVars;                                          		// 0x002C (0x0004) [0x0000000000000000]              
	int                                                MaxVars;                                          		// 0x0030 (0x0004) [0x0000000000000000]              
	class UProperty*                                   CachedProperty;                                   		// 0x0034 (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	unsigned long                                      bWriteable : 1;                                   		// 0x0038 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bModifiesLinkedObject : 1;                        		// 0x0038 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bAllowAnyType : 1;                                		// 0x0038 (0x0004) [0x0000000000000000] [0x00000004] 
};
...
struct FOnlineFriendMessage
{
	...
	unsigned long                                      bIsFriendInvite : 1;                              		// 0x0020 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bIsGameInvite : 1;                                		// 0x0020 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bWasAccepted : 1;                                 		// 0x0020 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bWasDenied : 1;                                   		// 0x0020 (0x0004) [0x0000000000000000] [0x00000008] 
};
...
{
	struct FString                                     InterfaceClassName;                               		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       InterfaceName;                                    		// 0x000C (0x0008) [0x0000000000000000]              
};
...
{
	TArray< struct FOnlineRegistrant >                 Registrants;                                      		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FOnlineArbitrationRegistrant >      ArbitrationRegistrants;                           		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FPointer                                    SessionInfo;                                      		// 0x0018 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	struct FName                                       SessionName;                                      		// 0x001C (0x0008) [0x0000000000000000]              
	class UOnlineGameSettings*                         GameSettings;                                     		// 0x0024 (0x0004) [0x0000000000000000]              
};
...
{
	struct FPointer                                    Value2;                                           		// 0x0000 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
...
{
	struct FSettingsData                               Data;                                             		// 0x0000 (0x000C) [0x0000000000000000]              
...
{
	TArray< struct FSettingsProperty >                 MetadataItems;                                    		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                ContentType;                                      		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FOnlinePartyMember
{
	...
	struct FPointer                                    SessionInfo;                                      		// 0x0024 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	...
	unsigned char                                      LocalUserNum;                                     		// 0x0030 (0x0001) [0x0000000000000002]              ( CPF_Const )
	unsigned char                                      NatType;                                          		// 0x0031 (0x0001) [0x0000000000000002]              ( CPF_Const )
};
...
{
	struct FString                                     AchievementName;                                  		// 0x0000 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     Description;                                      		// 0x000C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     HowTo;                                            		// 0x0018 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	int                                                Id;                                               		// 0x0024 (0x0004) [0x0000000000000002]              ( CPF_Const )
...
struct FCommunityContentFile
{
	...
	struct FString                                     LocalFilePath;                                    		// 0x0008 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                ContentId;                                        		// 0x0014 (0x0004) [0x0000000000000000]              
	int                                                FileId;                                           		// 0x0018 (0x0004) [0x0000000000000000]              
	int                                                ContentType;                                      		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                FileSize;                                         		// 0x0020 (0x0004) [0x0000000000000000]              
...
struct FTitleFile
{
	...
	unsigned char                                      AsyncState;                                       		// 0x0018 (0x0001) [0x0000000000000000]              
};
...
struct FOnlineContent
{
	...
	struct FString                                     ContentPath;                                      		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           ContentPackages;                                  		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           ContentFiles;                                     		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FOnlineFriend
{
	...
	unsigned long                                      bIsOnline : 1;                                    		// 0x0028 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
	unsigned long                                      bIsPlaying : 1;                                   		// 0x0028 (0x0004) [0x0000000000000002] [0x00000002] ( CPF_Const )
	unsigned long                                      bIsPlayingThisGame : 1;                           		// 0x0028 (0x0004) [0x0000000000000002] [0x00000004] ( CPF_Const )
	unsigned long                                      bIsJoinable : 1;                                  		// 0x0028 (0x0004) [0x0000000000000002] [0x00000008] ( CPF_Const )
	unsigned long                                      bHasVoiceSupport : 1;                             		// 0x0028 (0x0004) [0x0000000000000002] [0x00000010] ( CPF_Const )
	unsigned long                                      bHaveInvited : 1;                                 		// 0x0028 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bHasInvitedYou : 1;                               		// 0x0028 (0x0004) [0x0000000000000002] [0x00000040] ( CPF_Const )
	unsigned char                                      FriendState;                                      		// 0x002C (0x0001) [0x0000000000000002]              ( CPF_Const )
};
...
{
	struct FString                                     DebugText;                                        		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FVector                                     SrcActorOffset;                                   		// 0x000C (0x000C) [0x0000000000000000]              
	struct FVector                                     SrcActorDesiredOffset;                            		// 0x0018 (0x000C) [0x0000000000000000]              
	class AActor*                                      SrcActor;                                         		// 0x0024 (0x0004) [0x0000000000000000]              
...
{
	class AActor*                                      Attachment;                                       		// 0x0000 (0x0004) [0x0000000000000000]              
	struct FVector                                     RelativeOffset;                                   		// 0x0004 (0x000C) [0x0000000000000000]              
	struct FRotator                                    RelativeRotation;                                 		// 0x0010 (0x000C) [0x0000000000000000]              
	struct FName                                       BoneName;                                         		// 0x001C (0x0008) [0x0000000000000000]              
	unsigned long                                      bDetach : 1;                                      		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bHardAttach : 1;                                  		// 0x0024 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bUseRelativeOffset : 1;                           		// 0x0024 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bUseRelativeRotation : 1;                         		// 0x0024 (0x0004) [0x0000000000000000] [0x00000008] 
};
...
struct FAnimBlendChild
{
	...
	float                                              BlendWeight;                                      		// 0x002C (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	int                                                bHasRootMotion;                                   		// 0x0030 (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	class UAnimNode*                                   Anim;                                             		// 0x0034 (0x0004) [0x0000000004400008]              ( CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	unsigned long                                      bMirrorSkeleton : 1;                              		// 0x0038 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bIsAdditive : 1;                                  		// 0x0038 (0x0004) [0x0000000000000000] [0x00000002] 
};
...
{
	class AActor*                                      ActorToReBase;                                    		// 0x0000 (0x0004) [0x0000000000000000]              
	class AActor*                                      NewBase;                                          		// 0x0004 (0x0004) [0x0000000000000000]              
	class USkeletalMeshComponent*                      SkelComponent;                                    		// 0x0008 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FVector                                     NewFloor;                                         		// 0x000C (0x000C) [0x0000000000000000]              
	struct FName                                       AttachName;                                       		// 0x0018 (0x0008) [0x0000000000000000]              
	unsigned long                                      bNotifyActor : 1;                                 		// 0x0020 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FClientAdjustment
{
	...
	class AActor*                                      NewBase;                                          		// 0x0028 (0x0004) [0x0000000000000000]              
	unsigned char                                      newPhysics;                                       		// 0x002C (0x0001) [0x0000000000000000]              
	unsigned char                                      bAckGoodMove;                                     		// 0x002D (0x0001) [0x0000000000000000]              
	unsigned char                                      bWarning;                                         		// 0x002E (0x0001) [0x0000000000000000]              
};
...
struct FInputMatchRequest
{
	...
	struct FScriptDelegate                             MatchDelegate;                                    		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       MatchFuncName;                                    		// 0x0018 (0x0008) [0x0000000000000000]              
	struct FName                                       FailedFuncName;                                   		// 0x0020 (0x0008) [0x0000000000000000]              
	struct FName                                       RequestName;                                      		// 0x0028 (0x0008) [0x0000000000000000]              
	class AActor*                                      MatchActor;                                       		// 0x0030 (0x0004) [0x0000000000000000]              
...
struct FKismetDrawTextInfo
{
	...
	struct FVector2D                                   MessageFontScale;                                 		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FVector2D                                   MessageOffset;                                    		// 0x0014 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UFont*                                       MessageFont;                                      		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
	struct FString                                     StringMessage;                                    		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UClass*                                      Message;                                          		// 0x000C (0x0004) [0x0000000000000000]              
	...
	class UObject*                                     OptionalObject;                                   		// 0x0038 (0x0004) [0x0000000000000000]              
	unsigned long                                      Drawn : 1;                                        		// 0x003C (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	struct FPointer                                    PlatformData;                                     		// 0x0000 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	class UOnlineGameSettings*                         GameSettings;                                     		// 0x0004 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	struct FPointer                                    OctreeNode;                                       		// 0x0000 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	struct FBox                                        BoundingBox;                                      		// 0x0004 (0x001C) [0x0000000000000000]              
	struct FVector                                     BoxCenter;                                        		// 0x0020 (0x000C) [0x0000000000000000]              
...
struct FAnimNotifyEvent
{
	...
	class UAnimNotify*                                 Notify;                                           		// 0x0010 (0x0004) [0x0000000004400009]              ( CPF_Edit | CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	unsigned long                                      bIgnoreWeightThreshold : 1;                       		// 0x0014 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
{
	TArray< struct FTimeModifier >                     Modifiers;                                        		// 0x0000 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
	struct FName                                       SkelControlName;                                  		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FCurveTrack
{
	TArray< float >                                    CurveWeights;                                     		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       CurveName;                                        		// 0x000C (0x0008) [0x0000000000000000]              
};
...
struct FWeightNodeRule
{
	...
	unsigned char                                      WeightCheck;                                      		// 0x0014 (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FPerBoneMaskInfo
{
	...
	TArray< struct FWeightRule >                       WeightRuleList;                                   		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< float >                                    PerBoneWeights;                                   		// 0x0018 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	TArray< unsigned char >                            TransformReqBone;                                 		// 0x0024 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	float                                              DesiredWeight;                                    		// 0x0030 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BlendTimeToGo;                                    		// 0x0034 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                TransformReqBoneIndex;                            		// 0x0038 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned long                                      bWeightBasedOnNodeRules : 1;                      		// 0x003C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bDisableForNonLocalHumanPlayers : 1;              		// 0x003C (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bPendingBlend : 1;                                		// 0x003C (0x0004) [0x0000000000002000] [0x00000004] ( CPF_Transient )
};
...
{
	TArray< struct FAimComponent >                     AimComponents;                                    		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       ProfileName;                                      		// 0x000C (0x0008) [0x0000000000020003]              ( CPF_Edit | CPF_Const | CPF_EditConst )
	struct FVector2D                                   HorizontalRange;                                  		// 0x0014 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FVector2D                                   VerticalRange;                                    		// 0x001C (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
struct FChildBoneBlendInfo
{
	...
	TArray< unsigned char >                            TargetRequiredBones;                              		// 0x000C (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	struct FName                                       InitTargetStartBone;                              		// 0x0018 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       OldStartBone;                                     		// 0x0020 (0x0008) [0x0000000000000002]              ( CPF_Const )
	float                                              InitPerBoneIncrease;                              		// 0x0028 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              OldBoneIncrease;                                  		// 0x002C (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	struct FAnimInfo                                   AnimInfo;                                         		// 0x0000 (0x0010) [0x0000000000000000]              
...
struct FSynchGroup
{
	...
	class UAnimNodeSequence*                           MasterNode;                                       		// 0x0014 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              RateScale;                                        		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bFireSlaveNotifies : 1;                           		// 0x001C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
struct FAnimGroup
{
	...
	struct FName                                       GroupName;                                        		// 0x000C (0x0008) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class UAnimNodeSequence*                           SynchMaster;                                      		// 0x0014 (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	class UAnimNodeSequence*                           NotifyMaster;                                     		// 0x0018 (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
...
{
	TArray< class UMorphTargetSet* >                   PreviewMorphSets;                                 		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FName                                       DisplayName;                                      		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class USkeletalMesh*                               PreviewSkelMesh;                                  		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	TArray< class UAnimSet* >                          PreviewAnimSets;                                  		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FName                                       DisplayName;                                      		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	TArray< struct FNxDestructibleDepthParameters >    DepthParameters;                                  		// 0x0000 (0x000C) [0x0000000000400041]              ( CPF_Edit | CPF_EditConstArray | CPF_NeedCtorLink )
	struct FBox                                        ValidBounds;                                      		// 0x000C (0x001C) [0x0000000000000001]              ( CPF_Edit )
	float                                              DamageThreshold;                                  		// 0x0028 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DamageToRadius;                                   		// 0x002C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DamageCap;                                        		// 0x0030 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ForceToDamage;                                    		// 0x0034 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ImpactVelocityThreshold;                          		// 0x0038 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DamageToPercentDeformation;                       		// 0x003C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DeformationPercentLimit;                          		// 0x0040 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                SupportDepth;                                     		// 0x0044 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                DebrisDepth;                                      		// 0x0048 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                EssentialDepth;                                   		// 0x004C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DebrisLifetimeMin;                                		// 0x0050 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DebrisLifetimeMax;                                		// 0x0054 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DebrisMaxSeparationMin;                           		// 0x0058 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DebrisMaxSeparationMax;                           		// 0x005C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxChunkSpeed;                                    		// 0x0060 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MassScaleExponent;                                		// 0x0064 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FNxDestructibleParametersFlag               Flags;                                            		// 0x0068 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              GrbVolumeLimit;                                   		// 0x006C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              GrbParticleSpacing;                               		// 0x0070 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              FractureImpulseScale;                             		// 0x0074 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bFormExtendedStructures : 1;                      		// 0x0078 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
struct FListener
{
	...
	class APortalVolume*                               PortalVolume;                                     		// 0x0030 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
struct FFontParameterValue
{
	...
	class UFont*                                       FontValue;                                        		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                FontPage;                                         		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FTextureParameterValue
{
	struct FGuid                                       ExpressionGUID;                                   		// 0x0000 (0x0010) [0x0000000000000000]              
	struct FName                                       ParameterName;                                    		// 0x0010 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UTexture*                                    ParameterValue;                                   		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FCameraShakeInstance
{
	...
	class UCameraShake*                                SourceShake;                                      		// 0x0058 (0x0004) [0x0000000000000000]              
	float                                              OscillatorTimeRemaining;                          		// 0x005C (0x0004) [0x0000000000000000]              
	float                                              CurrentBlendInTime;                               		// 0x0060 (0x0004) [0x0000000000000000]              
	float                                              CurrentBlendOutTime;                              		// 0x0064 (0x0004) [0x0000000000000000]              
	float                                              FOVSinOffset;                                     		// 0x0068 (0x0004) [0x0000000000000000]              
	float                                              Scale;                                            		// 0x006C (0x0004) [0x0000000000000000]              
	class UCameraAnimInst*                             AnimInst;                                         		// 0x0070 (0x0004) [0x0000000000000000]              
	unsigned long                                      bBlendingIn : 1;                                  		// 0x0074 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bBlendingOut : 1;                                 		// 0x0074 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned char                                      PlaySpace;                                        		// 0x0078 (0x0001) [0x0000000000000000]              
};
...
struct FFontImportOptionsData
{
	...
	struct FString                                     Chars;                                            		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     UnicodeRange;                                     		// 0x0018 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     CharsFilePath;                                    		// 0x0024 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     CharsFileWildcard;                                		// 0x0030 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FLinearColor                                ForegroundColor;                                  		// 0x003C (0x0010) [0x0000000000000001]              ( CPF_Edit )
	float                                              Height;                                           		// 0x004C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                TexturePageWidth;                                 		// 0x0050 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                TexturePageMaxHeight;                             		// 0x0054 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                XPadding;                                         		// 0x0058 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                YPadding;                                         		// 0x005C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                ExtendBoxTop;                                     		// 0x0060 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                ExtendBoxBottom;                                  		// 0x0064 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                ExtendBoxRight;                                   		// 0x0068 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                ExtendBoxLeft;                                    		// 0x006C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                Kerning;                                          		// 0x0070 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                DistanceFieldScaleFactor;                         		// 0x0074 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bEnableAntialiasing : 1;                          		// 0x0078 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bEnableBold : 1;                                  		// 0x0078 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bEnableItalic : 1;                                		// 0x0078 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bEnableUnderline : 1;                             		// 0x0078 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bAlphaOnly : 1;                                   		// 0x0078 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bCreatePrintableOnly : 1;                         		// 0x0078 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bIncludeASCIIRange : 1;                           		// 0x0078 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
	unsigned long                                      bEnableDropShadow : 1;                            		// 0x0078 (0x0004) [0x0000000000000001] [0x00000080] ( CPF_Edit )
	unsigned long                                      bEnableLegacyMode : 1;                            		// 0x0078 (0x0004) [0x0000000000000001] [0x00000100] ( CPF_Edit )
	unsigned long                                      bUseDistanceFieldAlpha : 1;                       		// 0x0078 (0x0004) [0x0000000000000001] [0x00000200] ( CPF_Edit )
	unsigned char                                      CharacterSet;                                     		// 0x007C (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FNetViewer
{
	...
	class APlayerController*                           InViewer;                                         		// 0x0018 (0x0004) [0x0000000000000000]              
	class AActor*                                      Viewer;                                           		// 0x001C (0x0004) [0x0000000000000000]              
};
...
{
	class UNavMeshPathConstraint*                      List[ 0x5 ];                                      		// 0x0000 (0x0014) [0x0000000000000000]              
	int                                                ListIdx;                                          		// 0x0014 (0x0004) [0x0000000000000000]              
};
...
{
	class UNavMeshPathGoalEvaluator*                   List[ 0x5 ];                                      		// 0x0000 (0x0014) [0x0000000000000000]              
	int                                                ListIdx;                                          		// 0x0014 (0x0004) [0x0000000000000000]              
};
...
struct FMusicTrackStruct
{
	...
	unsigned long                                      bAutoPlay : 1;                                    		// 0x0014 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bPersistentAcrossLevels : 1;                      		// 0x0014 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
};
...
struct FUIProviderScriptFieldValue
{
	...
	struct FString                                     StringValue;                                      		// 0x0008 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< int >                                      ArrayValue;                                       		// 0x0014 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FUIRangeData                                RangeValue;                                       		// 0x0020 (0x0014) [0x0000000000000000]              
	struct FTextureCoordinates                         AtlasCoordinates;                                 		// 0x0034 (0x0010) [0x0000000000000000]              
	struct FName                                       PropertyTag;                                      		// 0x0044 (0x0008) [0x0000000000000000]              
	class USurface*                                    ImageValue;                                       		// 0x004C (0x0004) [0x0000000000000000]              
	unsigned char                                      PropertyType;                                     		// 0x0050 (0x0001) [0x0000000000000000]              
};
...
{
	class UClass*                                      RequiredStyleClass;                               		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FSTYLE_ID                                   AssignedStyleID;                                  		// 0x0004 (0x0010) [0x0000000000000002]              ( CPF_Const )
	struct FName                                       DefaultStyleTag;                                  		// 0x0014 (0x0008) [0x0000000000000000]              
...
{
	TArray< class UUIScreenObject* >                   Subscribers;                                      		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FName                                       KeyName;                                          		// 0x000C (0x0008) [0x0000000000100000]              
};
...
{
	class UClass*                                      EventState;                                       		// 0x0000 (0x0004) [0x0000000000000000]              
	class UUIEvent*                                    EventTemplate;                                    		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	TArray< struct FSeqOpOutputInputLink >             TriggeredOps;                                     		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       InputKeyName;                                     		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      InputKeyState;                                    		// 0x0014 (0x0001) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.UIRoot.StateInputKeyAction
// 0x0007(0x001C - 0x0015)
...
{
	struct FUIScreenValue_DockPadding                  DockPadding;                                      		// 0x0000 (0x0014) [0x0000000000020001]              ( CPF_Edit | CPF_EditConst )
	class UUIObject*                                   TargetWidget[ 0x4 ];                              		// 0x0014 (0x0010) [0x0000000000020001]              ( CPF_Edit | CPF_EditConst )
	class UUIObject*                                   OwnerWidget;                                      		// 0x0024 (0x0004) [0x0000000000000002]              ( CPF_Const )
...
{
	struct FString                                     MarkupString;                                     		// 0x0000 (0x000C) [0x0000000000400003]              ( CPF_Edit | CPF_Const | CPF_NeedCtorLink )
	class UUIDataStoreSubscriber*                      Subscriber;                                       		// 0x000C (0x0008) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	unsigned char                                      UnknownData00[ 0x4 ];                             		// 0x0010 (0x0004) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FName                                       DataStoreName;                                    		// 0x0014 (0x0008) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	struct FName                                       DataStoreField;                                   		// 0x001C (0x0008) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	int                                                BindingIndex;                                     		// 0x0024 (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	class UUIDataStore*                                ResolvedDataStore;                                		// 0x0028 (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	unsigned char                                      RequiredFieldType;                                		// 0x002C (0x0001) [0x0000000000020003]              ( CPF_Edit | CPF_Const | CPF_EditConst )
};
...
struct FUIStringCaretParameters
{
	...
	int                                                CaretPosition;                                    		// 0x000C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class UMaterialInterface*                          CaretMaterial;                                    		// 0x0010 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned long                                      bDisplayCaret : 1;                                		// 0x0014 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned char                                      CaretType;                                        		// 0x0018 (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FRenderParameters
{
	...
	struct FVector2D                                   ImageExtent;                                      		// 0x0028 (0x0008) [0x0000000000100000]              
	struct FVector2D                                   SpacingAdjust;                                    		// 0x0030 (0x0008) [0x0000000000100000]              
	float                                              DrawX;                                            		// 0x0038 (0x0004) [0x0000000000100000]              
	float                                              DrawY;                                            		// 0x003C (0x0004) [0x0000000000100000]              
	float                                              DrawXL;                                           		// 0x0040 (0x0004) [0x0000000000100000]              
	float                                              DrawYL;                                           		// 0x0044 (0x0004) [0x0000000000100000]              
	class UFont*                                       DrawFont;                                         		// 0x0048 (0x0004) [0x0000000000100000]              
	float                                              ViewportHeight;                                   		// 0x004C (0x0004) [0x0000000000100000]              
	unsigned long                                      bUseOverrideColor : 1;                            		// 0x0050 (0x0004) [0x0000000000100000] [0x00000001] 
	unsigned char                                      TextAlignment[ 0x2 ];                             		// 0x0054 (0x0002) [0x0000000000100000]              
};
...
{
	TArray< class UFont* >                             InlineFontStack;                                  		// 0x0000 (0x000C) [0x0000000000502002]              ( CPF_Const | CPF_Transient | CPF_NeedCtorLink )
	class UUIStyle_Data*                               Style;                                            		// 0x000C (0x0004) [0x0000000000102002]              ( CPF_Const | CPF_Transient )
};
...
struct FUICombinedStyleData
{
	...
	struct FTextAutoScaleValue                         TextAutoScaling;                                  		// 0x0068 (0x0008) [0x0000000000100000]              
	struct FVector2D                                   TextScale;                                        		// 0x0070 (0x0008) [0x0000000000100000]              
	struct FVector2D                                   TextSpacingAdjust;                                		// 0x0078 (0x0008) [0x0000000000100000]              
	class UFont*                                       DrawFont;                                         		// 0x0080 (0x0004) [0x0000000000100000]              
	class USurface*                                    FallbackImage;                                    		// 0x0084 (0x0004) [0x0000000000100000]              
	struct FUITextAttributes                           TextAttributes;                                   		// 0x0088 (0x0004) [0x0000000000100000]              
	unsigned long                                      bInitialized : 1;                                 		// 0x008C (0x0004) [0x0000000000100002] [0x00000001] ( CPF_Const )
	unsigned char                                      TextAlignment[ 0x2 ];                             		// 0x0090 (0x0002) [0x0000000000100000]              
	unsigned char                                      TextClipMode;                                     		// 0x0092 (0x0001) [0x0000000000100000]              
	unsigned char                                      TextClipAlignment;                                		// 0x0093 (0x0001) [0x0000000000100000]              
};
...
{
	TArray< struct FModifierData >                     ModifierStack;                                    		// 0x0000 (0x000C) [0x0000000000502002]              ( CPF_Const | CPF_Transient | CPF_NeedCtorLink )
	struct FUICombinedStyleData                        CustomStyleData;                                  		// 0x000C (0x0094) [0x0000000000102002]              ( CPF_Const | CPF_Transient )
	struct FUICombinedStyleData                        BaseStyleData;                                    		// 0x00A0 (0x0094) [0x0000000000102002]              ( CPF_Const | CPF_Transient )
...
{
	struct FTextAutoScaleValue                         AutoScaling;                                      		// 0x0020 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              DrawScale[ 0x2 ];                                 		// 0x0028 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              SpacingAdjust[ 0x2 ];                             		// 0x0030 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UFont*                                       DrawFont;                                         		// 0x0038 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FUITextAttributes                           TextAttributes;                                   		// 0x003C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bOverrideDrawFont : 1;                            		// 0x0040 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bOverrideAttributes : 1;                          		// 0x0040 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bOverrideAlignment : 1;                           		// 0x0040 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bOverrideClipMode : 1;                            		// 0x0040 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bOverrideClipAlignment : 1;                       		// 0x0040 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bOverrideAutoScale : 1;                           		// 0x0040 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bOverrideScale : 1;                               		// 0x0040 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bOverrideSpacingAdjust : 1;                       		// 0x0040 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned char                                      TextAlignment[ 0x2 ];                             		// 0x0044 (0x0002) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      ClipMode;                                         		// 0x0046 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      ClipAlignment;                                    		// 0x0047 (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FUIStringNode
{
	...
	struct FString                                     SourceText;                                       		// 0x0004 (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FPointer                                    ParentNode;                                       		// 0x0010 (0x0004) [0x0000000000103002]              ( CPF_Const | CPF_Native | CPF_Transient )
	struct FVector2D                                   Extent;                                           		// 0x0014 (0x0008) [0x0000000000100001]              ( CPF_Edit )
	struct FVector2D                                   Scaling;                                          		// 0x001C (0x0008) [0x0000000000100001]              ( CPF_Edit )
	class UUIDataStore*                                NodeDataStore;                                    		// 0x0024 (0x0004) [0x0000000000102002]              ( CPF_Const | CPF_Transient )
...
{
	struct FTextureCoordinates                         TexCoords;                                        		// 0x002C (0x0010) [0x0000000000100001]              ( CPF_Edit )
	struct FVector2D                                   ForcedExtent;                                     		// 0x003C (0x0008) [0x0000000000100001]              ( CPF_Edit )
...
{
	TArray< struct FRawInputKeyEventData >             LinkedInputKeys;                                  		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       InputAliasName;                                   		// 0x000C (0x0008) [0x0000000000000000]              
};
...
struct FUIInputAliasStateMap
{
	...
	TArray< struct FUIInputActionAlias >               StateInputAliases;                                		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UClass*                                      State;                                            		// 0x0018 (0x0004) [0x0000000000000000]              
};
...
struct FUIInputAliasClassMap
{
	...
	TArray< struct FUIInputAliasStateMap >             WidgetStates;                                     		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UClass*                                      WidgetClass;                                      		// 0x0018 (0x0004) [0x0000000000000000]              
...
{
	TArray< int >                                      AutoCompleteListIndices;                          		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FPointer >                          ChildNodes;                                       		// 0x000C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	int                                                IndexChar;                                        		// 0x0018 (0x0004) [0x0000000000000000]              
};
...
{
	TArray< int >                                      Slots;                                            		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class ACoverLink*                                  Link;                                             		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FCovPosInfo
{
	...
	class ACoverLink*                                  Link;                                             		// 0x0024 (0x0004) [0x0000000000000000]              
	int                                                LtSlotIdx;                                        		// 0x0028 (0x0004) [0x0000000000000000]              
	int                                                RtSlotIdx;                                        		// 0x002C (0x0004) [0x0000000000000000]              
	float                                              LtToRtPct;                                        		// 0x0030 (0x0004) [0x0000000000000000]              
};
...
struct FSlotMoveRef
{
	struct FBasedPosition                              Dest;                                             		// 0x0000 (0x0034) [0x0000000000000001]              ( CPF_Edit )
	struct FPolyReference                              Poly;                                             		// 0x0034 (0x0018) [0x0000000000000001]              ( CPF_Edit )
	int                                                Direction;                                        		// 0x004C (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FCoverSlot
{
	TArray< unsigned char >                            Actions;                                          		// 0x0000 (0x000C) [0x0000000000600000]              ( CPF_NeedCtorLink )
	TArray< struct FFireLink >                         FireLinks;                                        		// 0x000C (0x000C) [0x0000000000620001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
	TArray< struct FFireLink >                         RejectedFireLinks;                                		// 0x0018 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	TArray< int >                                      ExposedCoverPackedProperties;                     		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< int >                                      DangerCoverPackedProperties;                      		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FCoverReference >                   SlipTarget;                                       		// 0x003C (0x000C) [0x0000000000600000]              ( CPF_NeedCtorLink )
	TArray< struct FSlotMoveRef >                      SlipRefs;                                         		// 0x0048 (0x000C) [0x0000000000600000]              ( CPF_NeedCtorLink )
	TArray< struct FCoverReference >                   OverlapClaims;                                    		// 0x0054 (0x000C) [0x0000000000620001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
	struct FCoverReference                             MantleTarget;                                     		// 0x0060 (0x001C) [0x0000000000200000]              
	struct FVector                                     LocationOffset;                                   		// 0x007C (0x000C) [0x0000000000000000]              
	struct FRotator                                    RotationOffset;                                   		// 0x0088 (0x000C) [0x0000000000000000]              
	class APawn*                                       SlotOwner;                                        		// 0x0094 (0x0004) [0x0000000000000000]              
	float                                              SlotValidAfterTime;                               		// 0x0098 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	int                                                TurnTargetPackedProperties;                       		// 0x009C (0x0004) [0x0000000000000000]              
	int                                                CoverTurnTargetPackedProperties;                  		// 0x00A0 (0x0004) [0x0000000000000000]              
	int                                                ExtraCost;                                        		// 0x00A4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LeanTraceDist;                                    		// 0x00A8 (0x0004) [0x0000000000000000]              
	class ACoverSlotMarker*                            SlotMarker;                                       		// 0x00AC (0x0004) [0x0000000000220001]              ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bLeanLeft : 1;                                    		// 0x00B0 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bLeanRight : 1;                                   		// 0x00B0 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bForceCanPopUp : 1;                               		// 0x00B0 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bCanPopUp : 1;                                    		// 0x00B0 (0x0004) [0x0000000000020001] [0x00000008] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanMantle : 1;                                   		// 0x00B0 (0x0004) [0x0000000000020001] [0x00000010] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanClimbUp : 1;                                  		// 0x00B0 (0x0004) [0x0000000000020001] [0x00000020] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bForceCanCoverSlip_Left : 1;                      		// 0x00B0 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
	unsigned long                                      bForceCanCoverSlip_Right : 1;                     		// 0x00B0 (0x0004) [0x0000000000000001] [0x00000080] ( CPF_Edit )
	unsigned long                                      bCanCoverSlip_Left : 1;                           		// 0x00B0 (0x0004) [0x0000000000020001] [0x00000100] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanCoverSlip_Right : 1;                          		// 0x00B0 (0x0004) [0x0000000000020001] [0x00000200] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanSwatTurn_Left : 1;                            		// 0x00B0 (0x0004) [0x0000000000020001] [0x00000400] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanSwatTurn_Right : 1;                           		// 0x00B0 (0x0004) [0x0000000000020001] [0x00000800] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanCoverTurn_Left : 1;                           		// 0x00B0 (0x0004) [0x0000000000020001] [0x00001000] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanCoverTurn_Right : 1;                          		// 0x00B0 (0x0004) [0x0000000000020001] [0x00002000] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bEnabled : 1;                                     		// 0x00B0 (0x0004) [0x0000000000000001] [0x00004000] ( CPF_Edit )
	unsigned long                                      bAllowPopup : 1;                                  		// 0x00B0 (0x0004) [0x0000000000000001] [0x00008000] ( CPF_Edit )
	unsigned long                                      bAllowMantle : 1;                                 		// 0x00B0 (0x0004) [0x0000000000000001] [0x00010000] ( CPF_Edit )
	unsigned long                                      bAllowCoverSlip : 1;                              		// 0x00B0 (0x0004) [0x0000000000000001] [0x00020000] ( CPF_Edit )
	unsigned long                                      bAllowClimbUp : 1;                                		// 0x00B0 (0x0004) [0x0000000000000001] [0x00040000] ( CPF_Edit )
	unsigned long                                      bAllowSwatTurn : 1;                               		// 0x00B0 (0x0004) [0x0000000000000001] [0x00080000] ( CPF_Edit )
	unsigned long                                      bAllowCoverTurn : 1;                              		// 0x00B0 (0x0004) [0x0000000000000001] [0x00100000] ( CPF_Edit )
	unsigned long                                      bForceNoGroundAdjust : 1;                         		// 0x00B0 (0x0004) [0x0000000000000001] [0x00200000] ( CPF_Edit )
	unsigned long                                      bPlayerOnly : 1;                                  		// 0x00B0 (0x0004) [0x0000000000000001] [0x00400000] ( CPF_Edit )
	unsigned long                                      bUnsafeCover : 1;                                 		// 0x00B0 (0x0004) [0x0000000000000001] [0x00800000] ( CPF_Edit )
	unsigned long                                      bSelected : 1;                                    		// 0x00B0 (0x0004) [0x0000000000002000] [0x01000000] ( CPF_Transient )
	unsigned long                                      bFailedToFindSurface : 1;                         		// 0x00B0 (0x0004) [0x0000000000000000] [0x02000000] 
	unsigned char                                      ForceCoverType;                                   		// 0x00B4 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      CoverType;                                        		// 0x00B5 (0x0001) [0x0000000000020001]              ( CPF_Edit | CPF_EditConst )
	unsigned char                                      LocationDescription;                              		// 0x00B6 (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	TArray< unsigned char >                            SlotsEnabled;                                     		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< unsigned char >                            SlotsDisabled;                                    		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< unsigned char >                            SlotsAdjusted;                                    		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FManualCoverTypeInfo >              SlotsCoverTypeChanged;                            		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class ACoverLink*                                  Link;                                             		// 0x0030 (0x0004) [0x0000000000000000]              
};
...
{
	TArray< class UUIDataProvider* >                   FieldProviders;                                   		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FName                                       FieldTag;                                         		// 0x000C (0x0008) [0x0000000000100000]              
	unsigned char                                      FieldType;                                        		// 0x0014 (0x0001) [0x0000000000100000]              
};
...
{
	TArray< class UUIDataStore* >                      DataStores;                                       		// 0x0000 (0x000C) [0x0000000000502002]              ( CPF_Const | CPF_Transient | CPF_NeedCtorLink )
	class ULocalPlayer*                                PlayerOwner;                                      		// 0x000C (0x0004) [0x0000000000102002]              ( CPF_Const | CPF_Transient )
};
...
struct FKeyBind
{
	...
	struct FName                                       Name;                                             		// 0x000C (0x0008) [0x0000000000004000]              ( CPF_Config )
...
struct FDecalReceiver
{
	...
	class UPrimitiveComponent*                         Component;                                        		// 0x0004 (0x0004) [0x000000000408000A]              ( CPF_Const | CPF_ExportObject | CPF_Component | CPF_EditInline )
};
...
struct FParticleSysParam
{
	...
	float                                              Scalar;                                           		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	...
	unsigned char                                      ParamType;                                        		// 0x0028 (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FEmitterBaseInfo
{
	...
	class UParticleSystemComponent*                    PSC;                                              		// 0x0018 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class AActor*                                      Base;                                             		// 0x001C (0x0004) [0x0000000000000000]              
...
{
	struct FInterpCurveVector                          Curve;                                            		// 0x0000 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FName                                       AnimName;                                         		// 0x0010 (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
struct FFoliageMesh
{
	...
	class UStaticMesh*                                 InstanceStaticMesh;                               		// 0x0034 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UMaterialInterface*                          Material;                                         		// 0x0038 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxDrawRadius;                                    		// 0x003C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinTransitionRadius;                              		// 0x0040 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinThinningRadius;                                		// 0x0044 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinUniformScale;                                  		// 0x0048 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxUniformScale;                                  		// 0x004C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SwayScale;                                        		// 0x0050 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                Seed;                                             		// 0x0054 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SurfaceAreaPerInstance;                           		// 0x0058 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UFoliageComponent*                           Component;                                        		// 0x005C (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	unsigned long                                      bCreateInstancesOnBSP : 1;                        		// 0x0060 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bCreateInstancesOnStaticMeshes : 1;               		// 0x0060 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bCreateInstancesOnTerrain : 1;                    		// 0x0060 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
};
...
struct FURL
{
	...
	struct FString                                     Map;                                              		// 0x0018 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           Op;                                               		// 0x0024 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     Portal;                                           		// 0x0030 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	int                                                Port;                                             		// 0x003C (0x0004) [0x0000000000100000]              
...
{
	struct FString                                     Tag;                                              		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FName >                             PackagesToLoad;                                   		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UObject* >                           LoadedObjects;                                    		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      FullyLoadType;                                    		// 0x0024 (0x0001) [0x0000000000000000]              
};
...
{
	struct FPointer                                    NetDriver;                                        		// 0x0000 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	struct FName                                       NetDriverName;                                    		// 0x0004 (0x0008) [0x0000000000000000]              
};
...
{
	struct FString                                     Prefix;                                           		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     GameType;                                         		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           AdditionalGameTypes;                              		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           ForcedObjects;                                    		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     OverrideCommonPackage;                            		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bUsesCommonPackage : 1;                           		// 0x003C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bIsMultiplayer : 1;                               		// 0x003C (0x0004) [0x0000000000000000] [0x00000002] 
};
...
{
	struct FString                                     ColumnHeaderText;                                 		// 0x0000 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	TArray< struct FStringIdToStringMapping >          ValueMappings;                                    		// 0x000C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FName                                       Name;                                             		// 0x0018 (0x0008) [0x0000000000000002]              ( CPF_Const )
	int                                                Id;                                               		// 0x0020 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	struct FString                                     ColumnHeaderText;                                 		// 0x0000 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	TArray< struct FIdToStringMapping >                ValueMappings;                                    		// 0x000C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	TArray< struct FSettingsData >                     PredefinedValues;                                 		// 0x0018 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FName                                       Name;                                             		// 0x0024 (0x0008) [0x0000000000000002]              ( CPF_Const )
	int                                                Id;                                               		// 0x002C (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              MinVal;                                           		// 0x0030 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              MaxVal;                                           		// 0x0034 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              RangeIncrement;                                   		// 0x0038 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned char                                      MappingType;                                      		// 0x003C (0x0001) [0x0000000000000002]              ( CPF_Const )
};
...
struct FPlayerInformationNew
{
	...
	unsigned long                                      bIsBot : 1;                                       		// 0x0018 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	struct FString                                     TeamName;                                         		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FGameSessionInformation
{
	...
	struct FString                                     GameplaySessionTimestamp;                         		// 0x000C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     GameplaySessionID;                                		// 0x0018 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     GameClassName;                                    		// 0x0024 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     MapName;                                          		// 0x0030 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     MapURL;                                           		// 0x003C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	int                                                AppTitleID;                                       		// 0x0048 (0x0004) [0x0000000000000000]              
	int                                                PlatformType;                                     		// 0x004C (0x0004) [0x0000000000000000]              
	float                                              GameplaySessionStartTime;                         		// 0x0050 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              GameplaySessionEndTime;                           		// 0x0054 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      bGameplaySessionInProgress : 1;                   		// 0x0058 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
};
...
struct FDebugDisplayProperty
{
	...
	class UObject*                                     Obj;                                              		// 0x0008 (0x0004) [0x0000000000000000]              
...
{
	struct FString                                     CurveName;                                        		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UObject*                                     CurveObject;                                      		// 0x000C (0x0004) [0x0000000000000000]              
	struct FColor                                      CurveColor;                                       		// 0x0010 (0x0004) [0x0000000000000000]              
...
{
	struct FPointer                                    Callback;                                         		// 0x0000 (0x0004) [0x0000000000000000]              
	struct FPointer                                    Context;                                          		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                PreloadMovieHandle;                               		// 0x0008 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      CurrentState;                                     		// 0x000C (0x0001) [0x0000000000002000]              ( CPF_Transient )
};
...
{
	struct FBioBinkAsyncPreloader                      BinkPreloader;                                    		// 0x0000 (0x0010) [0x0000000000002000]              ( CPF_Transient )
	class UObject*                                     pObject;                                          		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                nKeyIndex;                                        		// 0x0014 (0x0004) [0x0000000000000000]              
	float                                              fTime;                                            		// 0x0018 (0x0004) [0x0000000000000000]              
	unsigned long                                      bPreloadFired : 1;                                		// 0x001C (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
};
...
{
	struct FString                                     FaceFXGroupName;                                  		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     FaceFXSeqName;                                    		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	TArray< class UFaceFXAnimSet* >                    aBioMaleSets;                                     		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UFaceFXAnimSet* >                    aBioFemaleSets;                                   		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UFaceFXAnimSet*                              fxaAnimSet;                                       		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      eAnimSequence;                                    		// 0x001C (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	struct FRawDistributionFloat                       LFMaterialIndex;                                  		// 0x0000 (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FRawDistributionFloat                       Scaling;                                          		// 0x001C (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FRawDistributionVector                      AxisScaling;                                      		// 0x0038 (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FRawDistributionFloat                       Rotation;                                         		// 0x0054 (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FRawDistributionVector                      Color;                                            		// 0x0070 (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FRawDistributionFloat                       Alpha;                                            		// 0x008C (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FRawDistributionVector                      Offset;                                           		// 0x00A8 (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FRawDistributionVector                      DistMap_Scale;                                    		// 0x00C4 (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FRawDistributionVector                      DistMap_Color;                                    		// 0x00E0 (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FRawDistributionFloat                       DistMap_Alpha;                                    		// 0x00FC (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	TArray< class UMaterialInterface* >                LFMaterials;                                      		// 0x0118 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FVector                                     Size;                                             		// 0x0124 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       ElementName;                                      		// 0x0130 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              RayDistance;                                      		// 0x0138 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bIsEnabled : 1;                                   		// 0x013C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bUseSourceDistance : 1;                           		// 0x013C (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bNormalizeRadialDistance : 1;                     		// 0x013C (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bModulateColorBySource : 1;                       		// 0x013C (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
};
...
{
	struct FPointer                                    pOwner;                                           		// 0x0000 (0x0004) [0x0000000000001000]              ( CPF_Native )
	class UPostProcessEffect*                          pEffect;                                          		// 0x0004 (0x0004) [0x0000000000000000]              
...
{
	struct FPostProcessSettings                        LastSettings;                                     		// 0x0000 (0x00D0) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class APostProcessVolume*                          LastVolumeUsed;                                   		// 0x00D0 (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x00D4 (0x0004) [0x0000000000000000]              
	float                                              LastBlendTime;                                    		// 0x00D8 (0x0004) [0x0000000000000000]              
};
...
{
	struct FInterpCurveFloat                           ParameterValueCurve;                              		// 0x0028 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              ParameterValue;                                   		// 0x0038 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	struct FInterpCurveVector                          ParameterValueCurve;                              		// 0x0028 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FLinearColor                                ParameterValue;                                   		// 0x0038 (0x0010) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FNavMeshPathParams
{
	...
	struct FVector                                     SearchExtent;                                     		// 0x0004 (0x000C) [0x0000000000000000]              
	struct FVector                                     SearchStart;                                      		// 0x0010 (0x000C) [0x0000000000000000]              
	float                                              MaxDropHeight;                                    		// 0x001C (0x0004) [0x0000000000000000]              
	float                                              MinWalkableZ;                                     		// 0x0020 (0x0004) [0x0000000000000000]              
	float                                              MaxHoverDistance;                                 		// 0x0024 (0x0004) [0x0000000000000000]              
	unsigned long                                      bCanMantle : 1;                                   		// 0x0028 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bNeedsMantleValidityTest : 1;                     		// 0x0028 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bAbleToSearch : 1;                                		// 0x0028 (0x0004) [0x0000000000000000] [0x00000004] 
};
...
{
	struct FUniqueNetId                                UniqueId;                                         		// 0x0000 (0x0008) [0x0000000000000000]              
	struct FString                                     ControllerName;                                   		// 0x0008 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     PlayerName;                                       		// 0x0014 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                LastPlayerEventIdx;                               		// 0x0020 (0x0004) [0x0000000000000000]              
	unsigned long                                      bIsBot : 1;                                       		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	struct FString                                     ObjectPropertyValue;                              		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       ObjectPropertyName;                               		// 0x000C (0x0008) [0x0000000000000000]              
};
...
struct FOverrideSkill
{
	...
	TArray< struct FDouble >                           Mus;                                              		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FDouble >                           Sigmas;                                           		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                LeaderboardId;                                    		// 0x0024 (0x0004) [0x0000000000000000]              
};
...
{
	struct FSettingsProperty                           ProfileSetting;                                   		// 0x0000 (0x0014) [0x0000000000000000]              
	unsigned char                                      Owner;                                            		// 0x0014 (0x0001) [0x0000000000000000]              
};
...
{
	struct FString                                     GameSettingsClassName;                            		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     URL;                                              		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                GameSettingId;                                    		// 0x0018 (0x0004) [0x0000000000000000]              
...
struct FPlaylist
{
	...
	struct FString                                     LocalizationString;                               		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< int >                                      ContentIds;                                       		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Name;                                             		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                PlaylistId;                                       		// 0x0030 (0x0004) [0x0000000000000000]              
	int                                                TeamSize;                                         		// 0x0034 (0x0004) [0x0000000000000000]              
	int                                                TeamCount;                                        		// 0x0038 (0x0004) [0x0000000000000000]              
...
{
	struct FSettingsData                               StatValue;                                        		// 0x0000 (0x000C) [0x0000000000000000]              
	int                                                ColumnNo;                                         		// 0x000C (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     ColumnName;                                       		// 0x0000 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FName                                       Name;                                             		// 0x000C (0x0008) [0x0000000000000002]              ( CPF_Const )
	int                                                Id;                                               		// 0x0014 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	TArray< class UParticleModuleEventSendToGame* >    ParticleModuleEventsToSendToGame;                 		// 0x0000 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
	struct FName                                       CustomName;                                       		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	int                                                Frequency;                                        		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                LowFreq;                                          		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                ParticleFrequency;                                		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      FirstTimeOnly : 1;                                		// 0x0020 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      LastTimeOnly : 1;                                 		// 0x0020 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      UseReflectedImpactVector : 1;                     		// 0x0020 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
...
{
	struct FRawDistributionFloat                       ParamValue;                                       		// 0x0000 (0x001C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FName                                       ParamName;                                        		// 0x001C (0x0008) [0x0000000000020001]              ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bUseEmitterTime : 1;                              		// 0x0024 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bSpawnTimeOnly : 1;                               		// 0x0024 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bScaleVelocityByParamValue : 1;                   		// 0x0024 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned char                                      ValueMethod;                                      		// 0x0028 (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	struct FPointer                                    FrameState;                                       		// 0x0000 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                EmitterType;                                      		// 0x0004 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                OriginalEmitterIndex;                             		// 0x0008 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
};
...
struct FPBRuleLink
{
	...
	class UPBRuleNodeBase*                             NextRule;                                         		// 0x0008 (0x0004) [0x0000000004400009]              ( CPF_Edit | CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
};
...
{
	struct FName                                       RulesetVariation;                                 		// 0x0000 (0x0008) [0x0000000000000000]              
	class AProcBuilding*                               OwningBuilding;                                   		// 0x0008 (0x0004) [0x0000000000000000]              
	class UProcBuildingRuleset*                        Ruleset;                                          		// 0x000C (0x0004) [0x0000000000000000]              
...
{
	TArray< class UMaterialInterface* >                MaterialOverrides;                                		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FBuildingMatOverrides >             SectionOverrides;                                 		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UStaticMesh*                                 Mesh;                                             		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DimX;                                             		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DimZ;                                             		// 0x0020 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Chance;                                           		// 0x0024 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UDistributionVector*                         Translation;                                      		// 0x0028 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UDistributionVector*                         Rotation;                                         		// 0x002C (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	int                                                OverriddenMeshLightMapRes;                        		// 0x0030 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bMeshScaleTranslation : 1;                        		// 0x0034 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bOverrideMeshLightMapRes : 1;                     		// 0x0034 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
};
...
{
	TArray< struct FPhysXDestructibleDepthParameters > DepthParameters;                                  		// 0x0000 (0x000C) [0x0000000000400041]              ( CPF_Edit | CPF_EditConstArray | CPF_NeedCtorLink )
	float                                              DamageThreshold;                                  		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DamageToRadius;                                   		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DamageCap;                                        		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ForceToDamage;                                    		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class USoundCue*                                   FractureSound;                                    		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UParticleSystem*                             CrumbleParticleSystem;                            		// 0x0020 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CrumbleParticleSize;                              		// 0x0024 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ScaledDamageToRadius;                             		// 0x0028 (0x0004) [0x0000000000000000]              
	unsigned long                                      bAccumulateDamage : 1;                            		// 0x002C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
...
struct FPhysXDestructibleChunk
{
	...
	struct FPointer                                    Structure;                                        		// 0x0080 (0x0004) [0x0000000000001000]              ( CPF_Native )
	struct FVector                                     RelativeCentroid;                                 		// 0x0084 (0x000C) [0x0000000000000000]              
	struct FVector                                     WorldCentroid;                                    		// 0x0090 (0x000C) [0x0000000000000000]              
	struct FName                                       BoneName;                                         		// 0x009C (0x0008) [0x0000000000000000]              
	int                                                ActorIndex;                                       		// 0x00A4 (0x0004) [0x0000000000000000]              
	int                                                FragmentIndex;                                    		// 0x00A8 (0x0004) [0x0000000000000000]              
	int                                                Index;                                            		// 0x00AC (0x0004) [0x0000000000000000]              
	int                                                MeshIndex;                                        		// 0x00B0 (0x0004) [0x0000000000000000]              
	int                                                BoneIndex;                                        		// 0x00B4 (0x0004) [0x0000000000000000]              
	int                                                BodyIndex;                                        		// 0x00B8 (0x0004) [0x0000000000000000]              
	float                                              Radius;                                           		// 0x00BC (0x0004) [0x0000000000000000]              
	int                                                ParentIndex;                                      		// 0x00C0 (0x0004) [0x0000000000000000]              
	int                                                FirstChildIndex;                                  		// 0x00C4 (0x0004) [0x0000000000000000]              
	int                                                NumChildren;                                      		// 0x00C8 (0x0004) [0x0000000000000000]              
	int                                                Depth;                                            		// 0x00CC (0x0004) [0x0000000000000000]              
	float                                              Age;                                              		// 0x00D0 (0x0004) [0x0000000000000000]              
	float                                              Damage;                                           		// 0x00D4 (0x0004) [0x0000000000000000]              
	float                                              Size;                                             		// 0x00D8 (0x0004) [0x0000000000000000]              
	int                                                FIFOIndex;                                        		// 0x00DC (0x0004) [0x0000000000001000]              ( CPF_Native )
	int                                                FirstOverlapIndex;                                		// 0x00E0 (0x0004) [0x0000000000000000]              
	int                                                NumOverlaps;                                      		// 0x00E4 (0x0004) [0x0000000000000000]              
	int                                                ShortestRoute;                                    		// 0x00E8 (0x0004) [0x0000000000000000]              
	int                                                NumSupporters;                                    		// 0x00EC (0x0004) [0x0000000000000000]              
	int                                                NumChildrenDup;                                   		// 0x00F0 (0x0004) [0x0000000000000000]              
	unsigned long                                      WorldCentroidValid : 1;                           		// 0x00F4 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      WorldMatrixValid : 1;                             		// 0x00F4 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bCrumble : 1;                                     		// 0x00F4 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      IsEnvironmentSupported : 1;                       		// 0x00F4 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      IsRouting : 1;                                    		// 0x00F4 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      IsRouteValid : 1;                                 		// 0x00F4 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      IsRouteBlocker : 1;                               		// 0x00F4 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned char                                      CurrentState;                                     		// 0x00F8 (0x0001) [0x0000000000000000]              
};
...
{
	class UObject*                                     Archetype;                                        		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                RemovedVersion;                                   		// 0x0004 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	TArray< int >                                      ActivateIndices;                                  		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class USequenceEvent*                              ActivatedEvent;                                   		// 0x000C (0x0004) [0x0000000000000000]              
	class AActor*                                      inOriginator;                                     		// 0x0010 (0x0004) [0x0000000000000000]              
	class AActor*                                      inInstigator;                                     		// 0x0014 (0x0004) [0x0000000000000000]              
...
struct FEMG_Entry
{
	struct FName                                       m_nmEffect;                                       		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
{
	struct FName                                       m_nmTag;                                          		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UMaterialInterface*                          m_pMaterial;                                      		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FCameraCutInfo
{
	...
	class USFXSceneShopNode*                           SFXOwningScene;                                   		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
{
	struct FName                                       LevelName;                                        		// 0x0000 (0x0008) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class ULevelStreaming*                             Level;                                            		// 0x0008 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	struct FName                                       nmEventName;                                      		// 0x0000 (0x0008) [0x0000000000000000]              
	class USFXSceneShopNode*                           pNode;                                            		// 0x0008 (0x0004) [0x0000000000000000]              
	float                                              fEventTime;                                       		// 0x000C (0x0004) [0x0000000000000000]              
};
...
{
	class USFXSceneShopNode*                           pLinkedNode;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                nLinkedIndex;                                     		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     sLinkName;                                        		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FSFXSSNodePinLink >                 aLinks;                                           		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FString                                     ReferenceWord;                                    		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     PhoneticWord;                                     		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
	TArray< unsigned char >                            UserData;                                         		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                ActiveVocabularies;                               		// 0x000C (0x0004) [0x0000000000000000]              
};
...
{
	class ULevelStreaming*                             Level;                                            		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bShouldBeLoaded : 1;                              		// 0x0004 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bShouldBeVisible : 1;                             		// 0x0004 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bShouldBlockOnLoad : 1;                           		// 0x0004 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
};
...
struct FUIAnimTrack
{
	TArray< struct FUIAnimationKeyFrame >              KeyFrames;                                        		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FUIAnimationKeyFrame >              LoopFrames;                                       		// 0x000C (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	unsigned char                                      TrackType;                                        		// 0x0018 (0x0001) [0x0000000000000000]              
};
...
{
	TArray< struct FUIAnimTrack >                      AnimationTracks;                                  		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	class UUIAnimationSeq*                             SequenceRef;                                      		// 0x000C (0x0004) [0x0000000000100000]              
	float                                              PlaybackRate;                                     		// 0x0010 (0x0004) [0x0000000000100000]              
	unsigned char                                      LoopMode;                                         		// 0x0014 (0x0001) [0x0000000000100000]              
};
...
{
	struct FUIStyleReference                           CellStyle[ 0x4 ];                                 		// 0x0000 (0x0080) [0x0000000000000000]              
	int                                                ContainerElementIndex;                            		// 0x0080 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	class UUIList*                                     OwnerList;                                        		// 0x0084 (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
...
struct FUIListItem
{
	TArray< struct FUIListElementCell >                Cells;                                            		// 0x0000 (0x000C) [0x0000000004420041]              ( CPF_Edit | CPF_EditConstArray | CPF_EditConst | CPF_NeedCtorLink | CPF_EditInline )
	struct FUIListItemDataBinding                      DataSource;                                       		// 0x000C (0x0014) [0x0000000000000002]              ( CPF_Const )
	class UUIObject*                                   ElementWidget;                                    		// 0x0020 (0x0004) [0x0000000004020001]              ( CPF_Edit | CPF_EditConst | CPF_EditInline )
	unsigned char                                      ElementState;                                     		// 0x0024 (0x0001) [0x0000000001022001]              ( CPF_Edit | CPF_Transient | CPF_EditConst )
};
...
{
	struct FString                                     ColumnHeaderText;                                 		// 0x008C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FName                                       CellDataField;                                    		// 0x0098 (0x0008) [0x0000000004000001]              ( CPF_Edit | CPF_EditInline )
...
{
	struct FString                                     ItemText;                                         		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FPointer                                    ParentItem;                                       		// 0x000C (0x0004) [0x0000000000103002]              ( CPF_Const | CPF_Native | CPF_Transient )
	class UUIContextMenu*                              OwnerMenu;                                        		// 0x0010 (0x0004) [0x0000000000102002]              ( CPF_Const | CPF_Transient )
	int                                                ItemId;                                           		// 0x0014 (0x0004) [0x0000000000100000]              
	unsigned char                                      ItemType;                                         		// 0x0018 (0x0001) [0x0000000000100000]              
};
...
struct FPlayerStorageArrayProvider
{
	...
	int                                                PlayerStorageId;                                  		// 0x0008 (0x0004) [0x0000000000000000]              
...
struct FSettingsArrayProvider
{
	...
	int                                                SettingsId;                                       		// 0x0008 (0x0004) [0x0000000000000000]              
...
{
	struct FString                                     ProviderClassName;                                		// 0x0000 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	class UClass*                                      ProviderClass;                                    		// 0x000C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	struct FName                                       ProviderTag;                                      		// 0x0010 (0x0008) [0x0000000000004000]              ( CPF_Config )
};
...
{
	struct FString                                     ButtonFontMarkupString;                           		// 0x0000 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FRawInputKeyEventData                       InputKeyData;                                     		// 0x000C (0x000C) [0x0000000000004000]              ( CPF_Config )
};
...
{
	struct FUIInputKeyData                             PlatformInputKeys[ 0x3 ];                         		// 0x0000 (0x0048) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FName                                       AliasName;                                        		// 0x0048 (0x0008) [0x0000000000004000]              ( CPF_Config )
};
...
{
	TArray< class UUIDataProvider_Settings* >          SearchResults;                                    		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UClass*                                      GameSearchClass;                                  		// 0x000C (0x0004) [0x0000000000000000]              
	class UClass*                                      DefaultGameSettingsClass;                         		// 0x0010 (0x0004) [0x0000000000000000]              
	class UClass*                                      SearchResultsProviderClass;                       		// 0x0014 (0x0004) [0x0000000000000000]              
	struct FName                                       SearchName;                                       		// 0x0018 (0x0008) [0x0000000000000000]              
	class UUIDataProvider_Settings*                    DesiredSettingsProvider;                          		// 0x0020 (0x0004) [0x0000000000000000]              
	class UOnlineGameSearch*                           Search;                                           		// 0x0024 (0x0004) [0x0000000000000000]              
};
...
struct FGameSettingsCfg
{
	...
	class UUIDataProvider_Settings*                    Provider;                                         		// 0x000C (0x0004) [0x0000000000000000]              
	class UOnlineGameSettings*                         GameSettings;                                     		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     PlayerNickColumnName;                             		// 0x0000 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FName                                       PlayerNickName;                                   		// 0x000C (0x0008) [0x0000000000000002]              ( CPF_Const )
};
...
{
	struct FString                                     RankColumnName;                                   		// 0x0000 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FName                                       RankName;                                         		// 0x000C (0x0008) [0x0000000000000002]              ( CPF_Const )
};
...
{
	struct FString                                     MappedText;                                       		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       FieldName;                                        		// 0x000C (0x0008) [0x0000000000000000]              
	struct FName                                       Set;                                              		// 0x0014 (0x0008) [0x0000000000000000]              
};
...
struct FArchetypeInstancePair
{
	...
	class UUIObject*                                   WidgetArchetype;                                  		// 0x0020 (0x0004) [0x0000000000102000]              ( CPF_Transient )
	class UUIObject*                                   WidgetInstance;                                   		// 0x0024 (0x0004) [0x0000000000102000]              ( CPF_Transient )
};
...
struct FStyleDataReference
{
	...
	class UUIStyle*                                    OwnerStyle;                                       		// 0x0010 (0x0004) [0x0000000000000000]              
