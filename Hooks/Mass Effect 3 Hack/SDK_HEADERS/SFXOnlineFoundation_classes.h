...
public:
	...
	struct FString                                     mPresenceString;                                  		// 0x0070 (0x000C) [0x0000000000001000]              ( CPF_Native )
	struct FString                                     mGamePresenceString;                              		// 0x007C (0x000C) [0x0000000000001000]              ( CPF_Native )
	struct FString                                     mSessionPresenceString;                           		// 0x0088 (0x000C) [0x0000000000001000]              ( CPF_Native )
	struct FString                                     mDisplayName;                                     		// 0x0094 (0x000C) [0x0000000000001000]              ( CPF_Native )
	TArray< struct FPCFriend >                         mFriendsListCache;                                		// 0x00A0 (0x000C) [0x0000000000001000]              ( CPF_Native )
	TArray< struct FPCFriend >                         mBlockListCache;                                  		// 0x00AC (0x000C) [0x0000000000001000]              ( CPF_Native )
	TArray< struct FSFXOnlineEntitlementLookupInfo >   mEntitlementCache;                                		// 0x00B8 (0x000C) [0x0000000000001000]              ( CPF_Native )
	struct FString                                     mOriginVersion;                                   		// 0x00C4 (0x000C) [0x0000000000001000]              ( CPF_Native )
	struct FString                                     mInviteInfo;                                      		// 0x00D0 (0x000C) [0x0000000000001000]              ( CPF_Native )
	TArray< struct FScriptDelegate >                   mOriginClosedDelegates;                           		// 0x00DC (0x000C) [0x0000000000001000]              ( CPF_Native )
	TArray< struct FScriptDelegate >                   mOriginAuthKeyDelegates;                          		// 0x00E8 (0x000C) [0x0000000000001000]              ( CPF_Native )
	TArray< struct FScriptDelegate >                   mWalletBalanceDelegates;                          		// 0x00F4 (0x000C) [0x0000000000001000]              ( CPF_Native )
	struct FString                                     mContentId;                                       		// 0x0100 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     mMultiplayerId;                                   		// 0x010C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     mCurrencyId;                                      		// 0x0118 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     mOfferGroup;                                      		// 0x0124 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     mAccessEntitlement;                               		// 0x0130 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnOriginClosedDelegate__Delegate;               		// 0x013C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnOriginAuthKey__Delegate;                      		// 0x0148 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnWalletBalanceAvailable__Delegate;             		// 0x0154 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	void*                                              mTitleStringRef;                                  		// 0x0160 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              mTimeBetweenOnlineChecks;                         		// 0x0164 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                mCheckoutTimeout;                                 		// 0x0168 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                mFriendQueryTimeout;                              		// 0x016C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                mEntitlementQueryTimeout;                         		// 0x0170 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              mTimeSinceLastOnlineCheck;                        		// 0x0174 (0x0004) [0x0000000000001000]              ( CPF_Native )
	unsigned long                                      mDisableOrigin : 1;                               		// 0x0178 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	unsigned long                                      mServiceStarted : 1;                              		// 0x0178 (0x0004) [0x0000000000001000] [0x00000002] ( CPF_Native )
	unsigned long                                      mIsLoggedIn : 1;                                  		// 0x0178 (0x0004) [0x0000000000001000] [0x00000004] ( CPF_Native )
	unsigned long                                      mIsOriginDisabled : 1;                            		// 0x0178 (0x0004) [0x0000000000001000] [0x00000008] ( CPF_Native )
	unsigned long                                      mIsEntitlementCacheAvailable : 1;                 		// 0x0178 (0x0004) [0x0000000000001000] [0x00000010] ( CPF_Native )
	unsigned long                                      mIsPendingConnection : 1;                         		// 0x0178 (0x0004) [0x0000000000001000] [0x00000020] ( CPF_Native )
	unsigned long                                      mIsOverlayUp : 1;                                 		// 0x0178 (0x0004) [0x0000000000001000] [0x00000040] ( CPF_Native )
	unsigned long                                      mIsOverlayEnabled : 1;                            		// 0x0178 (0x0004) [0x0000000000001000] [0x00000080] ( CPF_Native )
	unsigned long                                      mOldClient : 1;                                   		// 0x0178 (0x0004) [0x0000000000001000] [0x00000100] ( CPF_Native )
	unsigned long                                      mFriendsListUpToDate : 1;                         		// 0x0178 (0x0004) [0x0000000000001000] [0x00000200] ( CPF_Native )
	unsigned long                                      mIsOnline : 1;                                    		// 0x0178 (0x0004) [0x0000000000001000] [0x00000400] ( CPF_Native )
	unsigned long                                      mPendingInviteJoin : 1;                           		// 0x0178 (0x0004) [0x0000000000001000] [0x00000800] ( CPF_Native )
	unsigned char                                      mPresenceState;                                   		// 0x017C (0x0001) [0x0000000000001000]              ( CPF_Native )
...
public:
	...
	struct FPointer                                    VfTable_Blaze__BlazeStateEventHandler;            		// 0x0068 (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	TArray< struct FLeaderboardDefinition >            mLeaderboardDefinitions;                          		// 0x006C (0x000C) [0x0000000000001000]              ( CPF_Native )
	TArray< struct FLeaderboardId >                    mLeaderboardIDs;                                  		// 0x0078 (0x000C) [0x0000000000001000]              ( CPF_Native )
	TArray< struct FBlazeRequest >                     mBlazeDataRequests;                               		// 0x0084 (0x000C) [0x0000000000001000]              ( CPF_Native )
	TArray< struct FLeaderboardNameFormula >           mLeaderboardNames;                                		// 0x0090 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FScriptDelegate >                   RankNotificationCallbacks;                        		// 0x009C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FRankBypassNotification >           RankBypassNotifications;                          		// 0x00A8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnResultsRetrieved__Delegate;                   		// 0x00B4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnReadLbListCompleted__Delegate;                		// 0x00C0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnGetRankNotificationsCompleted__Delegate;      		// 0x00CC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FPointer                                    mLeaderboardAPI;                                  		// 0x00D8 (0x0004) [0x0000000000001000]              ( CPF_Native )
	struct FPointer                                    mCurrentLeaderboard;                              		// 0x00DC (0x0004) [0x0000000000001000]              ( CPF_Native )
	struct FPointer                                    mGlobalLeaderboardView;                           		// 0x00E0 (0x0004) [0x0000000000001000]              ( CPF_Native )
	void*                                              srRankColumnHeader;                               		// 0x00E4 (0x0004) [0x0000000000004000]              ( CPF_Config )
	void*                                              srUserColumnHeader;                               		// 0x00E8 (0x0004) [0x0000000000004000]              ( CPF_Config )
	void*                                              srReplacementGlobalMapName;                       		// 0x00EC (0x0004) [0x0000000000004000]              ( CPF_Config )
	void*                                              srFriendsDuplicateSuffix;                         		// 0x00F0 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                mLbInfoRetrievedCount;                            		// 0x00F4 (0x0004) [0x0000000000000000]              
	int                                                mGlobalLbEntityCount;                             		// 0x00F8 (0x0004) [0x0000000000000000]              
...
public:
	...
	void CancelLeaderboardRequests ( );
	void RequestReadLeaderboardList ( );
	void FlushNotificationsFriendLeaderboardCb ( TArray< struct FLeaderboardColumn > aColumnInfo, TArray< struct FLeaderboardRecord > aResults, unsigned char nErrorCode, struct FPointer pExternalData );
	void RankNotificationFriendLeaderboardCb ( TArray< struct FLeaderboardColumn > aColumnInfo, TArray< struct FLeaderboardRecord > aResults, unsigned char nErrorCode, struct FPointer pExternalData );
	void RequestFriendLeaderboardData ( struct FScriptDelegate funcResultsRetrieved, struct FPointer pExternalData );
	void FlushRankNotifications ( );
	void GetRankNotifications ( );
...
public:
	...
	void eventSetPrivate ( unsigned long isPrivate );
	bool eventIsPrivateMatch ( );
};
