...
//	void addChoice(wstring choice) { cL.push_back(choice); }
//	// All Controls
//	wstring label;
//	int xOffset;
//	int yOffset;
...
//	tabList tL; // CTab
//
//	typedef vector<wstring> choiceList; // CDropDown
//	choiceList cL;
...
//{
//public:
//	CLabel(wstring label, int xOffset, int yOffset, DWORD align)
//	{
//		this->label = label;
...
//{
//public: 
//	CGroupBox(wstring label, int xOffset, int yOffset, int width, int height)
//	{
//		this->label = label;
//		this->xOffset = xOffset;
//		this->yOffset = yOffset;
...
//{
//public: 
//	CButton(wstring label, int xOffset, int yOffset, int width, int height, void* function)
//	{
//		this->label = label;
//		this->xOffset = xOffset;
//		this->yOffset = yOffset;
...
//{
//public: 
//	CCheckbox(wstring label, int xOffset, int yOffset, void* value)
//	{ 
//		this->label = label; 
//		this->xOffset = xOffset; 
//		this->yOffset = yOffset;
...
//{
//public:
//	CRadioButton(wstring label, int xOffset, int yOffset, int group)
//	{ 
//		this->label = label; 
//		this->xOffset = xOffset; 
//		this->yOffset = yOffset;
...
//{
//public:
//	CDropDown(wstring label, int xOffset, int yOffset, void* value)
//	{
//		this->label = label;
//		this->xOffset = xOffset;
//		this->yOffset = yOffset;
...
//{
//public:
//	CSlider(wstring label, int xOffset, int yOffset, int min, int max, void* value)
//	{ 
//		this->label = label; 
//		this->xOffset = xOffset; 
//		this->yOffset = yOffset;
...
//{
//public:
//	CMenu(wstring title) { CMenu(title, 100, 100, 100, 100, NULL); }
//	CMenu(wstring title, int x, int y) { CMenu(title, x, y, 100, 100, NULL); }
//	CMenu(wstring title, int x, int y, int w, int h) { CMenu(title, x, y, w, h, NULL); }
//	CMenu(wstring title, int x, int y, int w, int h, DWORD style);
//
...
//
//	void MessageBox(wstring title, wstring message);
//
