...
// [0x00120000] 
struct UGFxEngine_execMoviesDeleted_Parms
{
};
...
// [0x00020802] ( FUNC_Event )
struct UGFxObject_eventGetNextHighestDepth_Parms
{
...
struct UGFxObject_eventAttachMovieClip_Parms
{
	...
	class UClass*                                      Type;                                             		// 0x0018 (0x0004) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
...
// [0x00020002] 
struct UGFxObject_execInvokeNoParams_Parms
{
	struct FString                                     MemberName;                                       		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	struct FASValue                                    ReturnValue;                                      		// 0x000C (0x0018) [0x0000000000400580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
	// TArray< struct FASValue >                       EmptyArgs;                                        		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
