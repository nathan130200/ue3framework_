...
public:
	...
	unsigned char                                      UnknownData01[ 0x30 ];                            		// 0x01A0 (0x0030) MISSED OFFSET
...
// Class WinDrv.CloudStorageWindows
// 0x000C (0x0060 - 0x0054)
class UCloudStorageWindows : public UCloudStorageBase
{
public:
...
UClass* UCloudStorageWindows::pClassPointer = NULL;
