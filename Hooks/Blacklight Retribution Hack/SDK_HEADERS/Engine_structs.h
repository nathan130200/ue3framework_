...
struct FPlayerResponseLine
{
	...
	TArray< struct AInfo_FKeyValuePair >               PlayerInfo;                                       		// 0x0020 (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FServerResponseLine
{
	...
	TArray< struct AInfo_FKeyValuePair >               ServerInfo;                                       		// 0x0048 (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
...
struct FOnlinePlayerScore
{
	...
	struct FString                                     StatGuid;                                         		// 0x001C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
// ScriptStruct Engine.OnlineSubsystem.NamedLobby
// 0x0018
struct FNamedLobby
{
	struct FName                                       LobbyName;                                        		// 0x0000 (0x0008) [0x0000000000000000]              
	struct FPointer                                    LobbyInfo;                                        		// 0x0008 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	TArray< struct FOnlineRegistrant >                 Registrants;                                      		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FOnlineFriend
{
	...
	unsigned char                                      Platform;                                         		// 0x0029 (0x0001) [0x0000000000000002]              ( CPF_Const )
	...
	unsigned long                                      bIsInYourParty : 1;                               		// 0x002C (0x0004) [0x0000000000000002] [0x00000080] ( CPF_Const )
	unsigned long                                      bIsOnSameConsole : 1;                             		// 0x002C (0x0004) [0x0000000000000002] [0x00000100] ( CPF_Const )
	struct FString                                     PresenceLocation;                                 		// 0x0030 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	unsigned char                                      AcceptStatus;                                     		// 0x003C (0x0001) [0x0000000000000002]              ( CPF_Const )
	struct FUniqueNetId                                OwnerID;                                          		// 0x0040 (0x0008) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      bFriendShipOwner : 1;                             		// 0x0048 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
	struct FString                                     OwnerName;                                        		// 0x004C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	int                                                TitleData;                                        		// 0x0058 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FQWord                                      BadgeData;                                        		// 0x005C (0x0008) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      bIsFemale : 1;                                    		// 0x0064 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
	struct FString                                     DateAdded;                                        		// 0x0068 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     LastSeen;                                         		// 0x0074 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                Experience;                                       		// 0x0080 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
struct FAnimBlendInfo
{
	...
	float                                              WeightMultiplier;                                 		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FAnimInfo                                   AnimInfo;                                         		// 0x000C (0x0010) [0x0000000000000000]              
...
// ScriptStruct Engine.Pawn.FlashLocData
// 0x000D
struct FFlashLocData
{
	struct FVector                                     Location;                                         		// 0x0000 (0x000C) [0x0000000000000000]              
	unsigned char                                      OptionalFlag;                                     		// 0x000C (0x0001) [0x0000000000000000]              
};
...
struct FCullDistanceSizePair
{
	...
	float                                              ScreenSpaceMultiplier;                            		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FKeyBind
{
	...
	struct FName                                       SecondaryName;                                    		// 0x0008 (0x0008) [0x0000000000004000]              ( CPF_Config )
	struct FName                                       GamePadName;                                      		// 0x0010 (0x0008) [0x0000000000004000]              ( CPF_Config )
	struct FString                                     Command;                                          		// 0x0018 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	unsigned long                                      Control : 1;                                      		// 0x0024 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	unsigned long                                      Shift : 1;                                        		// 0x0024 (0x0004) [0x0000000000004000] [0x00000002] ( CPF_Config )
	unsigned long                                      Alt : 1;                                          		// 0x0024 (0x0004) [0x0000000000004000] [0x00000004] ( CPF_Config )
	unsigned long                                      bIgnoreCtrl : 1;                                  		// 0x0024 (0x0004) [0x0000000000004000] [0x00000008] ( CPF_Config )
	unsigned long                                      bIgnoreShift : 1;                                 		// 0x0024 (0x0004) [0x0000000000004000] [0x00000010] ( CPF_Config )
	unsigned long                                      bIgnoreAlt : 1;                                   		// 0x0024 (0x0004) [0x0000000000004000] [0x00000020] ( CPF_Config )
};
...
struct FParticleSysParam
{
	...
	struct FLinearColor                                LinColor;                                         		// 0x0030 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	class AActor*                                      Actor;                                            		// 0x0040 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
struct FPlayerInformation
{
	...
	unsigned long                                      bIsBot : 1;                                       		// 0x001C (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FGameSessionInformation
{
	...
	int                                                PlaylistId;                                       		// 0x006C (0x0004) [0x0000000000000000]              
};

// ScriptStruct Engine.GameReplicationInfo.VoipInfo
// 0x001C
struct FVoipInfo
{
	struct FString                                     Address;                                          		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                Port;                                             		// 0x000C (0x0004) [0x0000000000000000]              
	struct FString                                     ChannelName;                                      		// 0x0010 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FLandscapeLayerInfo
{
	...
	unsigned long                                      bSelected : 1;                                    		// 0x000C (0x0004) [0x0000000000002000] [0x00000002] ( CPF_Transient )
...
// ScriptStruct Engine.LFXSubsystem.LFXLight
// 0x000C
struct FLFXLight
{
	struct FString                                     Description;                                      		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};

// ScriptStruct Engine.LFXSubsystem.LFXDevice
// 0x001C
struct FLFXDevice
{
	int                                                Index;                                            		// 0x0000 (0x0004) [0x0000000000000000]              
	struct FString                                     Description;                                      		// 0x0004 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FLFXLight >                         Lights;                                           		// 0x0010 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};

// ScriptStruct Engine.LFXSubsystem.LFXAction
// 0x002C
struct FLFXAction
{
	struct FName                                       ActionName;                                       		// 0x0000 (0x0008) [0x0000000000000000]              
	struct FColor                                      PriColor;                                         		// 0x0008 (0x0004) [0x0000000000000000]              
	struct FColor                                      SecColor;                                         		// 0x000C (0x0004) [0x0000000000000000]              
	float                                              Duration;                                         		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                ResolvedLoc;                                      		// 0x0014 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              DurationLeft;                                     		// 0x0018 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              LifetimeRatio;                                    		// 0x001C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              LastTickTime;                                     		// 0x0020 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      ActionType;                                       		// 0x0024 (0x0001) [0x0000000000000000]              
	unsigned char                                      Priority;                                         		// 0x0025 (0x0001) [0x0000000000000000]              
	unsigned long                                      bResetOnDestroy : 1;                              		// 0x0028 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bResetOnBecomeRelevant : 1;                       		// 0x0028 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bResetOnLeaveRelevant : 1;                        		// 0x0028 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bValid : 1;                                       		// 0x0028 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bAll : 1;                                         		// 0x0028 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bTop : 1;                                         		// 0x0028 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bBottom : 1;                                      		// 0x0028 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bFront : 1;                                       		// 0x0028 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bBack : 1;                                        		// 0x0028 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bLeft : 1;                                        		// 0x0028 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bRight : 1;                                       		// 0x0028 (0x0004) [0x0000000000000000] [0x00000400] 
};

// ScriptStruct Engine.LFXSubsystem.MovieMap
// 0x0038
struct FMovieMap
{
	struct FString                                     FileName;                                         		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FLFXAction                                  Action;                                           		// 0x000C (0x002C) [0x0000000000000000]              
};

// ScriptStruct Engine.LibCurlSubsystem.HTTPRequestInput
// 0x003D
struct FHTTPRequestInput
{
	struct FString                                     RequestURL;                                       		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     RequestSSLCert;                                   		// 0x000C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     RequestSSLKey;                                    		// 0x0018 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< unsigned char >                            RequestPOSTData;                                  		// 0x0024 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< unsigned char >                            RequestHeaderData;                                		// 0x0030 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	unsigned char                                      RequestType;                                      		// 0x003C (0x0001) [0x0000000000000000]              
};

// ScriptStruct Engine.LibCurlSubsystem.LibCurlRequestData
// 0x0158
struct FLibCurlRequestData
{
	struct FHTTPRequestInput                           RequestInput;                                     		// 0x0000 (0x0040) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                RequestHandle;                                    		// 0x0040 (0x0004) [0x0000000000000000]              
	struct FPointer                                    OutData;                                          		// 0x0044 (0x0004) [0x0000000000000000]              
	int                                                OutSize;                                          		// 0x0048 (0x0004) [0x0000000000000000]              
	struct FScriptDelegate                             CompletedDelegate;                                		// 0x004C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      ErrorData[ 0x100 ];                               		// 0x0058 (0x0100) [0x0000000000000000]              
};
...
{
	struct FPostProcessSettings                        Settings;                                         		// 0x0000 (0x00E0) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bBlendingIn : 1;                                  		// 0x00E0 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bBlendingOut : 1;                                 		// 0x00E0 (0x0004) [0x0000000000000000] [0x00000002] 
	float                                              CurrentBlendInTime;                               		// 0x00E4 (0x0004) [0x0000000000000000]              
	float                                              CurrentBlendOutTime;                              		// 0x00E8 (0x0004) [0x0000000000000000]              
	float                                              BlendInDuration;                                  		// 0x00EC (0x0004) [0x0000000000000000]              
	float                                              BlendOutDuration;                                 		// 0x00F0 (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x00F4 (0x0004) [0x0000000000000000]              
};
...
struct FCurrentPostProcessVolumeInfo
{
	...
	class APostProcessVolume*                          LastVolumeUsed;                                   		// 0x00E0 (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x00E4 (0x0004) [0x0000000000000000]              
	float                                              LastBlendTime;                                    		// 0x00E8 (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct Engine.LogitechKBSubsystem.ScoreInfo
// 0x003C
struct FScoreInfo
{
	...
	int                                                MinutesRemaining;                                 		// 0x0018 (0x0004) [0x0000000000000000]              
	int                                                SecondsRemaining;                                 		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                TeamScore;                                        		// 0x0020 (0x0004) [0x0000000000000000]              
	int                                                EnemyScore;                                       		// 0x0024 (0x0004) [0x0000000000000000]              
	int                                                PlayerScore;                                      		// 0x0028 (0x0004) [0x0000000000000000]              
	int                                                CPCount;                                          		// 0x002C (0x0004) [0x0000000000000000]              
	int                                                KillCount;                                        		// 0x0030 (0x0004) [0x0000000000000000]              
	int                                                AssistCount;                                      		// 0x0034 (0x0004) [0x0000000000000000]              
	int                                                DeathCount;                                       		// 0x0038 (0x0004) [0x0000000000000000]              
};

// ScriptStruct Engine.LogitechKBSubsystem.TacticalInfo
// 0x0050
struct FTacticalInfo
{
	int                                                PrimAmmoInClip;                                   		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                PrimAmmoClipMax;                                  		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                PrimAmmoLeft;                                     		// 0x0008 (0x0004) [0x0000000000000000]              
	int                                                PrimAmmoMax;                                      		// 0x000C (0x0004) [0x0000000000000000]              
	int                                                SecAmmoInClip;                                    		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                SecAmmoClipMax;                                   		// 0x0014 (0x0004) [0x0000000000000000]              
	int                                                SecAmmoLeft;                                      		// 0x0018 (0x0004) [0x0000000000000000]              
	int                                                SecAmmoMax;                                       		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                Tac1AmmoInClip;                                   		// 0x0020 (0x0004) [0x0000000000000000]              
	int                                                Tac1AmmoLeft;                                     		// 0x0024 (0x0004) [0x0000000000000000]              
	int                                                Tac2AmmoInClip;                                   		// 0x0028 (0x0004) [0x0000000000000000]              
	int                                                Tac2AmmoLeft;                                     		// 0x002C (0x0004) [0x0000000000000000]              
	int                                                Tac3AmmoInClip;                                   		// 0x0030 (0x0004) [0x0000000000000000]              
	int                                                Tac3AmmoLeft;                                     		// 0x0034 (0x0004) [0x0000000000000000]              
	int                                                Tac4AmmoInClip;                                   		// 0x0038 (0x0004) [0x0000000000000000]              
	int                                                Tac4AmmoLeft;                                     		// 0x003C (0x0004) [0x0000000000000000]              
	int                                                PlayerHealth;                                     		// 0x0040 (0x0004) [0x0000000000000000]              
	int                                                PlayerHealthMax;                                  		// 0x0044 (0x0004) [0x0000000000000000]              
	float                                              PlayerStamina;                                    		// 0x0048 (0x0004) [0x0000000000000000]              
	float                                              PlayerStaminaMax;                                 		// 0x004C (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct Engine.OnlineLeaderboardRead.OnlineLeaderboardRow
// 0x000C(0x0038 - 0x002C)
struct FOnlineLeaderboardRow : FOnlineStatsRow
{
	struct FSettingsData                               Score;                                            		// 0x002C (0x000C) [0x0000000000000002]              ( CPF_Const )
};

// ScriptStruct Engine.OnlineStatsWrite.StatMappingEntry
// 0x000C
struct FStatMappingEntry
{
	struct FName                                       StatName;                                         		// 0x0000 (0x0008) [0x0000000000000002]              ( CPF_Const )
...
// ScriptStruct Engine.UIDataStore_Registry.KeyValuePair
// 0x0018
struct UUIDataStore_Registry_FKeyValuePair
{
