...
public:
	...
	class APlayerController*                           PlayerOwner;                                      		// 0x00D0 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	int                                                LocalPlayerOwnerIndex;                            		// 0x00D4 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class UObject*                                     ExternalInterface;                                		// 0x00D8 (0x0004) [0x0000000000000000]              
	TArray< struct FName >                             CaptureKeys;                                      		// 0x00DC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FName >                             FocusIgnoreKeys;                                  		// 0x00E8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      SceneDPG;                                         		// 0x00F4 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      TimingMode;                                       		// 0x00F5 (0x0001) [0x0000000000000000]              
	unsigned char                                      RenderTextureMode;                                		// 0x00F6 (0x0001) [0x0000000000000000]              
	unsigned char                                      Priority;                                         		// 0x00F7 (0x0001) [0x0000000000000000]              
	TArray< struct FExternalTexture >                  ExternalTextures;                                 		// 0x00F8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FSoundThemeBinding >                SoundThemes;                                      		// 0x0104 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FGFxWidgetBinding >                 WidgetBindings;                                   		// 0x0110 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      UnknownData02[ 0x3C ];                            		// 0x011C (0x003C) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetPathBindings
	TArray< class UGFxObject* >                        ObjectValues;                                     		// 0x0158 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UGFxObject*                                  SplitscreenLayoutObject;                          		// 0x0164 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	int                                                SplitscreenLayoutYAdjust;                         		// 0x0168 (0x0004) [0x0000000000004000]              ( CPF_Config )
...
public:
	...
	struct FScriptDelegate                             __MoviesDeleted__Delegate;                        		// 0x004C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	int eventGetNextHighestDepth ( );
	class UGFxObject* eventAttachMovieClip ( struct FString symbolname, struct FString instancename, class UClass* Type );
	...
	struct FASValue InvokeNoParams ( struct FString MemberName );
...
{
public:
	class UGFxMoviePlayer*                             Movie;                                            		// 0x00F0 (0x0004) [0x0000000000000000]              
	unsigned long                                      bUnload : 1;                                      		// 0x00F4 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
{
public:
	class USwfMovie*                                   Movie;                                            		// 0x00F0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UClass*                                      MoviePlayerClass;                                 		// 0x00F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UGFxMoviePlayer*                             MoviePlayer;                                      		// 0x00F8 (0x0004) [0x0000000000000000]              
	unsigned long                                      bTakeFocus : 1;                                   		// 0x00FC (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bCaptureInput : 1;                                		// 0x00FC (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bStartPaused : 1;                                 		// 0x00FC (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bEnableGammaCorrection : 1;                       		// 0x00FC (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bDisplayWithHudOff : 1;                           		// 0x00FC (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned char                                      RenderTextureMode;                                		// 0x0100 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	class UTextureRenderTarget2D*                      RenderTexture;                                    		// 0x0104 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FName >                             CaptureKeys;                                      		// 0x0108 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             FocusIgnoreKeys;                                  		// 0x0114 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	class USwfMovie*                                   Movie;                                            		// 0x0108 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     FSCommand;                                        		// 0x010C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UGFxFSCmdHandler_Kismet*                     Handler;                                          		// 0x0118 (0x0004) [0x0000000000000000]              
