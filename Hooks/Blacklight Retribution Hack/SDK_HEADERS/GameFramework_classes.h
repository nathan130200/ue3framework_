...
public:
	...
	int                                                LoopCount;                                        		// 0x0238 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	TArray< struct FRequiredMobileInputConfig >        RequiredMobileInputConfigs;                       		// 0x0374 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
{
public:
	class UGameAICommand*                              CommandList;                                      		// 0x0388 (0x0004) [0x0000000004002003]              ( CPF_Edit | CPF_Const | CPF_Transient | CPF_EditInline )
	unsigned long                                      bHasRunawayCommandList : 1;                       		// 0x038C (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
	...
	unsigned long                                      bAIBroken : 1;                                    		// 0x038C (0x0004) [0x0000000000002000] [0x00000040] ( CPF_Transient )
	class AFileLog*                                    AILogFile;                                        		// 0x0390 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              DebugTextMaxLen;                                  		// 0x0394 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FAICmdHistoryItem >                 CommandHistory;                                   		// 0x0398 (0x000C) [0x0000000000402003]              ( CPF_Edit | CPF_Const | CPF_Transient | CPF_NeedCtorLink )
	int                                                CommandHistoryNum;                                		// 0x03A4 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	TArray< struct FName >                             AILogFilter;                                      		// 0x03A8 (0x000C) [0x0000000000404001]              ( CPF_Edit | CPF_Config | CPF_NeedCtorLink )
	struct FString                                     DemoActionString;                                 		// 0x03B4 (0x000C) [0x0000000000400020]              ( CPF_Net | CPF_NeedCtorLink )
...
public:
	...
	int                                                Health;                                           		// 0x01FC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	...
	int                                                ConformTraceFrameCount;                           		// 0x0208 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< struct FNearbyDynamicItem >                NearbyDynamics;                                   		// 0x020C (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	unsigned long                                      bUniformScale : 1;                                		// 0x0218 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bCheckForObstacles : 1;                           		// 0x0218 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bUseNavMeshPathing : 1;                           		// 0x0218 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bWantsSeePlayerNotification : 1;                  		// 0x0218 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bAllowPitching : 1;                               		// 0x0218 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bHitObstacle : 1;                                 		// 0x0218 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bBadHitNormal : 1;                                		// 0x0218 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bSimulateThisTick : 1;                            		// 0x0218 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bPotentialEncounter : 1;                          		// 0x0218 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bIsPanicked : 1;                                  		// 0x0218 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bWantsGroupIdle : 1;                              		// 0x0218 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bPreferVisibleDestination : 1;                    		// 0x0218 (0x0004) [0x0000000000000001] [0x00000800] ( CPF_Edit )
	unsigned long                                      bPreferVisibleDestinationOnSpawn : 1;             		// 0x0218 (0x0004) [0x0000000000000001] [0x00001000] ( CPF_Edit )
	unsigned long                                      bHasNotifiedSpawner : 1;                          		// 0x0218 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bIsInSpawnPool : 1;                               		// 0x0218 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bPaused : 1;                                      		// 0x0218 (0x0004) [0x0000000000000001] [0x00008000] ( CPF_Edit )
	unsigned char                                      ConformType;                                      		// 0x021C (0x0001) [0x0000000000000001]              ( CPF_Edit )
	float                                              ConformTraceDist;                                 		// 0x0220 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                ConformTraceInterval;                             		// 0x0224 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                CurrentConformTraceInterval;                      		// 0x0228 (0x0004) [0x0000000000000000]              
	...
	TArray< struct FAvoidOtherSampleItem >             AvoidOtherSampleList;                             		// 0x0238 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	...
	int                                                ExtraPathCost;                                    		// 0x0264 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	...
	int                                                ObstacleCheckCount;                               		// 0x02C4 (0x0004) [0x0000000000000000]              
	...
	TArray< struct FRecentInteraction >                RecentInteractions;                               		// 0x02E8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	TArray< struct FBehaviorEntry >                    EncounterAgentBehaviors;                          		// 0x0328 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    SeePlayerBehaviors;                               		// 0x0334 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	...
	TArray< struct FBehaviorEntry >                    SpawnBehaviors;                                   		// 0x0348 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    UneasyBehaviors;                                  		// 0x0354 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    AlertBehaviors;                                   		// 0x0360 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	...
	TArray< struct FBehaviorEntry >                    TakeDamageBehaviors;                              		// 0x0384 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	...
	TArray< struct FBehaviorEntry >                    GroupWaitingBehaviors;                            		// 0x039C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	...
	class UGameCrowdSpawnerInterface*                  MySpawner;                                        		// 0x03B4 (0x0008) [0x0000000000000000]              
	unsigned char                                      UnknownData00[ 0x4 ];                             		// 0x03B8 (0x0004) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	TArray< struct FName >                             WalkAnimNames;                                    		// 0x03F0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             RunAnimNames;                                     		// 0x03FC (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             IdleAnimNames;                                    		// 0x0408 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             DeathAnimNames;                                   		// 0x0414 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	...
	struct FName                                       MoveSyncGroupName;                                		// 0x0430 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FGameCrowdAttachmentList >          Attachments;                                      		// 0x0438 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              MaxTargetAcquireTime;                             		// 0x0444 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bUseRootMotionVelocity : 1;                       		// 0x0448 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bIsPlayingIdleAnimation : 1;                      		// 0x0448 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bIsPlayingDeathAnimation : 1;                     		// 0x0448 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bAnimateThisTick : 1;                             		// 0x0448 (0x0004) [0x0000000000000000] [0x00000008] 
	float                                              MaxAnimationDistance;                             		// 0x044C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxAnimationDistanceSq;                           		// 0x0450 (0x0004) [0x0000000000000000]              
...
{
public:
	TArray< class AGameCrowdDestination* >             PotentialSpawnPoints;                             		// 0x01F4 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	unsigned long                                      bIsEnabled : 1;                                   		// 0x01C8 (0x0004) [0x0000000000000021] [0x00000001] ( CPF_Edit | CPF_Net )
...
public:
	...
	unsigned char                                      EventType;                                        		// 0x01D8 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bRequireLOS : 1;                                  		// 0x01DC (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
public:
	...
	unsigned long                                      bKillWhenReached : 1;                             		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bAllowAsPreviousDestination : 1;                  		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bAvoidWhenPanicked : 1;                           		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bSkipBehaviorIfPanicked : 1;                      		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bFleeDestination : 1;                             		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bMustReachExactly : 1;                            		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bHasRestrictions : 1;                             		// 0x01D4 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bAllowsSpawning : 1;                              		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000080] ( CPF_Edit )
	unsigned long                                      bAllowCloudSpawning : 1;                          		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000100] ( CPF_Edit )
	unsigned long                                      bAllowVisibleSpawning : 1;                        		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000200] ( CPF_Edit )
	unsigned long                                      bLineSpawner : 1;                                 		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000400] ( CPF_Edit )
	unsigned long                                      bSpawnAtEdge : 1;                                 		// 0x01D4 (0x0004) [0x0000000000000001] [0x00000800] ( CPF_Edit )
	unsigned long                                      bSoftPerimeter : 1;                               		// 0x01D4 (0x0004) [0x0000000000000001] [0x00001000] ( CPF_Edit )
	unsigned long                                      bIsVisible : 1;                                   		// 0x01D4 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bWillBeVisible : 1;                               		// 0x01D4 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bCanSpawnHereNow : 1;                             		// 0x01D4 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bIsBeyondSpawnDistance : 1;                       		// 0x01D4 (0x0004) [0x0000000000000000] [0x00010000] 
	unsigned long                                      bAdjacentToVisibleNode : 1;                       		// 0x01D4 (0x0004) [0x0000000000000000] [0x00020000] 
	unsigned long                                      bHasNavigationMesh : 1;                           		// 0x01D4 (0x0004) [0x0000000000000000] [0x00040000] 
	TArray< class AGameCrowdDestination* >             NextDestinations;                                 		// 0x01D8 (0x000C) [0x0000000000600001]              ( CPF_Edit | CPF_NeedCtorLink )
	class AGameCrowdDestinationQueuePoint*             QueueHead;                                        		// 0x01E4 (0x0004) [0x0000000000200001]              ( CPF_Edit )
	int                                                Capacity;                                         		// 0x01E8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Frequency;                                        		// 0x01EC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                CustomerCount;                                    		// 0x01F0 (0x0004) [0x0000000000000000]              
	TArray< class UClass* >                            SupportedAgentClasses;                            		// 0x01F4 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UObject* >                           SupportedArchetypes;                              		// 0x0200 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UClass* >                            RestrictedAgentClasses;                           		// 0x020C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UObject* >                           RestrictedArchetypes;                             		// 0x0218 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              ExactReachTolerance;                              		// 0x0224 (0x0004) [0x0000000000000000]              
	struct FName                                       InteractionTag;                                   		// 0x0228 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              InteractionDelay;                                 		// 0x0230 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FBehaviorEntry >                    ReachedBehaviors;                                 		// 0x0234 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	...
	unsigned long                                      bClearingQueue : 1;                               		// 0x01E0 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bPendingAdvance : 1;                              		// 0x01E0 (0x0004) [0x0000000000000000] [0x00000002] 
...
public:
	...
	TArray< struct FCrowdSpawnInfoItem >               ScriptedSpawnInfo;                                		// 0x0248 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class AGameCrowdInfoVolume*                        ActiveCrowdInfoVolume;                            		// 0x0254 (0x0004) [0x0000000000000000]              
	TArray< class AGameCrowdDestination* >             GlobalPotentialSpawnPoints;                       		// 0x0258 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	TArray< struct FCrowdSpawnerPlayerInfo >           PlayerInfo;                                       		// 0x027C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              LastPlayerInfoUpdateTime;                         		// 0x0288 (0x0004) [0x0000000000000000]              
	unsigned long                                      bDebugSpawns : 1;                                 		// 0x028C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bPauseCrowd : 1;                                  		// 0x028C (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
...
{
public:
	class USeqAct_GameCrowdSpawner*                    Spawner;                                          		// 0x01C8 (0x0004) [0x0000000000000020]              ( CPF_Net )
	unsigned long                                      bSpawningActive : 1;                              		// 0x01CC (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	int                                                DestroyAllCount;                                  		// 0x01D0 (0x0004) [0x0000000000000020]              ( CPF_Net )
...
{
public:
	unsigned long                                      bHasExploded : 1;                                 		// 0x01C8 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
	unsigned long                                      bExplodeMoreThanOnce : 1;                         		// 0x01C8 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bTrackExplosionParticleSystemLifespan : 1;        		// 0x01C8 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bDrawDebug : 1;                                   		// 0x01C8 (0x0004) [0x0000000000000000] [0x00000008] 
...
{
public:
	unsigned long                                      bLastHitWasHeadShot : 1;                          		// 0x0460 (0x0004) [0x0000000000002020] [0x00000001] ( CPF_Net | CPF_Transient )
	unsigned long                                      bRespondToExplosions : 1;                         		// 0x0460 (0x0004) [0x0000000000000000] [0x00000002] 
...
// 0x0014 (0x05B8 - 0x05A4)
class AGamePlayerController : public APlayerController
{
public:
	unsigned long                                      bWarnCrowdMembers : 1;                            		// 0x05A4 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bDebugCrowdAwareness : 1;                         		// 0x05A4 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bIsWarmupPaused : 1;                              		// 0x05A4 (0x0004) [0x0000000000002000] [0x00000004] ( CPF_Transient )
	unsigned long                                      bEnableMouseCursor : 1;                           		// 0x05A4 (0x0004) [0x0000000000000000] [0x00000008] 
	float                                              AgentAwareRadius;                                 		// 0x05A8 (0x0004) [0x0000000000000000]              
	class AZEGameHud*                                  MyGameHud;                                        		// 0x05AC (0x0004) [0x0000000000000000]              
	struct FName                                       CurrentSoundMode;                                 		// 0x05B0 (0x0008) [0x0000000000002000]              ( CPF_Transient )
...
// 0x00EC (0x053C - 0x0450)
class AMobileHUD : public AHUD
{
public:
	unsigned long                                      bShowGameHud : 1;                                 		// 0x0450 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	unsigned long                                      bShowMobileHud : 1;                               		// 0x0450 (0x0004) [0x0000000000004000] [0x00000002] ( CPF_Config )
	unsigned long                                      bForceMobileHUD : 1;                              		// 0x0450 (0x0004) [0x0000000000044000] [0x00000004] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bShowMobileTilt : 1;                              		// 0x0450 (0x0004) [0x0000000000004000] [0x00000008] ( CPF_Config )
	unsigned long                                      bDebugTouches : 1;                                		// 0x0450 (0x0004) [0x0000000000004000] [0x00000010] ( CPF_Config )
	unsigned long                                      bDebugZones : 1;                                  		// 0x0450 (0x0004) [0x0000000000004000] [0x00000020] ( CPF_Config )
	unsigned long                                      bDebugZonePresses : 1;                            		// 0x0450 (0x0004) [0x0000000000004000] [0x00000040] ( CPF_Config )
	unsigned long                                      bShowMotionDebug : 1;                             		// 0x0450 (0x0004) [0x0000000000004000] [0x00000080] ( CPF_Config )
	...
	class UTexture2D*                                  ButtonImages[ 0x2 ];                              		// 0x047C (0x0008) [0x0000000000000000]              
	struct FTextureUVs                                 ButtonUVs[ 0x2 ];                                 		// 0x0484 (0x0020) [0x0000000000000000]              
	...
	class UTexture2D*                                  SliderImages[ 0x4 ];                              		// 0x04D4 (0x0010) [0x0000000000000000]              
	struct FTextureUVs                                 SliderUVs[ 0x4 ];                                 		// 0x04E4 (0x0040) [0x0000000000000000]              
	...
	TArray< class USeqEvent_HudRender* >               KismetRenderEvents;                               		// 0x0530 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	class UTexture2D*                                  Image;                                            		// 0x0094 (0x0004) [0x0000000000000000]              
	unsigned char                                      ImageDrawStyle;                                   		// 0x0098 (0x0001) [0x0000000000000000]              
	struct FUVCoords                                   ImageUVs;                                         		// 0x009C (0x0014) [0x0000000000000000]              
...
// 0x0274 (0x03F0 - 0x017C)
class UMobilePlayerInput : public UPlayerInput
{
public:
	struct FTouchData                                  Touches[ 0x5 ];                                   		// 0x017C (0x0168) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UMobileMenuObject*                           InteractiveObject;                                		// 0x02E4 (0x0004) [0x0000000000000000]              
	TArray< struct FMobileInputGroup >                 MobileInputGroups;                                		// 0x02E8 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
	int                                                CurrentMobileGroup;                               		// 0x02F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< class UMobileInputZone* >                  MobileInputZones;                                 		// 0x02F8 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
	TArray< struct FMobileInputZoneClassMap >          MobileInputZoneClasses;                           		// 0x0304 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bSupportsAccelerometer : 1;                       		// 0x0310 (0x0004) [0x0000000000000003] [0x00000001] ( CPF_Edit | CPF_Const )
	unsigned long                                      bAllowTouchesInCinematic : 1;                     		// 0x0310 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bDisableTouchInput : 1;                           		// 0x0310 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bFakeMobileTouches : 1;                           		// 0x0310 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bDeviceHasGyroscope : 1;                          		// 0x0310 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bDeviceHasAccelerometer : 1;                      		// 0x0310 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	float                                              MobilePitch;                                      		// 0x0314 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobilePitchCenter;                                		// 0x0318 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobilePitchMultiplier;                            		// 0x031C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobileYaw;                                        		// 0x0320 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobileYawCenter;                                  		// 0x0324 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobileYawMultiplier;                              		// 0x0328 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobilePitchDeadzoneSize;                          		// 0x032C (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              MobileYawDeadzoneSize;                            		// 0x0330 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              MobileDoubleTapTime;                              		// 0x0334 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              MobileMinHoldForTap;                              		// 0x0338 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              MobileTapRepeatTime;                              		// 0x033C (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              ZoneTimeout;                                      		// 0x0340 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	TArray< class UMobileMenuScene* >                  MobileMenuStack;                                  		// 0x0344 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     NativeDebugString;                                		// 0x0350 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              MobileInactiveTime;                               		// 0x035C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DeviceMotionAttitude;                             		// 0x0360 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DeviceMotionRotationRate;                         		// 0x036C (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DeviceMotionGravity;                              		// 0x0378 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DeviceMotionAcceleration;                         		// 0x0384 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	TArray< class USeqEvent_MobileBase* >              MobileSeqEventHandlers;                           		// 0x0390 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class USeqEvent_MobileRawInput* >          MobileRawInputSeqEventHandlers;                   		// 0x039C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FVector                                     DeviceGyroRawData;                                		// 0x03A8 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DeviceAccelerometerRawData;                       		// 0x03B4 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FScriptDelegate                             __OnMobileMotion__Delegate;                       		// 0x03C0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnTouchNotHandledInMenu__Delegate;              		// 0x03CC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnPreviewTouch__Delegate;                       		// 0x03D8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnInputTouch__Delegate;                         		// 0x03E4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	struct FString                                     MovieName;                                        		// 0x0100 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                StartOfRenderingMovieFrame;                       		// 0x010C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                EndOfRenderingMovieFrame;                         		// 0x0110 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	float                                              ScreenX;                                          		// 0x00F0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ScreenY;                                          		// 0x00F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TraceDistance;                                    		// 0x00F8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UObject*                                     HitObject;                                        		// 0x00FC (0x0004) [0x0000000000000000]              
	struct FVector                                     HitLocation;                                      		// 0x0100 (0x000C) [0x0000000000000000]              
	struct FVector                                     HitNormal;                                        		// 0x010C (0x000C) [0x0000000000000000]              
...
{
public:
	float                                              WarmupPopulationPct;                              		// 0x00F0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UGameCrowd_ListOfAgents*                     CrowdAgentList;                                   		// 0x00F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bClearOldArchetypes : 1;                          		// 0x00F8 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bEnableCrowdLightEnvironment : 1;                 		// 0x00F8 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bCastShadows : 1;                                 		// 0x00F8 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bFillPotentialSpawnPoints : 1;                    		// 0x00F8 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bForceObstacleChecking : 1;                       		// 0x00F8 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bForceNavMeshPathing : 1;                         		// 0x00F8 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bIndividualSpawner : 1;                           		// 0x00F8 (0x0004) [0x0000000000000000] [0x00000040] 
	int                                                MaxAgents;                                        		// 0x00FC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SpawnRate;                                        		// 0x0100 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FLightingChannelContainer                   AgentLightingChannel;                             		// 0x0104 (0x0004) [0x0000000000000000]              
	float                                              MaxSpawnDist;                                     		// 0x0108 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinBehindSpawnDist;                               		// 0x010C (0x0004) [0x0000000000000000]              
	TArray< class AGameCrowdDestination* >             PotentialSpawnPoints;                             		// 0x0110 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              AgentWarmupTime;                                  		// 0x011C (0x0004) [0x0000000000000000]              
	int                                                NumAgentsToTickPerFrame;                          		// 0x0120 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< class AGameCrowdAgent* >                   LastSpawnedList;                                  		// 0x0124 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	struct FName                                       ZoneName;                                         		// 0x00F0 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UMobileInputZone*                            NewZone;                                          		// 0x00F8 (0x0004) [0x0000000004000001]              ( CPF_Edit | CPF_EditInline )
...
{
public:
	struct FString                                     ZoneName;                                         		// 0x00F0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	TArray< struct FPropertyInfo >                     Properties;                                       		// 0x00F0 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
...
{
public:
	TArray< struct FName >                             AnimationList;                                    		// 0x0100 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              BlendInTime;                                      		// 0x010C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BlendOutTime;                                     		// 0x0110 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bUseRootMotion : 1;                               		// 0x0114 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bFaceActionTargetFirst : 1;                       		// 0x0114 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bLooping : 1;                                     		// 0x0114 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bBlendBetweenAnims : 1;                           		// 0x0114 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	int                                                LoopIndex;                                        		// 0x0118 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LoopTime;                                         		// 0x011C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AActor*                                      ActionTarget;                                     		// 0x0120 (0x0004) [0x0000000000000000]              
...
{
public:
	TArray< class UObject* >                           Targets;                                          		// 0x0108 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      bIsActive : 1;                                    		// 0x0114 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              AuthoredGlobalScale;                              		// 0x0118 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	float                                              Roll;                                             		// 0x0108 (0x0004) [0x0000000000000000]              
	float                                              Pitch;                                            		// 0x010C (0x0004) [0x0000000000000000]              
	float                                              Yaw;                                              		// 0x0110 (0x0004) [0x0000000000000000]              
	float                                              DeltaRoll;                                        		// 0x0114 (0x0004) [0x0000000000000000]              
	float                                              DeltaPitch;                                       		// 0x0118 (0x0004) [0x0000000000000000]              
	float                                              DeltaYaw;                                         		// 0x011C (0x0004) [0x0000000000000000]              
...
{
public:
	struct FString                                     TargetZoneName;                                   		// 0x0108 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	unsigned long                                      bWasActiveLastFrame : 1;                          		// 0x0114 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bSendPressedOnlyOnTouchDown : 1;                  		// 0x0114 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bSendPressedOnlyOnTouchUp : 1;                    		// 0x0114 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
...
{
public:
	float                                              XAxisValue;                                       		// 0x0114 (0x0004) [0x0000000000000000]              
	float                                              YAxisValue;                                       		// 0x0118 (0x0004) [0x0000000000000000]              
	float                                              CenterX;                                          		// 0x011C (0x0004) [0x0000000000000000]              
	float                                              CenterY;                                          		// 0x0120 (0x0004) [0x0000000000000000]              
	float                                              CurrentX;                                         		// 0x0124 (0x0004) [0x0000000000000000]              
	float                                              CurrentY;                                         		// 0x0128 (0x0004) [0x0000000000000000]              
...
{
public:
	float                                              Yaw;                                              		// 0x0114 (0x0004) [0x0000000000000000]              
	float                                              StickStrength;                                    		// 0x0118 (0x0004) [0x0000000000000000]              
	struct FVector                                     RotationVector;                                   		// 0x011C (0x000C) [0x0000000000000000]              
...
{
public:
	int                                                TouchIndex;                                       		// 0x0108 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                TouchpadIndex;                                    		// 0x010C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TouchLocationX;                                   		// 0x0110 (0x0004) [0x0000000000000000]              
	float                                              TouchLocationY;                                   		// 0x0114 (0x0004) [0x0000000000000000]              
	float                                              TimeStamp;                                        		// 0x0118 (0x0004) [0x0000000000000000]              
...
{
public:
	float                                              TraceDistance;                                    		// 0x011C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bCheckonTouch : 1;                                		// 0x0120 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FVector                                     FinalTouchLocation;                               		// 0x0124 (0x000C) [0x0000000000000000]              
	struct FVector                                     FinalTouchNormal;                                 		// 0x0130 (0x000C) [0x0000000000000000]              
	class UObject*                                     FinalTouchObject;                                 		// 0x013C (0x0004) [0x0000000000000000]              
	TArray< class UObject* >                           Targets;                                          		// 0x0140 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	float                                              Tolerance;                                        		// 0x011C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinDistance;                                      		// 0x0120 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector2D                                   InitialTouch;                                     		// 0x0124 (0x0008) [0x0000000000000000]              
	TArray< class AActor* >                            TouchedActors;                                    		// 0x012C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              TraceDistance;                                    		// 0x0138 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
// Class GameFramework.ZeOnlineStatsWrite
// 0x0008 (0x00A4 - 0x009C)
class UZeOnlineStatsWrite : public UOnlineStatsWrite
{
public:
	int                                                InstanceId;                                       		// 0x009C (0x0004) [0x0000000000000000]              
	unsigned long                                      bIsActive : 1;                                    		// 0x00A0 (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	...
	struct FString PrintLog ( );
	float GetFloatStat ( int StatId );
	struct FString GetStringStat ( int StatId );
	int GetIntStat ( int StatId );
	void FreeMemory ( );
};

UClass* UZeOnlineStatsWrite::pClassPointer = NULL;

// Class GameFramework.ZeStatsManager
// 0x0014 (0x0050 - 0x003C)
class UZeStatsManager : public UObject
{
public:
	TArray< class UZeOnlineStatsWrite* >               StatsArray;                                       		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                NextUniqueID;                                     		// 0x0048 (0x0004) [0x0000000000000000]              
	int                                                ReferenceCount;                                   		// 0x004C (0x0004) [0x0000000000000000]              
...
public:
	...
	void WriteAllRankedStats ( class UOnlineStatsInterface* StatsInterface );
	void WriteAllNonRankedStats ( struct FName SessionName, class APlayerReplicationInfo* ForPlayer, class UOnlineStatsInterface* StatsInterface );
	void ClearAllStats ( );
	class UZeOnlineStatsWrite* GetActiveStatGroup ( class UClass* DesiredClass );
	bool SetStatGroupsActiveByID ( int GroupID );
	bool SetStatGroupActive ( class UZeOnlineStatsWrite* TheStatsGroup );
	void RemoveStatsGroup ( class UClass* StatsClass );
	class UZeOnlineStatsWrite* AddNewStatsGroup ( class UClass* StatsClass );
	void AddReference ( );
};

UClass* UZeStatsManager::pClassPointer = NULL;

// Class GameFramework.GameSkelControlLimb
// 0x0080 (0x013C - 0x00BC)
class UGameSkelControlLimb : public USkelControlBase
{
public:
	struct FVector                                     EffectorLocation;                                 		// 0x00BC (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FRotator                                    EffectorRotation;                                 		// 0x00C8 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      EffectorSpace;                                    		// 0x00D4 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      JointTargetLocationSpace;                         		// 0x00D5 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      BoneAxis;                                         		// 0x00D6 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      JointAxis;                                        		// 0x00D7 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       EffectorSpaceBoneName;                            		// 0x00D8 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bMaintainEffectorRelRot : 1;                      		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bTakeRotationFromEffectorSpace : 1;               		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bConstrainJointAngles : 1;                        		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bInvertBoneAxis : 1;                              		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bInvertJointAxis : 1;                             		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bRotateJoint : 1;                                 		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bAllowStretching : 1;                             		// 0x00E0 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
	unsigned char                                      UnknownData00[ 0xC ];                             		// 0x00E4 (0x000C) MISSED OFFSET
	struct FBoneAtom                                   CachedUnmodifiedEndBoneAtom;                      		// 0x00F0 (0x0020) [0x0000000000000000]              
	...
	float                                              MaxJointAngle;                                    		// 0x0124 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector2D                                   StretchLimits;                                    		// 0x0128 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       StretchRollBoneName;                              		// 0x0130 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class USkeletalMeshComponent*                      EffectorSpaceOtherComponent;                      		// 0x0138 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
...
UClass* UGameSkelControlLimb::pClassPointer = NULL;
...
// 0x006C (0x04A0 - 0x0434)
class AGamePlayerCamera : public ACamera
{
public:
	class UGameCameraBase*                             ThirdPersonCam;                                   		// 0x0434 (0x0004) [0x0000000004002001]              ( CPF_Edit | CPF_Transient | CPF_EditInline )
	class UClass*                                      ThirdPersonCameraClass;                           		// 0x0438 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class UGameCameraBase*                             FixedCam;                                         		// 0x043C (0x0004) [0x0000000004002001]              ( CPF_Edit | CPF_Transient | CPF_EditInline )
	class UClass*                                      FixedCameraClass;                                 		// 0x0440 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class UGameCameraBase*                             CurrentCamera;                                    		// 0x0444 (0x0004) [0x0000000004002001]              ( CPF_Edit | CPF_Transient | CPF_EditInline )
	unsigned long                                      bUseForcedCamFOV : 1;                             		// 0x0448 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
	unsigned long                                      bInterpolateCamChanges : 1;                       		// 0x0448 (0x0004) [0x0000000000002000] [0x00000002] ( CPF_Transient )
	unsigned long                                      bResetInterp : 1;                                 		// 0x0448 (0x0004) [0x0000000000002000] [0x00000004] ( CPF_Transient )
	float                                              ForcedCamFOV;                                     		// 0x044C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class AActor*                                      LastViewTarget;                                   		// 0x0450 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              SplitScreenShakeScale;                            		// 0x0454 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class AActor*                                      LastTargetBase;                                   		// 0x0458 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      UnknownData00[ 0x4 ];                             		// 0x045C (0x0004) MISSED OFFSET
	struct FMatrix                                     LastTargetBaseTM;                                 		// 0x0460 (0x0040) [0x0000000000002000]              ( CPF_Transient )
...
public:
	...
	float                                              FOVAngle;                                         		// 0x0040 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
...
// Class GameFramework.ZEBehavior
// 0x0008 (0x0044 - 0x003C)
class UZEBehavior : public UObject
{
public:
	class APawn*                                       Agent;                                            		// 0x003C (0x0004) [0x0000000000000000]              
	float                                              BehaviorDelay;                                    		// 0x0040 (0x0004) [0x0000000000000000]              
...
UClass* UZEBehavior::pClassPointer = NULL;

// Class GameFramework.ZEGameHud
// 0x0020 (0x0470 - 0x0450)
class AZEGameHud : public AHUD
{
public:
	struct FString                                     CurrentMessage;                                   		// 0x0450 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	float                                              MessageDisplayTime;                               		// 0x045C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              CurrentMessageStartTime;                          		// 0x0460 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< class AZEHudEffect* >                      HudEffects;                                       		// 0x0464 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
...
public:
	...
	void RemoveAllHudEffects ( );
	bool RemoveHudEffect ( class AZEHudEffect* EffectToRemove );
	class AZEHudEffect* FindHudEffect ( class UClass* EffectClass );
	class AZEHudEffect* SpawnHudEffect ( class UClass* EffectClass );
	void DrawHudEffects ( unsigned long bIsScreenPass );
	void eventPostRender ( );
	void RemoveHUDMessage ( );
	void AddHUDMessage ( struct FString MessageMarkup, float DisplayTime );
	void DrawEngineHUD ( );
};

UClass* AZEGameHud::pClassPointer = NULL;

// Class GameFramework.ZEGameInfo
// 0x0000 (0x0374 - 0x0374)
class AZEGameInfo : public AGameInfo
{
public:
...
UClass* AZEGameInfo::pClassPointer = NULL;

// Class GameFramework.ZeMovieBase
// 0x001C (0x0194 - 0x0178)
class UZeMovieBase : public UGFxMoviePlayer
{
public:
	struct FString                                     MovieLocation;                                    		// 0x0178 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     LocalizationPackageName;                          		// 0x0184 (0x000C) [0x0000000000404002]              ( CPF_Const | CPF_Config | CPF_NeedCtorLink )
	unsigned long                                      bForceLocalization : 1;                           		// 0x0190 (0x0004) [0x0000000000004002] [0x00000001] ( CPF_Const | CPF_Config )
...
public:
	...
	struct FString MarkupHTMLIcon ( struct FString IconRef, int Width, int Height );
	struct FString MarkupImageString ( struct FString IconRef );
	struct FString GetLocalizedString ( struct FString SectionName, struct FString Key );
	bool IsCircleButtonAccept ( );
	void SetMovieVisibility ( unsigned long bShow );
...
UClass* UZeMovieBase::pClassPointer = NULL;

// Class GameFramework.ZeUIBase
// 0x0024 (0x01B8 - 0x0194)
class UZeUIBase : public UZeMovieBase
{
public:
	struct FString                                     CommandGroupFileName;                             		// 0x0194 (0x000C) [0x0000000000404002]              ( CPF_Const | CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           commandGroupStack;                                		// 0x01A0 (0x000C) [0x0000000000001000]              ( CPF_Native )
	struct FString                                     CurrentGroupName;                                 		// 0x01AC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	void ParseAndExecute ( struct FName theCommand, struct FString theParameters );
	void eventui_RunCommandGroup ( struct FString commandParameters );
};

UClass* UZeUIBase::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32761 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32978 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32979 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33071 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33117 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33300 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33750 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34079 ];
...
{
public:
	float                                              DefaultFOV;                                       		// 0x0044 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34100 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34196 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34215 ];
...
{
public:
	class UTexture2D*                                  Images[ 0x2 ];                                    		// 0x0094 (0x0008) [0x0000000000000000]              
	struct FUVCoords                                   ImagesUVs[ 0x2 ];                                 		// 0x009C (0x0028) [0x0000000000000000]              
	struct FLinearColor                                ImageColor;                                       		// 0x00C4 (0x0010) [0x0000000000000000]              
	struct FString                                     Caption;                                          		// 0x00D4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FLinearColor                                CaptionColor;                                     		// 0x00E0 (0x0010) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35055 ];
...
{
public:
	class UClass*                                      InitialSceneToDisplayClass;                       		// 0x0374 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35083 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35094 ];
...
{
public:
	struct FString                                     Caption;                                          		// 0x0094 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UFont*                                       TextFont;                                         		// 0x00A0 (0x0004) [0x0000000000000000]              
	struct FColor                                      TextColor;                                        		// 0x00A4 (0x0004) [0x0000000000000000]              
	struct FColor                                      TouchedColor;                                     		// 0x00A8 (0x0004) [0x0000000000000000]              
	float                                              TextXScale;                                       		// 0x00AC (0x0004) [0x0000000000000000]              
	float                                              TextYScale;                                       		// 0x00B0 (0x0004) [0x0000000000000000]              
	unsigned long                                      bAutoSize : 1;                                    		// 0x00B4 (0x0004) [0x0000000000000000] [0x00000001] 
...
{
public:
	int                                                NumberOfClientsToWaitFor;                         		// 0x0374 (0x0004) [0x0000000000000000]              
	struct FString                                     URLToLoad;                                        		// 0x0378 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35361 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35376 ];
...
{
public:
	struct FLinearColor                                DisplayColor;                                     		// 0x011C (0x0010) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DisplayLocation;                                  		// 0x012C (0x000C) [0x0000000000000001]              ( CPF_Edit )
	class UTexture2D*                                  DisplayTexture;                                   		// 0x0138 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              XL;                                               		// 0x013C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              YL;                                               		// 0x0140 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              U;                                                		// 0x0144 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              V;                                                		// 0x0148 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              UL;                                               		// 0x014C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              VL;                                               		// 0x0150 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35459 ];
...
// 0x0021 (0x013D - 0x011C)
class USeqEvent_HudRenderText : public USeqEvent_HudRender
{
public:
	class UFont*                                       DisplayFont;                                      		// 0x011C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      DisplayColor;                                     		// 0x0120 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DisplayLocation;                                  		// 0x0124 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     DisplayText;                                      		// 0x0130 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned char                                      TextDrawMethod;                                   		// 0x013C (0x0001) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35479 ];
...
// Class GameFramework.ZEAIController
// 0x0004 (0x038C - 0x0388)
class AZEAIController : public AAIController
{
public:
	class UZEBehavior*                                 ActiveBehavior;                                   		// 0x0388 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35552 ];

		return pClassPointer;
	};

	void StartBehavior ( class UZEBehavior* NewBehavior );
	void DetermineBestBehavior ( );
};

UClass* AZEAIController::pClassPointer = NULL;

// Class GameFramework.ZEHudEffect
// 0x001C (0x01E4 - 0x01C8)
class AZEHudEffect : public AActor
{
public:
	class UMaterialInterface*                          BaseMaterial;                                     		// 0x01C8 (0x0004) [0x0000000000000000]              
	class UMaterialInstance*                           ActiveInstance;                                   		// 0x01CC (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class AZEGameHud*                                  GameHud;                                          		// 0x01D0 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              LifeSpanRatio;                                    		// 0x01D4 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              InitialLifeSpan;                                  		// 0x01D8 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              DestructionTime;                                  		// 0x01DC (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned long                                      bAllowMultipleInstances : 1;                      		// 0x01E0 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bScreenEffect : 1;                                		// 0x01E0 (0x0004) [0x0000000000000002] [0x00000002] ( CPF_Const )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35570 ];
	...
	void DrawEffect ( class UCanvas* DrawCanvas );
	void UpdateEffect ( );
	void eventPostBeginPlay ( );
};

UClass* AZEHudEffect::pClassPointer = NULL;

// Class GameFramework.ZEInfoNode
// 0x001C (0x01E4 - 0x01C8)
class AZEInfoNode : public AActor
{
public:
	float                                              Radius;                                           		// 0x01C8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     DebugString;                                      		// 0x01CC (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              DisplayTime;                                      		// 0x01D8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinInterval;                                      		// 0x01DC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LastActivatedTime;                                		// 0x01E0 (0x0004) [0x0000000000002000]              ( CPF_Transient )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35612 ];
...
UClass* AZEInfoNode::pClassPointer = NULL;

// Class GameFramework.ZEMapInfo
// 0x0000 (0x003C - 0x003C)
class UZEMapInfo : public UMapInfo
{
public:
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35631 ];
...
UClass* UZEMapInfo::pClassPointer = NULL;

// Class GameFramework.ZEPawnSoundGroup
// 0x0028 (0x0064 - 0x003C)
class UZEPawnSoundGroup : public UObject
{
public:
	class USoundCue*                                   LandSound;                                        		// 0x003C (0x0004) [0x0000000000000000]              
	class USoundCue*                                   DyingSound;                                       		// 0x0040 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   HitSound;                                         		// 0x0044 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   ScoredHitSound;                                   		// 0x0048 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SprintSound;                                      		// 0x004C (0x0004) [0x0000000000000000]              
	class USoundCue*                                   OutOfBreathSound;                                 		// 0x0050 (0x0004) [0x0000000000000000]              
	TArray< struct FFootstepSoundInfo >                FootstepSounds;                                   		// 0x0054 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class USoundCue*                                   DefaultFootstepSound;                             		// 0x0060 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35680 ];

		return pClassPointer;
	};

	void PlayTakeHitSound ( class APawn* P );
...
UClass* UZEPawnSoundGroup::pClassPointer = NULL;
