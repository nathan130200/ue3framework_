...
// [0x00020000] 
struct UOnlineGameInterfaceImpl_execReregisterLocalPlayers_Parms
{
	struct FName                                       SessionName;                                      		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
};
...
// [0x00024000] 
struct UOnlineGameInterfaceImpl_execJoinOnlineGameByIP_Parms
{
	unsigned char                                      PlayerNum;                                        		// 0x0000 (0x0001) [0x0000000000000080]              ( CPF_Parm )
...
// [0x00020002] 
struct UOnlineGameInterfaceImpl_execClearFullVersionUnlockDelegate_Parms
{
	unsigned char                                      LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000080]              ( CPF_Parm )
	struct FScriptDelegate                             FullVersionUnlockDelegate;                        		// 0x0004 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	// int                                             RemoveIndex;                                      		// 0x0010 (0x0004) [0x0000000000000000]              
};

// Function IpDrv.OnlineGameInterfaceImpl.AddFullVersionUnlockDelegate
// [0x00020002] 
struct UOnlineGameInterfaceImpl_execAddFullVersionUnlockDelegate_Parms
{
	unsigned char                                      LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000080]              ( CPF_Parm )
	struct FScriptDelegate                             FullVersionUnlockDelegate;                        		// 0x0004 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
...
// [0x00120000] 
struct UOnlineGameInterfaceImpl_execOnFullVersionUnlock_Parms
{
};
