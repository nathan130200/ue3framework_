...
public:
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00778140 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x004572A0 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x00455750 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00B8A560 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x009CFA10 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x00C12F30 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x00483960 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x004839B0 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x00435AA0 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x004852D0 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x00778140 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x004842E0 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x0044DB60 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x00453E40 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x00428E80 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x00C12F30 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x00484E90 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x004836F0 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x00484DC0 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x00484F60 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x004838D0 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x00483710 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x004838A0 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x00C12F30 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x00C12F30 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00BFB6E0 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x00483700 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x00483710 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x004838A0 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x00483710 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x004838A0 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x00486370 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x00485050 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x00485190 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x00C12F30 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x00447F50 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x0048FBC0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x00403BF0 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x00403C20 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x00403C50 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x00485420 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x00404AB0 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x006FBA40 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x00BFB6E0 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x00BFB6E0 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x00C12F30 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x006FBA40 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x008495E0 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x00853050 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x00447FD0 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x004501B0 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x009CFA10 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x009CFA10 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x00435920 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x004554C0 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x00485FA0 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x00F1EA40 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x00483880 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x00484A00 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x00426C00 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x0048F4E0 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x006FBA40 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x00401AA0 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x00401AC0 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x00492870 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x00483720 (0x104)
	virtual void VirtualFunction66 ( );																			// 0x00452B20 (0x108)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x0044CC30 (0x10C)
};
