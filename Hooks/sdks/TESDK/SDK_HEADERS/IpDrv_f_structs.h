...
// [0x00420000] 
struct UOnlineEventsInterfaceMcp_execUploadMatchmakingSessionData_Parms
{
...
// [0x00420000] 
struct UOnlineEventsInterfaceMcp_execUploadMatchmakingSearchData_Parms
{
...
struct UOnlineEventsInterfaceMcp_execUploadProfileData_Parms
{
	struct FUniqueNetId                                UniqueId;                                         		// 0x0000 (0x002C) [0x0000000000000080]              ( CPF_Parm )
	struct FString                                     PlayerNick;                                       		// 0x002C (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	class UOnlineProfileSettings*                      ProfileSettings;                                  		// 0x0038 (0x0004) [0x0000000000000080]              ( CPF_Parm )
...
struct UOnlineSubsystemCommonImpl_eventGetPlayerUniqueNetIdFromIndex_Parms
{
	...
	struct FUniqueNetId                                ReturnValue;                                      		// 0x0004 (0x002C) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
{
	struct FUniqueNetId                                CancellingPartyLeader;                            		// 0x0000 (0x002C) [0x0000000000000080]              ( CPF_Parm )
...
struct UPartyBeaconClient_execRequestReservationUpdate_Parms
{
	...
	struct FUniqueNetId                                RequestingPartyLeader;                            		// 0x0008 (0x002C) [0x0000000000000080]              ( CPF_Parm )
	TArray< struct FPlayerReservation >                PlayersToAdd;                                     		// 0x0034 (0x000C) [0x0000000000400182]              ( CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0040 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct UPartyBeaconClient_execOnTravelRequestReceived_Parms
{
	...
	unsigned char                                      PlatformSpecificInfo[ 0x44 ];                     		// 0x000C (0x0044) [0x0000000000000080]              ( CPF_Parm )
};
...
// [0x00120000] 
struct UPartyBeaconClient_execOnReservationUpdateRequestComplete_Parms
{
...
struct UPartyBeaconHost_execGetPlayers_Parms
{
	...
	// struct FPlayerReservation                       PlayerRes;                                        		// 0x0014 (0x0044) [0x0000000000000000]              
};
...
{
	struct FUniqueNetId                                PartyLeader;                                      		// 0x0000 (0x002C) [0x0000000000000080]              ( CPF_Parm )
	// int                                             PlayerIndex;                                      		// 0x002C (0x0004) [0x0000000000000000]              
	// int                                             PartyIndex;                                       		// 0x0030 (0x0004) [0x0000000000000000]              
	// class UOnlineSubsystem*                         OnlineSub;                                        		// 0x0034 (0x0004) [0x0000000000000000]              
	// struct FPlayerReservation                       PlayerRes;                                        		// 0x0038 (0x0044) [0x0000000000000000]              
};
...
struct UPartyBeaconHost_eventUnregisterPartyMembers_Parms
{
	...
	// struct FPlayerReservation                       PlayerRes;                                        		// 0x000C (0x0044) [0x0000000000000000]              
};
...
struct UPartyBeaconHost_eventRegisterPartyMembers_Parms
{
	...
	// struct FPlayerReservation                       PlayerRes;                                        		// 0x001C (0x0044) [0x0000000000000000]              
};
...
struct UPartyBeaconHost_execHandlePlayerLogout_Parms
{
	...
	unsigned long                                      bMaintainParty : 1;                               		// 0x002C (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
};
...
{
	struct FUniqueNetId                                PartyLeader;                                      		// 0x0000 (0x002C) [0x0000000000000080]              ( CPF_Parm )
	TArray< struct FPlayerReservation >                PlayerMembers;                                    		// 0x002C (0x000C) [0x0000000000400182]              ( CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	unsigned char                                      ReturnValue;                                      		// 0x0038 (0x0001) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct UPartyBeaconHost_execAddPartyReservationEntry_Parms
{
	struct FUniqueNetId                                PartyLeader;                                      		// 0x0000 (0x002C) [0x0000000000000080]              ( CPF_Parm )
	TArray< struct FPlayerReservation >                PlayerMembers;                                    		// 0x002C (0x000C) [0x0000000000400182]              ( CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	int                                                TeamNum;                                          		// 0x0038 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      bIsHost : 1;                                      		// 0x003C (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
