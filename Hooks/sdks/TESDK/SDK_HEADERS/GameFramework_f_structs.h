...
struct AGameCrowdAgent_execInitializeAgent_Parms
{
	...
	// unsigned long                                   bGroupDestination : 1;                            		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
// [0x00824802] ( FUNC_Event )
struct AGameCrowdDestination_eventGeneratePathToActor_Parms
{
	class AGameCrowdAgent*                             Agent;                                            		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	...
	unsigned long                                      bAllowPartialPath : 1;                            		// 0x000C (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
...
// [0x00020802] ( FUNC_Event )
struct AGameCrowdDestination_eventInitNavigationHandle_Parms
{
};
...
// [0x00020400] ( FUNC_Native )
struct AGameCrowdDestination_execReachedBy_Parms
{
	class AGameCrowdAgent*                             Agent;                                            		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
...
// [0x00020800] ( FUNC_Event )
struct AGameCrowdDestination_eventNotifyPathChanged_Parms
{
};
...
// [0x00020400] ( FUNC_Native )
struct AGameCrowdDestinationQueuePoint_execReachedBy_Parms
{
	class AGameCrowdAgent*                             Agent;                                            		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FVector                                     TestPosition;                                     		// 0x0004 (0x000C) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0010 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
...
// [0x00020902] ( FUNC_Event )
struct AGameCrowdReplicationActor_eventTick_Parms
{
	float                                              DeltaTime;                                        		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
struct AGameExplosionActor_execHurtExplosion_Parms
{
	...
	// struct FVector                                  Dir;                                              		// 0x0034 (0x000C) [0x0000000000000000]              
	// unsigned long                                   bDamageBlocked : 1;                               		// 0x0040 (0x0004) [0x0000000000000000] [0x00000001] 
	// float                                           ColRadius;                                        		// 0x0044 (0x0004) [0x0000000000000000]              
	// float                                           ColHeight;                                        		// 0x0048 (0x0004) [0x0000000000000000]              
	// TArray< class AActor* >                         VictimsList;                                      		// 0x004C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// float                                           RealDamageRadius;                                 		// 0x0058 (0x0004) [0x0000000000000000]              
	// struct FBox                                     BBox;                                             		// 0x005C (0x001C) [0x0000000000000000]              
	// struct FVector                                  BBoxCenter;                                       		// 0x0078 (0x000C) [0x0000000000000000]              
	// struct FVector                                  BBoxExtent;                                       		// 0x0084 (0x000C) [0x0000000000000000]              
	// class AController*                              ModInstigator;                                    		// 0x0090 (0x0004) [0x0000000000000000]              
	// class APawn*                                    VictimPawn;                                       		// 0x0094 (0x0004) [0x0000000000000000]              
	// class UClass*                                   ModDamageType;                                    		// 0x0098 (0x0004) [0x0000000000000000]              
};
...
{
	struct FPostProcessSettings                        PP;                                               		// 0x0000 (0x00D4) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
};
...
struct UGameCameraBase_execUpdateCamera_Parms
{
	...
	struct FTViewTarget                                OutVT;                                            		// 0x0008 (0x002C) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
};
...
struct AGamePlayerCamera_execUpdateViewTarget_Parms
{
	...
	// class ACameraActor*                             CamActor;                                         		// 0x003C (0x0004) [0x0000000000000000]              
};
...
// [0x00020802] ( FUNC_Event )
struct UGameThirdPersonCameraMode_eventGetPawnRelativeOffset_Parms
{
	class APawn*                                       P;                                                		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FVector                                     ReturnValue;                                      		// 0x0004 (0x000C) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
