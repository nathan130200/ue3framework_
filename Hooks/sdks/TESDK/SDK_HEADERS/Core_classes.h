...
public:
	...
	void ScriptPgNetLog ( struct FString NetLogMsg );
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00C142B0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x0043F410 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x0043E4E0 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00401730 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x00698BE0 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x004B6450 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x0048E490 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x00430D30 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x0048F670 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x00C142B0 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x004898D0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x00437670 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x00443300 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x00488C00 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x0041B7C0 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x004B6450 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x0048DEC0 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x00488660 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x0048DF90 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x00488670 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x00488AE0 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x004886A0 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x004886B0 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x004B6450 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x004B6450 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00488690 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x004886A0 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x004886B0 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x004886A0 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x004886B0 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x0048F480 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x0048E060 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x0048E1B0 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x004B6450 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x00436590 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x0049CB20 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x00404260 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x00404290 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x004042C0 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x004056A0 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x006359C0 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x004B6450 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x00866030 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x00870BF0 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x004A2AB0 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x00438680 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x00698BE0 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x00698BE0 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x00430C20 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x0043E390 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x0048ED50 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x0132E930 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x00488AC0 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x004A29F0 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x0049C210 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x004B6450 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x006359C0 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x00401A00 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x00401A20 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x004A2E90 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x004886C0 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x0043C4F0 (0xF4)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x0045FF80 (0xF8)
};
...
{
public:
	unsigned char                                      UnknownData00[ 0x9C ];                            		// 0x014C (0x009C) MISSED OFFSET
...
// 0x05B0 (0x06FC - 0x014C)
class ULinkerLoad : public ULinker
{
public:
	unsigned char                                      UnknownData00[ 0x5B0 ];                           		// 0x014C (0x05B0) MISSED OFFSET
...
// Class Core.Class
// 0x00F8 (0x01DC - 0x00E4)
class UClass : public UState
{
public:
	unsigned char                                      UnknownData00[ 0xF8 ];                            		// 0x00E4 (0x00F8) MISSED OFFSET
