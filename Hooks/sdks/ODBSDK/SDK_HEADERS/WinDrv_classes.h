...
{
public:
	struct FHttpRequestWindowsImplContainer            ImplContainer;                                    		// 0x0048 (0x0004) [0x0000000000000000]              
...
{
public:
	struct FHttpResponseWindowsImplContainer           ImplContainer;                                    		// 0x003C (0x0004) [0x0000000000000000]              
