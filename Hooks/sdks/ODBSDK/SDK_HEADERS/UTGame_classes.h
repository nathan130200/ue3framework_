...
// 0x00F9 (0x0371 - 0x0278)
class AUTPlayerReplicationInfo : public APlayerReplicationInfo
{
public:
	unsigned long                                      bHasFlag : 1;                                     		// 0x0278 (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	unsigned long                                      bHolding : 1;                                     		// 0x0278 (0x0004) [0x0000000000000020] [0x00000002] ( CPF_Net )
	unsigned long                                      bIsFemale : 1;                                    		// 0x0278 (0x0004) [0x0000000000000020] [0x00000004] ( CPF_Net )
	int                                                spree;                                            		// 0x027C (0x0004) [0x0000000000000000]              
	int                                                MultiKillLevel;                                   		// 0x0280 (0x0004) [0x0000000000000000]              
	float                                              LastKillTime;                                     		// 0x0284 (0x0004) [0x0000000000000000]              
	class AUTSquadAI*                                  Squad;                                            		// 0x0288 (0x0004) [0x0000000000000020]              ( CPF_Net )
	class AUTCarriedObject*                            HasFlag;                                          		// 0x028C (0x0004) [0x0000000000000000]              
	class UClass*                                      VoiceClass;                                       		// 0x0290 (0x0004) [0x0000000000000000]              
	class AUTPlayerReplicationInfo*                    LastKillerPRI;                                    		// 0x0294 (0x0004) [0x0000000000000000]              
	struct FColor                                      DefaultHudColor;                                  		// 0x0298 (0x0004) [0x0000000000000000]              
	struct FVector                                     HUDLocation;                                      		// 0x029C (0x000C) [0x0000000000000000]              
	class UClass*                                      CharClassInfo;                                    		// 0x02A8 (0x0004) [0x0000000000000020]              ( CPF_Net )
	class UTexture*                                    CharPortrait;                                     		// 0x02AC (0x0004) [0x0000000000000000]              
	TArray< struct FIntStat >                          KillStats;                                        		// 0x02B0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FIntStat >                          DeathStats;                                       		// 0x02BC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FIntStat >                          SuicideStats;                                     		// 0x02C8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FIntStat >                          EventStats;                                       		// 0x02D4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FIntStat >                          VehicleKillStats;                                 		// 0x02E0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FIntStat >                          PickupStats;                                      		// 0x02EC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FTimeStat >                         DrivingStats;                                     		// 0x02F8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FTimeStat >                         PowerupTimeStats;                                 		// 0x0304 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     OrdersString[ 0x8 ];                              		// 0x0310 (0x0060) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	unsigned char                                      OrdersIndex;                                      		// 0x0370 (0x0001) [0x0000000000000020]              ( CPF_Net )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 41972 ];
...
// 0x00F4 (0x0968 - 0x0874)
class AUTPlayerController : public AUDKPlayerController
{
public:
	unsigned long                                      bLateComer : 1;                                   		// 0x0874 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bIsTyping : 1;                                    		// 0x0874 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bAutoTaunt : 1;                                   		// 0x0874 (0x0004) [0x0000000000044000] [0x00000004] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bUseVehicleRotationOnPossess : 1;                 		// 0x0874 (0x0004) [0x0000000000044000] [0x00000008] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bRotateMinimap : 1;                               		// 0x0874 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bCameraOutOfWorld : 1;                            		// 0x0874 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bFirstPersonWeaponsSelfShadow : 1;                		// 0x0874 (0x0004) [0x0000000000044000] [0x00000040] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bBehindView : 1;                                  		// 0x0874 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bForceBehindView : 1;                             		// 0x0874 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bFreeCamera : 1;                                  		// 0x0874 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bNoTextToSpeechVoiceMessages : 1;                 		// 0x0874 (0x0004) [0x0000000000044000] [0x00000400] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bTextToSpeechTeamMessagesOnly : 1;                		// 0x0874 (0x0004) [0x0000000000044000] [0x00000800] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bCurrentCamAnimIsDamageShake : 1;                 		// 0x0874 (0x0004) [0x0000000000000000] [0x00001000] 
	unsigned long                                      bCurrentCamAnimAffectsFOV : 1;                    		// 0x0874 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bLandingShake : 1;                                		// 0x0874 (0x0004) [0x0000000000044000] [0x00004000] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bCenteredWeaponFire : 1;                          		// 0x0874 (0x0004) [0x0000000000004000] [0x00008000] ( CPF_Config )
	unsigned long                                      bNonlinearZoomInterpolation : 1;                  		// 0x0874 (0x0004) [0x0000000000002000] [0x00010000] ( CPF_Transient )
	unsigned long                                      bQuittingToMainMenu : 1;                          		// 0x0874 (0x0004) [0x0000000000002000] [0x00020000] ( CPF_Transient )
	unsigned long                                      bDebugFreeCam : 1;                                		// 0x0874 (0x0004) [0x0000000000002000] [0x00040000] ( CPF_Transient )
	unsigned long                                      bJustFoundVehicle : 1;                            		// 0x0874 (0x0004) [0x0000000000000000] [0x00080000] 
	unsigned long                                      bNoCrosshair : 1;                                 		// 0x0874 (0x0004) [0x0000000000004000] [0x00100000] ( CPF_Config )
	unsigned long                                      bSimpleCrosshair : 1;                             		// 0x0874 (0x0004) [0x0000000000004000] [0x00200000] ( CPF_Config )
	unsigned long                                      bAlreadyReset : 1;                                		// 0x0874 (0x0004) [0x0000000000000000] [0x00400000] 
	unsigned long                                      bServerMutedText : 1;                             		// 0x0874 (0x0004) [0x0000000000000000] [0x00800000] 
	unsigned long                                      bHideObjectivePaths : 1;                          		// 0x0874 (0x0004) [0x0000000000044000] [0x01000000] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bCleanupInProgress : 1;                           		// 0x0874 (0x0004) [0x0000000000000000] [0x02000000] 
	unsigned long                                      bCleanupComplete : 1;                             		// 0x0874 (0x0004) [0x0000000000000000] [0x04000000] 
	unsigned char                                      IdentifiedTeam;                                   		// 0x0878 (0x0001) [0x0000000000000000]              
	unsigned char                                      PawnShadowMode;                                   		// 0x0879 (0x0001) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	unsigned char                                      WeaponHandPreference;                             		// 0x087A (0x0001) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	unsigned char                                      WeaponHand;                                       		// 0x087B (0x0001) [0x0000000000000000]              
	unsigned char                                      AutoObjectivePreference;                          		// 0x087C (0x0001) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	unsigned char                                      VehicleControlType;                               		// 0x087D (0x0001) [0x0000000000000000]              
	struct FVector                                     DesiredLocation;                                  		// 0x0880 (0x000C) [0x0000000000000000]              
	class AUTAnnouncer*                                Announcer;                                        		// 0x088C (0x0004) [0x0000000000000000]              
	class AUTMusicManager*                             MusicManager;                                     		// 0x0890 (0x0004) [0x0000000000000000]              
	float                                              LastTauntAnimTime;                                		// 0x0894 (0x0004) [0x0000000000000000]              
	float                                              LastKickWarningTime;                              		// 0x0898 (0x0004) [0x0000000000000000]              
	struct FString                                     MsgPlayerNotFound;                                		// 0x089C (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	class UForceFeedbackWaveform*                      CameraShakeShortWaveForm;                         		// 0x08A8 (0x0004) [0x0000000000000000]              
	class UForceFeedbackWaveform*                      CameraShakeLongWaveForm;                          		// 0x08AC (0x0004) [0x0000000000000000]              
	class UCameraAnim*                                 DamageCameraAnim;                                 		// 0x08B0 (0x0004) [0x0000000000000000]              
	float                                              LastCameraTimeStamp;                              		// 0x08B4 (0x0004) [0x0000000000000000]              
	class UClass*                                      MatineeCameraClass;                               		// 0x08B8 (0x0004) [0x0000000000000000]              
	class AActor*                                      CalcViewActor;                                    		// 0x08BC (0x0004) [0x0000000000000000]              
	struct FVector                                     CalcViewActorLocation;                            		// 0x08C0 (0x000C) [0x0000000000000000]              
	struct FRotator                                    CalcViewActorRotation;                            		// 0x08CC (0x000C) [0x0000000000000000]              
	struct FVector                                     CalcViewLocation;                                 		// 0x08D8 (0x000C) [0x0000000000000000]              
	struct FRotator                                    CalcViewRotation;                                 		// 0x08E4 (0x000C) [0x0000000000000000]              
	float                                              CalcEyeHeight;                                    		// 0x08F0 (0x0004) [0x0000000000000000]              
	struct FVector                                     CalcWalkBob;                                      		// 0x08F4 (0x000C) [0x0000000000000000]              
	float                                              LastWarningTime;                                  		// 0x0900 (0x0004) [0x0000000000000000]              
	float                                              FOVLinearZoomRate;                                		// 0x0904 (0x0004) [0x0000000000000000]              
	float                                              FOVNonlinearZoomInterpSpeed;                      		// 0x0908 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              ZoomRotationModifier;                             		// 0x090C (0x0004) [0x0000000000000000]              
	struct FRotator                                    DebugFreeCamRot;                                  		// 0x0910 (0x000C) [0x0000000000002000]              ( CPF_Transient )
	float                                              LastShowPathTime;                                 		// 0x091C (0x0004) [0x0000000000000000]              
	class AActor*                                      LastAutoObjective;                                		// 0x0920 (0x0004) [0x0000000000000000]              
	float                                              LastBullseyeTime;                                 		// 0x0924 (0x0004) [0x0000000000000000]              
	float                                              LastUseTime;                                      		// 0x0928 (0x0004) [0x0000000000000000]              
	float                                              OldMessageTime;                                   		// 0x092C (0x0004) [0x0000000000000000]              
	float                                              LastFriendlyFireTime;                             		// 0x0930 (0x0004) [0x0000000000000000]              
	class UUTUIDataStore_StringAliasBindingsMap*       BoundEventsStringDataStore;                       		// 0x0934 (0x0004) [0x0000000000000000]              
	float                                              NextAdminCmdTime;                                 		// 0x0938 (0x0004) [0x0000000000000000]              
	float                                              OnFootDefaultFOV;                                 		// 0x093C (0x0004) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	float                                              LastIncomingMessageTime;                          		// 0x0940 (0x0004) [0x0000000000000000]              
	float                                              LastCombatUpdateTime;                             		// 0x0944 (0x0004) [0x0000000000000000]              
	float                                              LastTeamChangeTime;                               		// 0x0948 (0x0004) [0x0000000000000000]              
	class UClass*                                      AchievementHandlerClass;                          		// 0x094C (0x0004) [0x0000000000000000]              
	class UUTAchievementsBase*                         AchievementHandler;                               		// 0x0950 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class UUTLeaderboardRead*                          LeaderboardStatsRead;                             		// 0x0954 (0x0004) [0x0000000000000000]              
	class UClass*                                      LeaderboardStatsWriteClass;                       		// 0x0958 (0x0004) [0x0000000000000000]              
	struct FString                                     DisconnectCommand;                                		// 0x095C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42014 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42022 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42021 ];
...
// Class UTGame.UTPawn
// 0x024C (0x0870 - 0x0624)
class AUTPawn : public AUDKPawn
{
public:
	unsigned long                                      bFixedView : 1;                                   		// 0x0624 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bSpawnDone : 1;                                   		// 0x0624 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bSpawnIn : 1;                                     		// 0x0624 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bShieldAbsorb : 1;                                		// 0x0624 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bDodging : 1;                                     		// 0x0624 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bStopOnDoubleLanding : 1;                         		// 0x0624 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bIsInvulnerable : 1;                              		// 0x0624 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bJustDroppedOrb : 1;                              		// 0x0624 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bForcedFeignDeath : 1;                            		// 0x0624 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bWeaponBob : 1;                                   		// 0x0624 (0x0004) [0x0000000000044000] [0x00000200] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bJustLanded : 1;                                  		// 0x0624 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bLandRecovery : 1;                                		// 0x0624 (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bHasHoverboard : 1;                               		// 0x0624 (0x0004) [0x0000000000000020] [0x00001000] ( CPF_Net )
	unsigned long                                      bStopDeathCamera : 1;                             		// 0x0624 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bWinnerCam : 1;                                   		// 0x0624 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bGibbed : 1;                                      		// 0x0624 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bHeadGibbed : 1;                                  		// 0x0624 (0x0004) [0x0000000000000000] [0x00010000] 
	unsigned long                                      bArmsAttached : 1;                                		// 0x0624 (0x0004) [0x0000000000000000] [0x00020000] 
	unsigned long                                      bWeaponAttachmentVisible : 1;                     		// 0x0624 (0x0004) [0x0000000000000000] [0x00040000] 
	unsigned long                                      bHideOnListenServer : 1;                          		// 0x0624 (0x0004) [0x0000000000000000] [0x00080000] 
	unsigned long                                      bPostRenderTraceSucceeded : 1;                    		// 0x0624 (0x0004) [0x0000000000000000] [0x00100000] 
	unsigned long                                      bReceivedValidTeam : 1;                           		// 0x0624 (0x0004) [0x0000000000000000] [0x00200000] 
	unsigned long                                      bKillsAffectHead : 1;                             		// 0x0624 (0x0004) [0x0000000000000000] [0x00400000] 
	unsigned long                                      bKilledByBio : 1;                                 		// 0x0624 (0x0004) [0x0000000000000000] [0x00800000] 
	class UClass*                                      CurrentWeaponAttachmentClass;                     		// 0x0628 (0x0004) [0x0000000000000020]              ( CPF_Net )
	int                                                UnfeignFailedCount;                               		// 0x062C (0x0004) [0x0000000000000000]              
	class UDynamicLightEnvironmentComponent*           LightEnvironment;                                 		// 0x0630 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UAnimNodeBlend*                              FeignDeathBlend;                                  		// 0x0634 (0x0004) [0x0000000000000000]              
	class UAnimNodeSlot*                               FullBodyAnimSlot;                                 		// 0x0638 (0x0004) [0x0000000000000000]              
	class UAnimNodeSlot*                               TopHalfAnimSlot;                                  		// 0x063C (0x0004) [0x0000000000000000]              
	float                                              DeathHipLinSpring;                                		// 0x0640 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DeathHipLinDamp;                                  		// 0x0644 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DeathHipAngSpring;                                		// 0x0648 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DeathHipAngDamp;                                  		// 0x064C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              StartDeathAnimTime;                               		// 0x0650 (0x0004) [0x0000000000000000]              
	class UClass*                                      DeathAnimDamageType;                              		// 0x0654 (0x0004) [0x0000000000000000]              
	float                                              TimeLastTookDeathAnimDamage;                      		// 0x0658 (0x0004) [0x0000000000000000]              
	struct FVector                                     FixedViewLoc;                                     		// 0x065C (0x000C) [0x0000000000000000]              
	struct FRotator                                    FixedViewRot;                                     		// 0x0668 (0x000C) [0x0000000000000000]              
	float                                              CameraScale;                                      		// 0x0674 (0x0004) [0x0000000000000000]              
	float                                              CurrentCameraScale;                               		// 0x0678 (0x0004) [0x0000000000000000]              
	float                                              CameraScaleMin;                                   		// 0x067C (0x0004) [0x0000000000000000]              
	float                                              CameraScaleMax;                                   		// 0x0680 (0x0004) [0x0000000000000000]              
	struct FVector                                     OldCameraPosition;                                		// 0x0684 (0x000C) [0x0000000000000000]              
	float                                              CameraZOffset;                                    		// 0x0690 (0x0004) [0x0000000000000000]              
	float                                              HeroCameraScale;                                  		// 0x0694 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                HeroCameraPitch;                                  		// 0x0698 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DodgeSpeed;                                       		// 0x069C (0x0004) [0x0000000000000000]              
	float                                              DodgeSpeedZ;                                      		// 0x06A0 (0x0004) [0x0000000000000000]              
	unsigned char                                      CurrentDir;                                       		// 0x06A4 (0x0001) [0x0000000000000000]              
	float                                              DoubleJumpEyeHeight;                              		// 0x06A8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DoubleJumpThreshold;                              		// 0x06AC (0x0004) [0x0000000000000000]              
	float                                              DefaultAirControl;                                		// 0x06B0 (0x0004) [0x0000000000000000]              
	float                                              Bob;                                              		// 0x06B4 (0x0004) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	float                                              LandBob;                                          		// 0x06B8 (0x0004) [0x0000000000000000]              
	float                                              JumpBob;                                          		// 0x06BC (0x0004) [0x0000000000000000]              
	float                                              AppliedBob;                                       		// 0x06C0 (0x0004) [0x0000000000000000]              
	float                                              BobTime;                                          		// 0x06C4 (0x0004) [0x0000000000000000]              
	struct FVector                                     WalkBob;                                          		// 0x06C8 (0x000C) [0x0000000000000000]              
	float                                              FeignDeathBodyAtRestSpeed;                        		// 0x06D4 (0x0004) [0x0000000000000000]              
	float                                              FeignDeathStartTime;                              		// 0x06D8 (0x0004) [0x0000000000000000]              
	float                                              FeignDeathRecoveryStartTime;                      		// 0x06DC (0x0004) [0x0000000000000000]              
	int                                                SuperHealthMax;                                   		// 0x06E0 (0x0004) [0x0000000000000000]              
	class UClass*                                      SoundGroupClass;                                  		// 0x06E4 (0x0004) [0x0000000000000000]              
	class UClass*                                      CurrCharClassInfo;                                		// 0x06E8 (0x0004) [0x0000000000000000]              
	TArray< struct FName >                             TakeHitPhysicsFixedBones;                         		// 0x06EC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FName >                             NoDriveBodies;                                    		// 0x06F8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UForceFeedbackWaveform*                      FallingDamageWaveForm;                            		// 0x0704 (0x0004) [0x0000000000000000]              
	float                                              AccumulateDamage;                                 		// 0x0708 (0x0004) [0x0000000000000000]              
	float                                              AccumulationTime;                                 		// 0x070C (0x0004) [0x0000000000000000]              
	float                                              LastHoverboardTime;                               		// 0x0710 (0x0004) [0x0000000000000000]              
	float                                              MinHoverboardInterval;                            		// 0x0714 (0x0004) [0x0000000000000000]              
	class UUTAnimBlendByDriving*                       DrivingNode;                                      		// 0x0718 (0x0004) [0x0000000000000000]              
	class UUTAnimBlendByVehicle*                       VehicleNode;                                      		// 0x071C (0x0004) [0x0000000000000000]              
	class UUTAnimBlendByHoverboarding*                 HoverboardingNode;                                		// 0x0720 (0x0004) [0x0000000000000000]              
	float                                              ShieldBeltArmor;                                  		// 0x0724 (0x0004) [0x0000000000000020]              ( CPF_Net )
	float                                              VestArmor;                                        		// 0x0728 (0x0004) [0x0000000000000020]              ( CPF_Net )
	float                                              ThighpadArmor;                                    		// 0x072C (0x0004) [0x0000000000000020]              ( CPF_Net )
	class AUTWeaponAttachment*                         CurrentWeaponAttachment;                          		// 0x0730 (0x0004) [0x0000000000000000]              
	struct FName                                       WeaponSocket;                                     		// 0x0734 (0x0008) [0x0000000000000000]              
	struct FName                                       WeaponSocket2;                                    		// 0x073C (0x0008) [0x0000000000000000]              
	struct FName                                       PawnEffectSockets[ 0x2 ];                         		// 0x0744 (0x0010) [0x0000000000000000]              
	float                                              HeadOffset;                                       		// 0x0754 (0x0004) [0x0000000000000000]              
	float                                              HeadRadius;                                       		// 0x0758 (0x0004) [0x0000000000000000]              
	float                                              HeadHeight;                                       		// 0x075C (0x0004) [0x0000000000000000]              
	struct FName                                       HeadBone;                                         		// 0x0760 (0x0008) [0x0000000000000000]              
	class UStaticMeshComponent*                        HeadshotNeckAttachment;                           		// 0x0768 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UClass*                                      TransInEffects[ 0x2 ];                            		// 0x076C (0x0008) [0x0000000000000000]              
	struct FLinearColor                                TranslocateColor[ 0x2 ];                          		// 0x0774 (0x0020) [0x0000000000000000]              
	class UCameraAnim*                                 TransCameraAnim[ 0x3 ];                           		// 0x0794 (0x000C) [0x0000000000000000]              
	class USoundCue*                                   ArmorHitSound;                                    		// 0x07A0 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SpawnSound;                                       		// 0x07A4 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   TeleportSound;                                    		// 0x07A8 (0x0004) [0x0000000000000000]              
	struct FLinearColor                                SpawnProtectionColor;                             		// 0x07AC (0x0010) [0x0000000000000000]              
	float                                              TeamBeaconPlayerInfoMaxDist;                      		// 0x07BC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UTexture*                                    SpeakingBeaconTexture;                            		// 0x07C0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MapSize;                                          		// 0x07C4 (0x0004) [0x0000000000000000]              
	struct FTextureCoordinates                         IconCoords;                                       		// 0x07C8 (0x0010) [0x0000000000000000]              
	float                                              LastPainSound;                                    		// 0x07D8 (0x0004) [0x0000000000000000]              
	float                                              RagdollLifespan;                                  		// 0x07DC (0x0004) [0x0000000000000000]              
	class AUTProjectile*                               AttachedProj;                                     		// 0x07E0 (0x0004) [0x0000000000000000]              
	float                                              MaxFootstepDistSq;                                		// 0x07E4 (0x0004) [0x0000000000000000]              
	float                                              MaxJumpSoundDistSq;                               		// 0x07E8 (0x0004) [0x0000000000000000]              
	class UClass*                                      HoverboardClass;                                  		// 0x07EC (0x0004) [0x0000000000000000]              
	struct FDrivenWeaponPawnInfo                       LastDrivenWeaponPawn;                             		// 0x07F0 (0x000C) [0x0000000000000000]              
	class AUTClientSideWeaponPawn*                     ClientSideWeaponPawn;                             		// 0x07FC (0x0004) [0x0000000000000000]              
	class UMaterialInterface*                          ShieldBeltMaterialInstance;                       		// 0x0800 (0x0004) [0x0000000000000000]              
	class UMaterialInterface*                          ShieldBeltTeamMaterialInstances[ 0x4 ];           		// 0x0804 (0x0010) [0x0000000000000000]              
	int                                                JumpBootCharge;                                   		// 0x0814 (0x0004) [0x0000000000000000]              
	float                                              DefaultMeshScale;                                 		// 0x0818 (0x0004) [0x0000000000000000]              
	struct FName                                       TauntNames[ 0x6 ];                                		// 0x081C (0x0030) [0x0000000000000000]              
	float                                              DesiredMeshScale;                                 		// 0x084C (0x0004) [0x0000000000000000]              
	struct FVector                                     CamOffset;                                        		// 0x0850 (0x000C) [0x0000000000000000]              
	class UParticleSystemComponent*                    BioBurnAway;                                      		// 0x085C (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	float                                              BioBurnAwayTime;                                  		// 0x0860 (0x0004) [0x0000000000000000]              
	struct FName                                       BioEffectName;                                    		// 0x0864 (0x0008) [0x0000000000000000]              
	float                                              DeathTime;                                        		// 0x086C (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42105 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42178 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42177 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42176 ];
...
public:
	...
	class UGameplayEventsWriterBase*                   GameplayEventsWriter;                             		// 0x04E4 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< struct FName >                             SpreeStatEvents;                                  		// 0x04E8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42199 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42198 ];
...
// 0x0048 (0x053C - 0x04F4)
class AUTTeamGame : public AUTDeathmatch
{
public:
	unsigned long                                      bPlayersBalanceTeams : 1;                         		// 0x04F4 (0x0004) [0x0000000000044000] [0x00000001] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bAllowNonTeamChat : 1;                            		// 0x04F4 (0x0004) [0x0000000000004000] [0x00000002] ( CPF_Config )
	unsigned long                                      bScoreTeamKills : 1;                              		// 0x04F4 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bSpawnInTeamArea : 1;                             		// 0x04F4 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bScoreVictimsTarget : 1;                          		// 0x04F4 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bForceAllRed : 1;                                 		// 0x04F4 (0x0004) [0x0000000000000000] [0x00000020] 
	float                                              FriendlyFireScale;                                		// 0x04F8 (0x0004) [0x0000000000000000]              
	float                                              TeammateBoost;                                    		// 0x04FC (0x0004) [0x0000000000000000]              
	class AUTTeamInfo*                                 Teams[ 0x2 ];                                     		// 0x0500 (0x0008) [0x0000000000000000]              
	class UClass*                                      TeamAIType[ 0x2 ];                                		// 0x0508 (0x0008) [0x0000000000000000]              
	struct FString                                     TeamFactions[ 0x2 ];                              		// 0x0510 (0x0018) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UClass*                                      TeamScoreMessageClass;                            		// 0x0528 (0x0004) [0x0000000000000000]              
	class APlayerController*                           PendingTeamSwap;                                  		// 0x052C (0x0004) [0x0000000000000000]              
	float                                              SwapRequestTime;                                  		// 0x0530 (0x0004) [0x0000000000000000]              
	struct FName                                       FlagKillMessageName;                              		// 0x0534 (0x0008) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42197 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42466 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42465 ];
...
// 0x005C (0x0240 - 0x01E4)
class AUTTeamInfo : public ATeamInfo
{
public:
	int                                                DesiredTeamSize;                                  		// 0x01E4 (0x0004) [0x0000000000000000]              
	class AUTTeamAI*                                   AI;                                               		// 0x01E8 (0x0004) [0x0000000000000000]              
	class AUTGameObjective*                            HomeBase;                                         		// 0x01EC (0x0004) [0x0000000000000020]              ( CPF_Net )
	class AUTCarriedObject*                            TeamFlag;                                         		// 0x01F0 (0x0004) [0x0000000000000020]              ( CPF_Net )
	struct FString                                     Faction;                                          		// 0x01F4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FColor                                      BaseTeamColor[ 0x4 ];                             		// 0x0200 (0x0010) [0x0000000000000000]              
	struct FString                                     TeamColorNames[ 0x4 ];                            		// 0x0210 (0x0030) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42474 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42476 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42485 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42578 ];
...
// 0x02FC (0x0A90 - 0x0794)
class AUTVehicle : public AUDKVehicle
{
public:
	unsigned long                                      bDriverHoldsFlag : 1;                             		// 0x0794 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bCanCarryFlag : 1;                                		// 0x0794 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bValidLinkTarget : 1;                             		// 0x0794 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bEnteringUnlocks : 1;                             		// 0x0794 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bHasCustomEntryRadius : 1;                        		// 0x0794 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bKeyVehicle : 1;                                  		// 0x0794 (0x0004) [0x0000000000000020] [0x00000020] ( CPF_Net )
	unsigned long                                      bMustBeUpright : 1;                               		// 0x0794 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bOverrideAVRiLLocks : 1;                          		// 0x0794 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bStickDeflectionThrottle : 1;                     		// 0x0794 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bShouldAutoCenterViewPitch : 1;                   		// 0x0794 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bHasWeaponBar : 1;                                		// 0x0794 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bNeverReset : 1;                                  		// 0x0794 (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bShouldLeaveForCombat : 1;                        		// 0x0794 (0x0004) [0x0000000000000000] [0x00001000] 
	unsigned long                                      bDrawHealthOnHUD : 1;                             		// 0x0794 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bDriverCastsShadow : 1;                           		// 0x0794 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bHasBeenDriven : 1;                               		// 0x0794 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bDropDetailWhenDriving : 1;                       		// 0x0794 (0x0004) [0x0000000000000000] [0x00010000] 
	unsigned long                                      bLookSteerOnNormalControls : 1;                   		// 0x0794 (0x0004) [0x0000000000000001] [0x00020000] ( CPF_Edit )
	unsigned long                                      bLookSteerOnSimpleControls : 1;                   		// 0x0794 (0x0004) [0x0000000000000001] [0x00040000] ( CPF_Edit )
	unsigned long                                      bUsingLookSteer : 1;                              		// 0x0794 (0x0004) [0x0000000000002000] [0x00080000] ( CPF_Transient )
	unsigned long                                      bFindGroundExit : 1;                              		// 0x0794 (0x0004) [0x0000000000000000] [0x00100000] 
	unsigned long                                      bRequestedEntryWithFlag : 1;                      		// 0x0794 (0x0004) [0x0000000000000000] [0x00200000] 
	unsigned long                                      bInitializedVehicleEffects : 1;                   		// 0x0794 (0x0004) [0x0000000000000000] [0x00400000] 
	unsigned long                                      bRagdollDriverOnDarkwalkerHorn : 1;               		// 0x0794 (0x0004) [0x0000000000000001] [0x00800000] ( CPF_Edit )
	unsigned long                                      bHasTurretExplosion : 1;                          		// 0x0794 (0x0004) [0x0000000000000000] [0x01000000] 
	unsigned long                                      bPostRenderTraceSucceeded : 1;                    		// 0x0794 (0x0004) [0x0000000000000000] [0x02000000] 
	unsigned long                                      bPlayingSpawnEffect : 1;                          		// 0x0794 (0x0004) [0x0000000000000020] [0x04000000] ( CPF_Net )
	unsigned long                                      bReducedFallingCollisionDamage : 1;               		// 0x0794 (0x0004) [0x0000000000000000] [0x08000000] 
	unsigned long                                      bRotateCameraUnderVehicle : 1;                    		// 0x0794 (0x0004) [0x0000000000000001] [0x10000000] ( CPF_Edit )
	unsigned long                                      bNoZSmoothing : 1;                                		// 0x0794 (0x0004) [0x0000000000000000] [0x20000000] 
	unsigned long                                      bLimitCameraZLookingUp : 1;                       		// 0x0794 (0x0004) [0x0000000000000000] [0x40000000] 
	unsigned long                                      bNoFollowJumpZ : 1;                               		// 0x0794 (0x0004) [0x0000000000000000] [0x80000000] 
	unsigned long                                      bFixedCamZ : 1;                                   		// 0x0798 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bCameraNeverHidesVehicle : 1;                     		// 0x0798 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bStopDeathCamera : 1;                             		// 0x0798 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bIsConsoleTurning : 1;                            		// 0x0798 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bAcceptTurretJump : 1;                            		// 0x0798 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bShowDamageDebug : 1;                             		// 0x0798 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bStealthVehicle : 1;                              		// 0x0798 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bHasEnemyVehicleSound : 1;                        		// 0x0798 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bIsNecrisVehicle : 1;                             		// 0x0798 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bSpectatedView : 1;                               		// 0x0798 (0x0004) [0x0000000000000000] [0x00000200] 
	class USoundCue*                                   VehicleLockedSound;                               		// 0x079C (0x0004) [0x0000000000000000]              
	unsigned char                                      AIPurpose;                                        		// 0x07A0 (0x0001) [0x0000000000000000]              
	unsigned char                                      LinkedToCount;                                    		// 0x07A1 (0x0001) [0x0000000000000020]              ( CPF_Net )
	class AActor*                                      NoPassengerObjective;                             		// 0x07A4 (0x0004) [0x0000000000000000]              
	float                                              DeflectionReverseThresh;                          		// 0x07A8 (0x0004) [0x0000000000000000]              
	class UPhysicalMaterial*                           DrivingPhysicalMaterial;                          		// 0x07AC (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class UPhysicalMaterial*                           DefaultPhysicalMaterial;                          		// 0x07B0 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class UDynamicLightEnvironmentComponent*           LightEnvironment;                                 		// 0x07B4 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	float                                              VehicleLostTime;                                  		// 0x07B8 (0x0004) [0x0000000000000000]              
	float                                              PlayerStartTime;                                  		// 0x07BC (0x0004) [0x0000000000000000]              
	float                                              RespawnTime;                                      		// 0x07C0 (0x0004) [0x0000000000000000]              
	float                                              InitialSpawnDelay;                                		// 0x07C4 (0x0004) [0x0000000000000000]              
	float                                              LinkHealMult;                                     		// 0x07C8 (0x0004) [0x0000000000000000]              
	class UAudioComponent*                             LinkedToAudio;                                    		// 0x07CC (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class USoundCue*                                   LinkedToCue;                                      		// 0x07D0 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   LinkedEndSound;                                   		// 0x07D4 (0x0004) [0x0000000000000000]              
	float                                              MaxDesireability;                                 		// 0x07D8 (0x0004) [0x0000000000000000]              
	TArray< class USoundCue* >                         HornSounds;                                       		// 0x07DC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              HornAIRadius;                                     		// 0x07E8 (0x0004) [0x0000000000000000]              
	float                                              LastHornTime;                                     		// 0x07EC (0x0004) [0x0000000000000000]              
	int                                                HornIndex;                                        		// 0x07F0 (0x0004) [0x0000000000000000]              
	float                                              LeftStickDirDeadZone;                             		// 0x07F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LookSteerSensitivity;                             		// 0x07F8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LookSteerDamping;                                 		// 0x07FC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LookSteerDeadZone;                                		// 0x0800 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ConsoleSteerScale;                                		// 0x0804 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class USoundCue*                                   LockedOnSound;                                    		// 0x0808 (0x0004) [0x0000000000000000]              
	class UClass*                                      RanOverDamageType;                                		// 0x080C (0x0004) [0x0000000000000000]              
	class USoundCue*                                   RanOverSound;                                     		// 0x0810 (0x0004) [0x0000000000000000]              
	int                                                StolenAnnouncementIndex;                          		// 0x0814 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   StolenSound;                                      		// 0x0818 (0x0004) [0x0000000000000000]              
	class AUTVehicle*                                  NextVehicle;                                      		// 0x081C (0x0004) [0x0000000000000000]              
	class AUTVehicleFactory*                           ParentFactory;                                    		// 0x0820 (0x0004) [0x0000000000000000]              
	class AUTBot*                                      Reservation;                                      		// 0x0824 (0x0004) [0x0000000000000000]              
	struct FString                                     VehiclePositionString;                            		// 0x0828 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FString                                     VehicleNameString;                                		// 0x0834 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FObjectiveAnnouncementInfo                  NeedToPickUpAnnouncement;                         		// 0x0840 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              TeamBeaconPlayerInfoMaxDist;                      		// 0x0850 (0x0004) [0x0000000000000000]              
	float                                              HUDExtent;                                        		// 0x0854 (0x0004) [0x0000000000000000]              
	class UClass*                                      VehicleDrowningDamType;                           		// 0x0858 (0x0004) [0x0000000000000000]              
	class UClass*                                      ExplosionLightClass;                              		// 0x085C (0x0004) [0x0000000000000000]              
	float                                              MaxExplosionLightDistance;                        		// 0x0860 (0x0004) [0x0000000000000000]              
	class AEmitter*                                    DeathExplosion;                                   		// 0x0864 (0x0004) [0x0000000000000000]              
	float                                              TimeTilSecondaryVehicleExplosion;                 		// 0x0868 (0x0004) [0x0000000000000000]              
	int                                                ClientHealth;                                     		// 0x086C (0x0004) [0x0000000000000000]              
	TArray< class UMaterialInterface* >                TeamMaterials;                                    		// 0x0870 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UClass*                                      VehiclePieceClass;                                		// 0x087C (0x0004) [0x0000000000000000]              
	float                                              DamageSmokeThreshold;                             		// 0x0880 (0x0004) [0x0000000000000000]              
	class UClass*                                      ExplosionDamageType;                              		// 0x0884 (0x0004) [0x0000000000000000]              
	float                                              MaxImpactEffectDistance;                          		// 0x0888 (0x0004) [0x0000000000000000]              
	float                                              MaxFireEffectDistance;                            		// 0x088C (0x0004) [0x0000000000000000]              
	class UParticleSystem*                             ExplosionTemplate;                                		// 0x0890 (0x0004) [0x0000000000000000]              
	TArray< struct FDistanceBasedParticleTemplate >    BigExplosionTemplates;                            		// 0x0894 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UParticleSystem*                             SecondaryExplosion;                               		// 0x08A0 (0x0004) [0x0000000000000000]              
	struct FName                                       BigExplosionSocket;                               		// 0x08A4 (0x0008) [0x0000000000000000]              
	float                                              BurnOutTime;                                      		// 0x08AC (0x0004) [0x0000000000000000]              
	float                                              DeadVehicleLifeSpan;                              		// 0x08B0 (0x0004) [0x0000000000000000]              
	int                                                DelayedBurnoutCount;                              		// 0x08B4 (0x0004) [0x0000000000000000]              
	float                                              ExplosionDamage;                                  		// 0x08B8 (0x0004) [0x0000000000000000]              
	float                                              ExplosionRadius;                                  		// 0x08BC (0x0004) [0x0000000000000000]              
	float                                              ExplosionMomentum;                                		// 0x08C0 (0x0004) [0x0000000000000000]              
	float                                              ExplosionInAirAngVel;                             		// 0x08C4 (0x0004) [0x0000000000000000]              
	class UCameraAnim*                                 DeathExplosionShake;                              		// 0x08C8 (0x0004) [0x0000000000000000]              
	float                                              InnerExplosionShakeRadius;                        		// 0x08CC (0x0004) [0x0000000000000000]              
	float                                              OuterExplosionShakeRadius;                        		// 0x08D0 (0x0004) [0x0000000000000000]              
	struct FName                                       TurretScaleControlName;                           		// 0x08D4 (0x0008) [0x0000000000000000]              
	struct FName                                       TurretSocketName;                                 		// 0x08DC (0x0008) [0x0000000000000000]              
	TArray< struct FDistanceBasedParticleTemplate >    DistanceTurretExplosionTemplates;                 		// 0x08E4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FVector                                     TurretOffset;                                     		// 0x08F0 (0x000C) [0x0000000000000000]              
	class AUTVehicleDeathPiece*                        DestroyedTurret;                                  		// 0x08FC (0x0004) [0x0000000000000000]              
	class UStaticMesh*                                 DestroyedTurretTemplate;                          		// 0x0900 (0x0004) [0x0000000000000000]              
	float                                              TurretExplosiveForce;                             		// 0x0904 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   ExplosionSound;                                   		// 0x0908 (0x0004) [0x0000000000000000]              
	struct FName                                       BurnTimeParameterName;                            		// 0x090C (0x0008) [0x0000000000000000]              
	float                                              SpawnRadius;                                      		// 0x0914 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SpawnInSound;                                     		// 0x0918 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SpawnOutSound;                                    		// 0x091C (0x0004) [0x0000000000000000]              
	class USoundCue*                                   BoostPadSound;                                    		// 0x0920 (0x0004) [0x0000000000000000]              
	struct FVector                                     FlagOffset;                                       		// 0x0924 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FRotator                                    FlagRotation;                                     		// 0x0930 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       FlagBone;                                         		// 0x093C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              MapSize;                                          		// 0x0944 (0x0004) [0x0000000000000000]              
	struct FTextureCoordinates                         IconCoords;                                       		// 0x0948 (0x0010) [0x0000000000000000]              
	struct FTextureCoordinates                         FlipToolTipIconCoords;                            		// 0x0958 (0x0010) [0x0000000000000000]              
	struct FTextureCoordinates                         EnterToolTipIconCoords;                           		// 0x0968 (0x0010) [0x0000000000000000]              
	struct FTextureCoordinates                         DropFlagIconCoords;                               		// 0x0978 (0x0010) [0x0000000000000000]              
	struct FTextureCoordinates                         DropOrbIconCoords;                                		// 0x0988 (0x0010) [0x0000000000000000]              
	int                                                LastHealth;                                       		// 0x0998 (0x0004) [0x0000000000000000]              
	float                                              HealthPulseTime;                                  		// 0x099C (0x0004) [0x0000000000000000]              
	struct FVector                                     TeamBeaconOffset;                                 		// 0x09A0 (0x000C) [0x0000000000000000]              
	class APlayerReplicationInfo*                      PassengerPRI;                                     		// 0x09AC (0x0004) [0x0000000000000020]              ( CPF_Net )
	struct FVector                                     PassengerTeamBeaconOffset;                        		// 0x09B0 (0x000C) [0x0000000000000000]              
	class UTexture2D*                                  HudIcons;                                         		// 0x09BC (0x0004) [0x0000000000000000]              
	struct FTextureCoordinates                         HudCoords;                                        		// 0x09C0 (0x0010) [0x0000000000000000]              
	TArray< class UParticleSystem* >                   SpawnInTemplates;                                 		// 0x09D0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FMaterialList >                     SpawnMaterialLists;                               		// 0x09DC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       SpawnMaterialParameterName;                       		// 0x09E8 (0x0008) [0x0000000000000000]              
	struct FInterpCurveFloat                           SpawnMaterialParameterCurve;                      		// 0x09F0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UMaterialInterface* >                OriginalMaterials;                                		// 0x0A00 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              SpawnInTime;                                      		// 0x0A0C (0x0004) [0x0000000000000000]              
	class UMaterialInterface*                          BurnOutMaterial[ 0x2 ];                           		// 0x0A10 (0x0008) [0x0000000000000000]              
	float                                              CollisionDamageMult;                              		// 0x0A18 (0x0004) [0x0000000000000000]              
	float                                              LastCollisionDamageTime;                          		// 0x0A1C (0x0004) [0x0000000000000000]              
	float                                              SeatCameraScale;                                  		// 0x0A20 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              OldCamPosZ;                                       		// 0x0A24 (0x0004) [0x0000000000000000]              
	float                                              CameraSmoothingFactor;                            		// 0x0A28 (0x0004) [0x0000000000000000]              
	float                                              DefaultFOV;                                       		// 0x0A2C (0x0004) [0x0000000000000000]              
	TArray< struct FTimePosition >                     OldPositions;                                     		// 0x0A30 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              CameraLag;                                        		// 0x0A3C (0x0004) [0x0000000000000000]              
	struct FVector                                     CameraOffset;                                     		// 0x0A40 (0x000C) [0x0000000000000000]              
	float                                              LookForwardDist;                                  		// 0x0A4C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinCameraDistSq;                                  		// 0x0A50 (0x0004) [0x0000000000000000]              
	struct FVector                                     OldCameraPosition;                                		// 0x0A54 (0x000C) [0x0000000000000000]              
	float                                              DisabledTime;                                     		// 0x0A60 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TimeLastDisabled;                                 		// 0x0A64 (0x0004) [0x0000000000000000]              
	class UParticleSystem*                             DisabledTemplate;                                 		// 0x0A68 (0x0004) [0x0000000000000000]              
	class UParticleSystemComponent*                    DisabledEffectComponent;                          		// 0x0A6C (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UStaticMesh*                                 ReferenceMovementMesh;                            		// 0x0A70 (0x0004) [0x0000000000000000]              
	float                                              LastEnemyWarningTime;                             		// 0x0A74 (0x0004) [0x0000000000000000]              
	TArray< class USoundNodeWave* >                    EnemyVehicleSound;                                		// 0x0A78 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class USoundNodeWave* >                    VehicleDestroyedSound;                            		// 0x0A84 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42660 ];
...
public:
	...
	TArray< struct FName >                             EffectSockets;                                    		// 0x0310 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                IconX;                                            		// 0x031C (0x0004) [0x0000000000000000]              
	int                                                IconY;                                            		// 0x0320 (0x0004) [0x0000000000000000]              
	int                                                IconWidth;                                        		// 0x0324 (0x0004) [0x0000000000000000]              
	int                                                IconHeight;                                       		// 0x0328 (0x0004) [0x0000000000000000]              
	float                                              SwitchAbortTime;                                  		// 0x032C (0x0004) [0x0000000000000000]              
	struct FTextureCoordinates                         IconCoordinates;                                  		// 0x0330 (0x0010) [0x0000000000000000]              
	struct FTextureCoordinates                         CrossHairCoordinates;                             		// 0x0340 (0x0010) [0x0000000000000000]              
	struct FTextureCoordinates                         SimpleCrossHairCoordinates;                       		// 0x0350 (0x0010) [0x0000000000000000]              
	class UTexture2D*                                  CrosshairImage;                                   		// 0x0360 (0x0004) [0x0000000000000000]              
	struct FTextureCoordinates                         LockedCrossHairCoordinates;                       		// 0x0364 (0x0010) [0x0000000000000000]              
	float                                              CurrentLockedScale;                               		// 0x0374 (0x0004) [0x0000000000000000]              
	float                                              StartLockedScale;                                 		// 0x0378 (0x0004) [0x0000000000000000]              
	float                                              FinalLockedScale;                                 		// 0x037C (0x0004) [0x0000000000000000]              
	float                                              LockedScaleTime;                                  		// 0x0380 (0x0004) [0x0000000000000000]              
	float                                              LockedStartTime;                                  		// 0x0384 (0x0004) [0x0000000000000000]              
	float                                              LastHitEnemyTime;                                 		// 0x0388 (0x0004) [0x0000000000000000]              
	struct FColor                                      CrosshairColor;                                   		// 0x038C (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              CrosshairScaling;                                 		// 0x0390 (0x0004) [0x0000000000000000]              
	struct FTextureCoordinates                         CustomCrosshairCoordinates;                       		// 0x0394 (0x0010) [0x0000000000004000]              ( CPF_Config )
	float                                              DroppedPickupOffsetZ;                             		// 0x03A4 (0x0004) [0x0000000000000000]              
	TArray< unsigned char >                            bZoomedFireMode;                                  		// 0x03A8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      ZoomedFireModeNum;                                		// 0x03B4 (0x0001) [0x0000000000000000]              
	unsigned char                                      InventoryGroup;                                   		// 0x03B5 (0x0001) [0x0000000000000000]              
	unsigned char                                      AmmoDisplayType;                                  		// 0x03B6 (0x0001) [0x0000000000000000]              
	float                                              ZoomedTargetFOV;                                  		// 0x03B8 (0x0004) [0x0000000000000000]              
	float                                              ZoomedRate;                                       		// 0x03BC (0x0004) [0x0000000000000000]              
	float                                              ZoomFadeTime;                                     		// 0x03C0 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   ZoomInSound;                                      		// 0x03C4 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   ZoomOutSound;                                     		// 0x03C8 (0x0004) [0x0000000000000000]              
	class UClass*                                      AttachmentClass;                                  		// 0x03CC (0x0004) [0x0000000000000000]              
	struct FVector                                     PivotTranslation;                                 		// 0x03D0 (0x000C) [0x0000000000000000]              
	float                                              GroupWeight;                                      		// 0x03DC (0x0004) [0x0000000000000000]              
	float                                              InventoryWeight;                                  		// 0x03E0 (0x0004) [0x0000000000000000]              
	TArray< struct FName >                             WeaponFireAnim;                                   		// 0x03E4 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             ArmFireAnim;                                      		// 0x03F0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UAnimSet*                                    ArmsAnimSet;                                      		// 0x03FC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       WeaponPutDownAnim;                                		// 0x0400 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       ArmsPutDownAnim;                                  		// 0x0408 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       WeaponEquipAnim;                                  		// 0x0410 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       ArmsEquipAnim;                                    		// 0x0418 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FName >                             WeaponIdleAnims;                                  		// 0x0420 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             ArmIdleAnims;                                     		// 0x042C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class USoundCue* >                         WeaponFireSnd;                                    		// 0x0438 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class USoundCue*                                   WeaponPutDownSnd;                                 		// 0x0444 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class USoundCue*                                   WeaponEquipSnd;                                   		// 0x0448 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BobDamping;                                       		// 0x044C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              JumpDamping;                                      		// 0x0450 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxPitchLag;                                      		// 0x0454 (0x0004) [0x0000000000000000]              
	float                                              MaxYawLag;                                        		// 0x0458 (0x0004) [0x0000000000000000]              
	float                                              LastRotUpdate;                                    		// 0x045C (0x0004) [0x0000000000000000]              
	struct FRotator                                    LastRotation;                                     		// 0x0460 (0x000C) [0x0000000000000000]              
	float                                              OldLeadMag[ 0x2 ];                                		// 0x046C (0x0008) [0x0000000000000000]              
	int                                                OldRotDiff[ 0x2 ];                                		// 0x0474 (0x0008) [0x0000000000000000]              
	float                                              OldMaxDiff[ 0x2 ];                                		// 0x047C (0x0008) [0x0000000000000000]              
	float                                              RotChgSpeed;                                      		// 0x0484 (0x0004) [0x0000000000000000]              
	float                                              ReturnChgSpeed;                                   		// 0x0488 (0x0004) [0x0000000000000000]              
	struct FColor                                      WeaponColor;                                      		// 0x048C (0x0004) [0x0000000000000000]              
	float                                              WeaponCanvasXPct;                                 		// 0x0490 (0x0004) [0x0000000000000000]              
	float                                              WeaponCanvasYPct;                                 		// 0x0494 (0x0004) [0x0000000000000000]              
	struct FName                                       MuzzleFlashSocket;                                		// 0x0498 (0x0008) [0x0000000000000000]              
	class UUTParticleSystemComponent*                  MuzzleFlashPSC;                                   		// 0x04A0 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UParticleSystem*                             MuzzleFlashPSCTemplate;                           		// 0x04A4 (0x0004) [0x0000000000000000]              
	class UParticleSystem*                             MuzzleFlashAltPSCTemplate;                        		// 0x04A8 (0x0004) [0x0000000000000000]              
	struct FColor                                      MuzzleFlashColor;                                 		// 0x04AC (0x0004) [0x0000000000000000]              
	class UUDKExplosionLight*                          MuzzleFlashLight;                                 		// 0x04B0 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UClass*                                      MuzzleFlashLightClass;                            		// 0x04B4 (0x0004) [0x0000000000000000]              
	float                                              MuzzleFlashDuration;                              		// 0x04B8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     PlayerViewOffset;                                 		// 0x04BC (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     SmallWeaponsOffset;                               		// 0x04C8 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	float                                              WideScreenOffsetScaling;                          		// 0x04D4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FRotator                                    WidescreenRotationOffset;                         		// 0x04D8 (0x000C) [0x0000000000000000]              
	struct FVector                                     HiddenWeaponsOffset;                              		// 0x04E4 (0x000C) [0x0000000000000000]              
	float                                              ProjectileSpawnOffset;                            		// 0x04F0 (0x0004) [0x0000000000000000]              
	struct FRotator                                    LockerRotation;                                   		// 0x04F4 (0x000C) [0x0000000000000000]              
	struct FVector                                     LockerOffset;                                     		// 0x0500 (0x000C) [0x0000000000000000]              
	float                                              CurrentRating;                                    		// 0x050C (0x0004) [0x0000000000000000]              
	float                                              aimerror;                                         		// 0x0510 (0x0004) [0x0000000000000000]              
	struct FObjectiveAnnouncementInfo                  NeedToPickUpAnnouncement;                         		// 0x0514 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              AimingHelpRadius[ 0x2 ];                          		// 0x0524 (0x0008) [0x0000000000000000]              
	float                                              ZoomedTurnSpeedScalePct;                          		// 0x052C (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetFrictionDistanceMin;                        		// 0x0530 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetFrictionDistancePeak;                       		// 0x0534 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetFrictionDistanceMax;                        		// 0x0538 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	struct FInterpCurveFloat                           TargetFrictionDistanceCurve;                      		// 0x053C (0x0010) [0x0000000000404001]              ( CPF_Edit | CPF_Config | CPF_NeedCtorLink )
	struct FVector2D                                   TargetFrictionMultiplierRange;                    		// 0x054C (0x0008) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetFrictionPeakRadiusScale;                    		// 0x0554 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetFrictionPeakHeightScale;                    		// 0x0558 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	struct FVector                                     TargetFrictionOffset;                             		// 0x055C (0x000C) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetFrictionZoomedBoostValue;                   		// 0x0568 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetAdhesionTimeMax;                            		// 0x056C (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetAdhesionDistanceMax;                        		// 0x0570 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetAdhesionAimDistY;                           		// 0x0574 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetAdhesionAimDistZ;                           		// 0x0578 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	struct FVector2D                                   TargetAdhesionScaleRange;                         		// 0x057C (0x0008) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetAdhesionScaleAmountMin;                     		// 0x0584 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetAdhesionTargetVelocityMin;                  		// 0x0588 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetAdhesionPlayerVelocityMin;                  		// 0x058C (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              TargetAdhesionZoomedBoostValue;                   		// 0x0590 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	TArray< class USoundNodeWave* >                    LocationSpeech;                                   		// 0x0594 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     UseHintString;                                    		// 0x05A0 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42691 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42694 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42737 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42736 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42735 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42741 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42740 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42749 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42751 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42775 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42788 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42794 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42950 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42949 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42952 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42998 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43054 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43062 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43066 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43190 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43189 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43265 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43340 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43339 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43348 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43366 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43479 ];
...
// 0x0009 (0x04A1 - 0x0498)
class UUTPlayerInput : public UUDKPlayerInput
{
public:
	float                                              LastDuckTime;                                     		// 0x0498 (0x0004) [0x0000000000000000]              
	unsigned long                                      bHoldDuck : 1;                                    		// 0x049C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned char                                      ForcedDoubleClick;                                		// 0x04A0 (0x0001) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43480 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43496 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43495 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43873 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43928 ];
...
// 0x00E1 (0x02A9 - 0x01C8)
class AUTWeaponAttachment : public AActor
{
public:
	class UClass*                                      SplashEffect;                                     		// 0x01C8 (0x0004) [0x0000000000000000]              
	class USkeletalMeshComponent*                      Mesh;                                             		// 0x01CC (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class USkeletalMeshComponent*                      OverlayMesh;                                      		// 0x01D0 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FName                                       MuzzleFlashSocket;                                		// 0x01D4 (0x0008) [0x0000000000000000]              
	class UParticleSystemComponent*                    MuzzleFlashPSC;                                   		// 0x01DC (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UParticleSystem*                             MuzzleFlashPSCTemplate;                           		// 0x01E0 (0x0004) [0x0000000000000000]              
	class UParticleSystem*                             MuzzleFlashAltPSCTemplate;                        		// 0x01E4 (0x0004) [0x0000000000000000]              
	struct FColor                                      MuzzleFlashColor;                                 		// 0x01E8 (0x0004) [0x0000000000000000]              
	unsigned long                                      bMuzzleFlashPSCLoops : 1;                         		// 0x01EC (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bAlignToSurfaceNormal : 1;                        		// 0x01EC (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bSuppressSounds : 1;                              		// 0x01EC (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bMakeSplash : 1;                                  		// 0x01EC (0x0004) [0x0000000000000000] [0x00000008] 
	class UClass*                                      MuzzleFlashLightClass;                            		// 0x01F0 (0x0004) [0x0000000000000000]              
	class UUDKExplosionLight*                          MuzzleFlashLight;                                 		// 0x01F4 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	float                                              MuzzleFlashDuration;                              		// 0x01F8 (0x0004) [0x0000000000000000]              
	class USkeletalMeshComponent*                      OwnerMesh;                                        		// 0x01FC (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FName                                       AttachmentSocket;                                 		// 0x0200 (0x0008) [0x0000000000000000]              
	TArray< struct FMaterialImpactEffect >             ImpactEffects;                                    		// 0x0208 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FMaterialImpactEffect >             AltImpactEffects;                                 		// 0x0214 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FMaterialImpactEffect                       DefaultImpactEffect;                              		// 0x0220 (0x0030) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FMaterialImpactEffect                       DefaultAltImpactEffect;                           		// 0x0250 (0x0030) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class USoundCue*                                   BulletWhip;                                       		// 0x0280 (0x0004) [0x0000000000000000]              
	float                                              MaxImpactEffectDistance;                          		// 0x0284 (0x0004) [0x0000000000000000]              
	float                                              MaxFireEffectDistance;                            		// 0x0288 (0x0004) [0x0000000000000000]              
	class UClass*                                      WeaponClass;                                      		// 0x028C (0x0004) [0x0000000000000000]              
	float                                              MaxDecalRangeSq;                                  		// 0x0290 (0x0004) [0x0000000000000000]              
	float                                              DistFactorForRefPose;                             		// 0x0294 (0x0004) [0x0000000000000000]              
	struct FName                                       FireAnim;                                         		// 0x0298 (0x0008) [0x0000000000000000]              
	struct FName                                       AltFireAnim;                                      		// 0x02A0 (0x0008) [0x0000000000000000]              
	unsigned char                                      WeapAnimType;                                     		// 0x02A8 (0x0001) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43956 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43961 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43963 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43965 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43972 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44074 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44081 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44087 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44101 ];
...
// 0x0154 (0x0700 - 0x05AC)
class AUTWeap_RocketLauncher : public AUTWeapon
{
public:
	unsigned char                                      LoadedFireMode;                                   		// 0x05AC (0x0001) [0x0000000000000000]              
	class UClass*                                      SeekingRocketClass;                               		// 0x05B0 (0x0004) [0x0000000000000000]              
	class UClass*                                      LoadedRocketClass;                                		// 0x05B4 (0x0004) [0x0000000000000000]              
	class UClass*                                      GrenadeClass;                                     		// 0x05B8 (0x0004) [0x0000000000000000]              
	int                                                GrenadeSpreadDist;                                		// 0x05BC (0x0004) [0x0000000000000000]              
	class USoundCue*                                   AltFireModeChangeSound;                           		// 0x05C0 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   RocketLoadedSound;                                		// 0x05C4 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   GrenadeFireSound;                                 		// 0x05C8 (0x0004) [0x0000000000000000]              
	class UUDKSkeletalMeshComponent*                   SkeletonFirstPersonMesh;                          		// 0x05CC (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	unsigned long                                      bIsAnyAmmoHidden : 1;                             		// 0x05D0 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bLockedOnTarget : 1;                              		// 0x05D0 (0x0004) [0x0000000000000020] [0x00000002] ( CPF_Net )
	unsigned long                                      bTargetLockingActive : 1;                         		// 0x05D0 (0x0004) [0x0000000000000000] [0x00000004] 
	float                                              LockCheckTime;                                    		// 0x05D4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LockRange;                                        		// 0x05D8 (0x0004) [0x0000000000000000]              
	float                                              LockAcquireTime;                                  		// 0x05DC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LockTolerance;                                    		// 0x05E0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AActor*                                      LockedTarget;                                     		// 0x05E4 (0x0004) [0x0000000000000020]              ( CPF_Net )
	class APlayerReplicationInfo*                      LockedTargetPRI;                                  		// 0x05E8 (0x0004) [0x0000000000000000]              
	class AActor*                                      PendingLockedTarget;                              		// 0x05EC (0x0004) [0x0000000000000000]              
	float                                              LastLockedOnTime;                                 		// 0x05F0 (0x0004) [0x0000000000000000]              
	float                                              PendingLockedTargetTime;                          		// 0x05F4 (0x0004) [0x0000000000000000]              
	float                                              LastValidTargetTime;                              		// 0x05F8 (0x0004) [0x0000000000000000]              
	float                                              LockAim;                                          		// 0x05FC (0x0004) [0x0000000000000000]              
	float                                              ConsoleLockAim;                                   		// 0x0600 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   LockAcquiredSound;                                		// 0x0604 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   LockLostSound;                                    		// 0x0608 (0x0004) [0x0000000000000000]              
	float                                              LastTargetLockCheckTime;                          		// 0x060C (0x0004) [0x0000000000000000]              
	int                                                LoadedShotCount;                                  		// 0x0610 (0x0004) [0x0000000000000000]              
	int                                                MaxLoadCount;                                     		// 0x0614 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   WeaponLoadedSnd;                                  		// 0x0618 (0x0004) [0x0000000000000000]              
	TArray< float >                                    AltFireQueueTimes;                                		// 0x061C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< float >                                    AltFireLaunchTimes;                               		// 0x0628 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< float >                                    AltFireEndTimes;                                  		// 0x0634 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class USoundCue* >                         AltFireSndQue;                                    		// 0x0640 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FName >                             MuzzleFlashSocketList;                            		// 0x064C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UUTParticleSystemComponent* >        MuzzleFlashPSCList;                               		// 0x0658 (0x000C) [0x0000000004480008]              ( CPF_ExportObject | CPF_Component | CPF_NeedCtorLink | CPF_EditInline )
	int                                                SpreadDist;                                       		// 0x0664 (0x0004) [0x0000000000000000]              
	float                                              GracePeriod;                                      		// 0x0668 (0x0004) [0x0000000000000000]              
	float                                              WaitToFirePct;                                    		// 0x066C (0x0004) [0x0000000000000000]              
	struct FString                                     GrenadeString;                                    		// 0x0670 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FString                                     SpiralString;                                     		// 0x067C (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FTextureCoordinates                         LoadedIconCoords[ 0x3 ];                          		// 0x0688 (0x0030) [0x0000000000000000]              
	struct FName                                       LoadUpAnimList[ 0x3 ];                            		// 0x06B8 (0x0018) [0x0000000000000000]              
	struct FName                                       WeaponAltFireLaunch[ 0x3 ];                       		// 0x06D0 (0x0018) [0x0000000000000000]              
	struct FName                                       WeaponAltFireLaunchEnd[ 0x3 ];                    		// 0x06E8 (0x0018) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44111 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44114 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44308 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44309 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44317 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44319 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44321 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44383 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44536 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44551 ];
...
// 0x0034 (0x05E0 - 0x05AC)
class AUTWeap_Physicsgun : public AUTWeapon
{
public:
	float                                              WeaponImpulse;                                    		// 0x05AC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              HoldDistanceMin;                                  		// 0x05B0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              HoldDistanceMax;                                  		// 0x05B4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ThrowImpulse;                                     		// 0x05B8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ChangeHoldDistanceIncrement;                      		// 0x05BC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class URB_Handle*                                  PhysicsGrabber;                                   		// 0x05C0 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	float                                              HoldDistance;                                     		// 0x05C4 (0x0004) [0x0000000000000000]              
	unsigned char                                      UnknownData00[ 0x8 ];                             		// 0x05C8 (0x0008) MISSED OFFSET
	struct FQuat                                       HoldOrientation;                                  		// 0x05D0 (0x0010) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44623 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44675 ];
...
{
public:
	int                                                Position;                                         		// 0x0240 (0x0004) [0x0000000000000000]              
	class UClass*                                      DMSquadClass;                                     		// 0x0244 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44714 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44776 ];
...
// 0x005C (0x0608 - 0x05AC)
class AUTBeamWeapon : public AUTWeapon
{
public:
	class UParticleSystem*                             BeamTemplate[ 0x2 ];                              		// 0x05AC (0x0008) [0x0000000000000000]              
	class UParticleSystemComponent*                    BeamEmitter[ 0x2 ];                               		// 0x05B4 (0x0008) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FName                                       BeamSockets[ 0x2 ];                               		// 0x05BC (0x0010) [0x0000000000000000]              
	struct FName                                       EndPointParamName;                                		// 0x05CC (0x0008) [0x0000000000000000]              
	struct FName                                       BeamPreFireAnim[ 0x2 ];                           		// 0x05D4 (0x0010) [0x0000000000000000]              
	struct FName                                       BeamFireAnim[ 0x2 ];                              		// 0x05E4 (0x0010) [0x0000000000000000]              
	struct FName                                       BeamPostFireAnim[ 0x2 ];                          		// 0x05F4 (0x0010) [0x0000000000000000]              
	class UForceFeedbackWaveform*                      BeamWeaponFireWaveForm;                           		// 0x0604 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45035 ];
...
{
public:
	class AActor*                                      LinkedTo;                                         		// 0x0608 (0x0004) [0x0000000000000020]              ( CPF_Net )
	class UPrimitiveComponent*                         LinkedComponent;                                  		// 0x060C (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	float                                              WeaponLinkDistance;                               		// 0x0610 (0x0004) [0x0000000000000000]              
	TArray< class AUTWeap_LinkGun* >                   LinkedList;                                       		// 0x0614 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class AActor*                                      Victim;                                           		// 0x0620 (0x0004) [0x0000000000000000]              
	int                                                LinkStrength;                                     		// 0x0624 (0x0004) [0x0000000000000020]              ( CPF_Net )
	float                                              LinkFlexibility;                                  		// 0x0628 (0x0004) [0x0000000000000000]              
	float                                              LinkBreakDelay;                                   		// 0x062C (0x0004) [0x0000000000000000]              
	float                                              MomentumTransfer;                                 		// 0x0630 (0x0004) [0x0000000000000000]              
	float                                              BeamAmmoUsePerSecond;                             		// 0x0634 (0x0004) [0x0000000000000000]              
	float                                              ReaccquireTimer;                                  		// 0x0638 (0x0004) [0x0000000000000000]              
	unsigned long                                      bBeamHit : 1;                                     		// 0x063C (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	unsigned long                                      bAutoCharge : 1;                                  		// 0x063C (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bFullPower : 1;                                   		// 0x063C (0x0004) [0x0000000000000020] [0x00000004] ( CPF_Net )
	float                                              RechargeRate;                                     		// 0x0640 (0x0004) [0x0000000000000000]              
	float                                              SavedDamage;                                      		// 0x0644 (0x0004) [0x0000000000000000]              
	float                                              SavedAmmoUse;                                     		// 0x0648 (0x0004) [0x0000000000000000]              
	float                                              MinimumDamage;                                    		// 0x064C (0x0004) [0x0000000000000000]              
	float                                              PartialAmmo;                                      		// 0x0650 (0x0004) [0x0000000000000000]              
	class UMaterialInstanceConstant*                   WeaponMaterialInstance;                           		// 0x0654 (0x0004) [0x0000000000000000]              
	class AUTLinkBeamLight*                            BeamLight;                                        		// 0x0658 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   StartAltFireSound;                                		// 0x065C (0x0004) [0x0000000000000000]              
	class USoundCue*                                   EndAltFireSound;                                  		// 0x0660 (0x0004) [0x0000000000000000]              
	class AUTEmitter*                                  BeamEndpointEffect;                               		// 0x0664 (0x0004) [0x0000000000000000]              
	class UParticleSystemComponent*                    PoweredUpEffect;                                  		// 0x0668 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FName                                       PoweredUpEffectSocket;                            		// 0x066C (0x0008) [0x0000000000000000]              
	struct FVector                                     BeamAttachLocation;                               		// 0x0674 (0x000C) [0x0000000000000000]              
	float                                              LastBeamAttachTime;                               		// 0x0680 (0x0004) [0x0000000000000000]              
	struct FVector                                     BeamAttachNormal;                                 		// 0x0684 (0x000C) [0x0000000000000000]              
	class AActor*                                      BeamAttachActor;                                  		// 0x0690 (0x0004) [0x0000000000000000]              
	class UClass*                                      LinkAttachmentClass;                              		// 0x0694 (0x0004) [0x0000000000000000]              
	class UParticleSystem*                             TeamMuzzleFlashTemplates[ 0x3 ];                  		// 0x0698 (0x000C) [0x0000000000000000]              
	class UParticleSystem*                             HighPowerMuzzleFlashTemplate;                     		// 0x06A4 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45034 ];
...
{
public:
	unsigned long                                      bTargetAdhesionEnabled : 1;                       		// 0x0968 (0x0004) [0x0000000000004001] [0x00000001] ( CPF_Edit | CPF_Config )
	unsigned long                                      bDebugTargetAdhesion : 1;                         		// 0x0968 (0x0004) [0x0000000000004000] [0x00000002] ( CPF_Config )
	TArray< struct FProfileSettingToUE3BindingDatum >  ProfileSettingToUE3BindingMapping360;             		// 0x096C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FProfileSettingToUE3BindingDatum >  ProfileSettingToUE3BindingMappingPS3;             		// 0x0978 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45036 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45039 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45054 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45055 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45056 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45057 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45059 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45061 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45062 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45064 ];
...
public:
	...
	struct FString                                     SteamServerId;                                    		// 0x00B4 (0x000C) [0x0000000040400000]              ( CPF_NeedCtorLink | CPF_EditInlineNotify )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45066 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45065 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45073 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45186 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45311 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45662 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45661 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45682 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45931 ];
...
public:
	...
	TArray< struct FListRow >                          ListItems;                                        		// 0x01CC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                LeaderboardReadCount;                             		// 0x01D8 (0x0004) [0x0000000000000000]              
	TArray< struct FUILeaderboardEntry >               LeaderboardData;                                  		// 0x01DC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45954 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 45956 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 46286 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 46287 ];
...
// 0x00B4 (0x0660 - 0x05AC)
class AUTVehicleWeapon : public AUTWeapon
{
public:
	int                                                SeatIndex;                                        		// 0x05AC (0x0004) [0x0000000000000020]              ( CPF_Net )
	class AUTVehicle*                                  MyVehicle;                                        		// 0x05B0 (0x0004) [0x0000000000000020]              ( CPF_Net )
	TArray< struct FName >                             FireTriggerTags;                                  		// 0x05B4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FName >                             AltFireTriggerTags;                               		// 0x05C0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FMaterialImpactEffect >             ImpactEffects;                                    		// 0x05CC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FMaterialImpactEffect >             AltImpactEffects;                                 		// 0x05D8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FMaterialImpactEffect                       DefaultImpactEffect;                              		// 0x05E4 (0x0030) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FMaterialImpactEffect                       DefaultAltImpactEffect;                           		// 0x0614 (0x0030) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class USoundCue*                                   BulletWhip;                                       		// 0x0644 (0x0004) [0x0000000000000000]              
	float                                              LastCorrectAimTime;                               		// 0x0648 (0x0004) [0x0000000000000000]              
	float                                              LastInCorrectAimTime;                             		// 0x064C (0x0004) [0x0000000000000000]              
	float                                              CurrentCrosshairScaling;                          		// 0x0650 (0x0004) [0x0000000000000000]              
	float                                              MaxFinalAimAdjustment;                            		// 0x0654 (0x0004) [0x0000000000000000]              
	unsigned long                                      bPlaySoundFromSocket : 1;                         		// 0x0658 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bCurrentlyZoomed : 1;                             		// 0x0658 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bIgnoreSocketPitchRotation : 1;                   		// 0x0658 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bIgnoreDownwardPitch : 1;                         		// 0x0658 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bDebugTurret : 1;                                 		// 0x0658 (0x0004) [0x0000000000000000] [0x00000010] 
	class UClass*                                      VehicleClass;                                     		// 0x065C (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 46345 ];
...
// 0x0140 (0x0BD0 - 0x0A90)
class AUTVehicle_Hoverboard : public AUTVehicle
{
public:
	class UUDKSkeletalMeshComponent*                   HoverboardMesh;                                   		// 0x0A90 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FVector                                     MeshLocationOffset;                               		// 0x0A94 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FRotator                                    MeshRotationOffset;                               		// 0x0AA0 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	float                                              JumpForceMag;                                     		// 0x0AAC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DodgeForceMag;                                    		// 0x0AB0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TrickJumpWarmupMax;                               		// 0x0AB4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              JumpCheckTraceDist;                               		// 0x0AB8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TrickSpinWarmup;                                  		// 0x0ABC (0x0004) [0x0000000000000000]              
	float                                              JumpDelay;                                        		// 0x0AC0 (0x0004) [0x0000000000000000]              
	float                                              LastJumpTime;                                     		// 0x0AC4 (0x0004) [0x0000000000000000]              
	unsigned long                                      bDoHoverboardJump : 1;                            		// 0x0AC8 (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	unsigned long                                      bIsDodging : 1;                                   		// 0x0AC8 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bGrabbingBoard : 1;                               		// 0x0AC8 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bNoVehicleEntry : 1;                              		// 0x0AC8 (0x0004) [0x0000000000000000] [0x00000008] 
	struct FVector                                     DodgeForce;                                       		// 0x0ACC (0x000C) [0x0000000000000000]              
	class URB_StayUprightSetup*                        LeanUprightConstraintSetup;                       		// 0x0AD8 (0x0004) [0x0000000004400008]              ( CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	class URB_ConstraintInstance*                      LeanUprightConstraintInstance;                    		// 0x0ADC (0x0004) [0x0000000004400008]              ( CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	class URB_ConstraintSetup*                         FootBoardConstraintSetup;                         		// 0x0AE0 (0x0004) [0x0000000004400008]              ( CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	class URB_ConstraintInstance*                      LeftFootBoardConstraintInstance;                  		// 0x0AE4 (0x0004) [0x0000000004400008]              ( CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	class URB_ConstraintInstance*                      RightFootBoardConstraintInstance;                 		// 0x0AE8 (0x0004) [0x0000000004400008]              ( CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	class USkelControlSingleBone*                      SpineTurnControl;                                 		// 0x0AEC (0x0004) [0x0000000000000000]              
	float                                              MaxTrackYaw;                                      		// 0x0AF0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CurrentHeadYaw;                                   		// 0x0AF4 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              TurnLeanFactor;                                   		// 0x0AF8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxLeanPitchSpeed;                                		// 0x0AFC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TargetPitch;                                      		// 0x0B00 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class URB_DistanceJointSetup*                      DistanceJointSetup;                               		// 0x0B04 (0x0004) [0x0000000004400008]              ( CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	class URB_ConstraintInstance*                      DistanceJointInstance;                            		// 0x0B08 (0x0004) [0x0000000004400008]              ( CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	class UParticleSystem*                             RedDustEffect;                                    		// 0x0B0C (0x0004) [0x0000000000000000]              
	class UParticleSystem*                             BlueDustEffect;                                   		// 0x0B10 (0x0004) [0x0000000000000000]              
	struct FName                                       DustVelMagParamName;                              		// 0x0B14 (0x0008) [0x0000000000000000]              
	struct FName                                       DustBoardHeightParamName;                         		// 0x0B1C (0x0008) [0x0000000000000000]              
	struct FName                                       DustVelParamName;                                 		// 0x0B24 (0x0008) [0x0000000000000000]              
	class UParticleSystemComponent*                    ThrusterEffect;                                   		// 0x0B2C (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FName                                       ThrusterEffectSocket;                             		// 0x0B30 (0x0008) [0x0000000000000000]              
	class UParticleSystem*                             RedThrusterEffect;                                		// 0x0B38 (0x0004) [0x0000000000000000]              
	class UParticleSystem*                             BlueThrusterEffect;                               		// 0x0B3C (0x0004) [0x0000000000000000]              
	class UParticleSystemComponent*                    RoosterEffect;                                    		// 0x0B40 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UParticleSystem*                             RoosterEffectTemplate;                            		// 0x0B44 (0x0004) [0x0000000000000000]              
	float                                              RoosterTurnScale;                                 		// 0x0B48 (0x0004) [0x0000000000000000]              
	class UAudioComponent*                             RoosterNoise;                                     		// 0x0B4C (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class USoundCue*                                   RoosterSoundCue;                                  		// 0x0B50 (0x0004) [0x0000000000000000]              
	class UAudioComponent*                             CurveSound;                                       		// 0x0B54 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class USoundCue*                                   EngineThrustSound;                                		// 0x0B58 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   TurnSound;                                        		// 0x0B5C (0x0004) [0x0000000000000000]              
	class USoundCue*                                   JumpSound;                                        		// 0x0B60 (0x0004) [0x0000000000000000]              
	float                                              CameraInitialOut;                                 		// 0x0B64 (0x0004) [0x0000000000000000]              
	struct FVector                                     HoverCamOffset;                                   		// 0x0B68 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FRotator                                    HoverCamRotOffset;                                		// 0x0B74 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     VelLookAtOffset;                                  		// 0x0B80 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     VelBasedCamOffset;                                		// 0x0B8C (0x000C) [0x0000000000000001]              ( CPF_Edit )
	float                                              VelRollFactor;                                    		// 0x0B98 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              HoverCamMaxVelUsed;                               		// 0x0B9C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ViewRollRate;                                     		// 0x0BA0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                CurrentViewRoll;                                  		// 0x0BA4 (0x0004) [0x0000000000000000]              
	float                                              TargetPhysicsWeight;                              		// 0x0BA8 (0x0004) [0x0000000000000000]              
	float                                              PhysWeightBlendTimeToGo;                          		// 0x0BAC (0x0004) [0x0000000000000000]              
	float                                              PhysWeightBlendTime;                              		// 0x0BB0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      DoubleClickMove;                                  		// 0x0BB4 (0x0001) [0x0000000000000000]              
	class UStaticMeshComponent*                        HandleMesh;                                       		// 0x0BB8 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	int                                                FallingDamageRagdollThreshold;                    		// 0x0BBC (0x0004) [0x0000000000000000]              
	float                                              ImpactGroundResetPhysRiderThresh;                 		// 0x0BC0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BigImpactPhysRiderZVel;                           		// 0x0BC4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DesiredSpeedSquared;                              		// 0x0BC8 (0x0004) [0x0000000000000000]              
	float                                              LastDesiredSpeedTime;                             		// 0x0BCC (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 46427 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 46535 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 46935 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 47055 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 47077 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 47521 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 47541 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 47582 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 47586 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 47746 ];
...
// 0x0004 (0x0874 - 0x0870)
class AUTDummyPawn : public AUTPawn
{
public:
	class UUTSeqAct_DummyWeaponFire*                   FireAction;                                       		// 0x0870 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 48127 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 48129 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 48227 ];
...
{
public:
	unsigned long                                      bFindPlayer : 1;                                  		// 0x0968 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bLockRotationToViewTarget : 1;                    		// 0x0968 (0x0004) [0x0000000000004000] [0x00000002] ( CPF_Config )
	unsigned long                                      bAutoSwitchPlayers : 1;                           		// 0x0968 (0x0004) [0x0000000000004000] [0x00000004] ( CPF_Config )
	class APlayerReplicationInfo*                      MyRealViewTarget;                                 		// 0x096C (0x0004) [0x0000000000000000]              
	float                                              AutoSwitchPlayerInterval;                         		// 0x0970 (0x0004) [0x0000000000004000]              ( CPF_Config )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 48771 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 49114 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 49167 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 49608 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 49924 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 49923 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 50086 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 50389 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 50494 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 50512 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 50773 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 50913 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 50992 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 51015 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 51550 ];
...
{
public:
	unsigned long                                      bAutoLand : 1;                                    		// 0x0A90 (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              PushForce;                                        		// 0x0A94 (0x0004) [0x0000000000000000]              
	struct FString                                     RadarLockMessage;                                 		// 0x0A98 (0x000C) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	float                                              LastRadarLockWarnTime;                            		// 0x0AA4 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 51832 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 51874 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 51905 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 52963 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 53188 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54165 ];
...
{
public:
	class AUTCTFFlag*                                  Flags[ 0x2 ];                                     		// 0x053C (0x0008) [0x0000000000000000]              
	class UClass*                                      AnnouncerMessageClass;                            		// 0x0544 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54185 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54219 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54485 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54737 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54736 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54761 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54794 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54796 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54798 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 54800 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 55050 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 55392 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 55678 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 55953 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 56152 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 56482 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 56486 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 56865 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 58232 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 59029 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 60195 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 60914 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 61975 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 62814 ];
...
// 0x003C (0x0AE4 - 0x0AA8)
class AUTVehicle_Cicada : public AUTAirVehicle
{
public:
	struct FVector                                     TurretFlashLocation;                              		// 0x0AA8 (0x000C) [0x0000000000000020]              ( CPF_Net )
	struct FRotator                                    TurretWeaponRotation;                             		// 0x0AB4 (0x000C) [0x0000000000000020]              ( CPF_Net )
	unsigned char                                      TurretFlashCount;                                 		// 0x0AC0 (0x0001) [0x0000000000000020]              ( CPF_Net )
	unsigned char                                      TurretFiringMode;                                 		// 0x0AC1 (0x0001) [0x0000000000000020]              ( CPF_Net )
	unsigned long                                      bFreelanceStart : 1;                              		// 0x0AC4 (0x0004) [0x0000000000000000] [0x00000001] 
	TArray< int >                                      JetEffectIndices;                                 		// 0x0AC8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UParticleSystem*                             TurretBeamTemplate;                               		// 0x0AD4 (0x0004) [0x0000000000000000]              
	class UUTSkelControl_JetThruster*                  JetControl;                                       		// 0x0AD8 (0x0004) [0x0000000000000000]              
	struct FName                                       JetScalingParam;                                  		// 0x0ADC (0x0008) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 63368 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 63662 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64253 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64266 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64359 ];
...
public:
	...
	TArray< struct FMessageRow >                       Messages;                                         		// 0x0188 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FMessageRow >                       FreeMessages;                                     		// 0x0194 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64534 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64777 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64780 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64910 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64911 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64913 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64915 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64921 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64928 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64927 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64930 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64934 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64936 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64939 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64938 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64942 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64941 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64944 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64946 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64950 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64953 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64955 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64957 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 64959 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66100 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66360 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66362 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66644 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66653 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66654 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66673 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66675 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66676 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66748 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66756 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66764 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66775 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66777 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66780 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66782 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66786 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66788 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66794 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66796 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66798 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66802 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66804 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66812 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66832 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66842 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66877 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 66974 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 67198 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 67313 ];
...
// 0x00C7 (0x0568 - 0x04A1)
class UUTConsolePlayerInput : public UUTPlayerInput
{
public:
	float                                              SensitivityMultiplier;                            		// 0x04A4 (0x0004) [0x0000000000000000]              
	float                                              TurningAccelerationMultiplier;                    		// 0x04A8 (0x0004) [0x0000000000000000]              
	unsigned long                                      bAutoCenterPitch : 1;                             		// 0x04AC (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	unsigned long                                      bAutoCenterVehiclePitch : 1;                      		// 0x04AC (0x0004) [0x0000000000004000] [0x00000002] ( CPF_Config )
	unsigned long                                      bViewAccelerationEnabled : 1;                     		// 0x04AC (0x0004) [0x0000000000004001] [0x00000004] ( CPF_Edit | CPF_Config )
	unsigned long                                      bDebugViewAcceleration : 1;                       		// 0x04AC (0x0004) [0x0000000000004000] [0x00000008] ( CPF_Config )
	unsigned long                                      bTargetFrictionEnabled : 1;                       		// 0x04AC (0x0004) [0x0000000000004001] [0x00000010] ( CPF_Edit | CPF_Config )
	unsigned long                                      bDebugTargetFriction : 1;                         		// 0x04AC (0x0004) [0x0000000000004000] [0x00000020] ( CPF_Config )
	unsigned long                                      bAppliedTargetFriction : 1;                       		// 0x04AC (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bIsLookingUp : 1;                                 		// 0x04AC (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bIsLookingDown : 1;                               		// 0x04AC (0x0004) [0x0000000000000000] [0x00000100] 
	float                                              LastTurnTime;                                     		// 0x04B0 (0x0004) [0x0000000000000000]              
	float                                              AutoCenterDelay;                                  		// 0x04B4 (0x0004) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	float                                              AutoVehicleCenterSpeed;                           		// 0x04B8 (0x0004) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	float                                              SlowTurnScaling;                                  		// 0x04BC (0x0004) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	float                                              ViewAccel_YawThreshold;                           		// 0x04C0 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              ViewAccel_DiagonalThreshold;                      		// 0x04C4 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              ViewAccel_BaseMultiplier;                         		// 0x04C8 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              ViewAccel_CurrMutliplier;                         		// 0x04CC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ViewAccel_TimeToHoldBeforeFastAcceleration;       		// 0x04D0 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              ViewAccel_TimeHeld;                               		// 0x04D4 (0x0004) [0x0000000000000000]              
	float                                              ViewAccel_Twitchy;                                		// 0x04D8 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              Dodge_Threshold;                                  		// 0x04DC (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	class APawn*                                       LastFrictionTarget;                               		// 0x04E0 (0x0004) [0x0000000000000000]              
	float                                              LastFrictionTargetTime;                           		// 0x04E4 (0x0004) [0x0000000000000000]              
	float                                              LastDistToTarget;                                 		// 0x04E8 (0x0004) [0x0000000000000000]              
	float                                              LastDistMultiplier;                               		// 0x04EC (0x0004) [0x0000000000000000]              
	float                                              LastDistFromAimZ;                                 		// 0x04F0 (0x0004) [0x0000000000000000]              
	float                                              LastDistFromAimY;                                 		// 0x04F4 (0x0004) [0x0000000000000000]              
	float                                              LastFrictionMultiplier;                           		// 0x04F8 (0x0004) [0x0000000000000000]              
	float                                              LastAdhesionAmtY;                                 		// 0x04FC (0x0004) [0x0000000000000000]              
	float                                              LastAdhesionAmtZ;                                 		// 0x0500 (0x0004) [0x0000000000000000]              
	float                                              LastTargetRadius;                                 		// 0x0504 (0x0004) [0x0000000000000000]              
	float                                              LastTargetHeight;                                 		// 0x0508 (0x0004) [0x0000000000000000]              
	float                                              LastDistFromAimYa;                                		// 0x050C (0x0004) [0x0000000000000000]              
	float                                              LastDistFromAimZa;                                		// 0x0510 (0x0004) [0x0000000000000000]              
	float                                              LastAdjustY;                                      		// 0x0514 (0x0004) [0x0000000000000000]              
	float                                              LastAdjustZ;                                      		// 0x0518 (0x0004) [0x0000000000000000]              
	struct FVector                                     LastCamLoc;                                       		// 0x051C (0x000C) [0x0000000000000000]              
	struct FRotator                                    LastDeltaRot;                                     		// 0x0528 (0x000C) [0x0000000000000000]              
	float                                              LeftThumbStickDeadZoneThreshold;                  		// 0x0534 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              RightThumbStickDeadZoneThreshold;                 		// 0x0538 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              MagicScaleForSensitivityMiddle;                   		// 0x053C (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              MagicScaleForSensitivityEdge;                     		// 0x0540 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              ViewAccel_RampSpeed;                              		// 0x0544 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              ViewAccel_MaxTurnSpeed;                           		// 0x0548 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              ViewAccel_PitchThreshold;                         		// 0x054C (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              ViewAccel_LookingUpOrDownBoundary;                		// 0x0550 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              ViewAccel_BackToCenterBoundary;                   		// 0x0554 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              ViewAccel_BackToCenterSpeed;                      		// 0x0558 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              AutoPitchCenterSpeed;                             		// 0x055C (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              AutoPitchStopAdjustingValue;                      		// 0x0560 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              HoverBoardPitchMultiplier;                        		// 0x0564 (0x0004) [0x0000000000004000]              ( CPF_Config )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 67347 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 67623 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68326 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68376 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68415 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68432 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68542 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68651 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68655 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68678 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68709 ];
...
{
public:
	class UPostProcessChain*                           EntryPostProcessChain;                            		// 0x0968 (0x0004) [0x0000000000000000]              
	TArray< class UPostProcessChain* >                 OldPostProcessChain;                              		// 0x096C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class ULocalPlayer*                                OldPlayer;                                        		// 0x0978 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68729 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68730 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68922 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 68931 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69030 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69065 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69080 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69082 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69092 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69104 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69113 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69118 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69172 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69182 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69188 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69240 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69273 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69356 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69485 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69496 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69524 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69528 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69530 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69544 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69564 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69573 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69578 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69589 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69595 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69606 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69608 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69610 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69615 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69628 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69643 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69648 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69658 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69670 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69696 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69698 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69703 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69706 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69709 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69761 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69763 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69789 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69799 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69811 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69813 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69815 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69828 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69830 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69832 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69834 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69838 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69847 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69849 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69852 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69860 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69876 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69952 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69954 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69964 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 69980 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70001 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70003 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70009 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70011 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70020 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70023 ];
...
{
public:
	class AUTVehicle_Hoverboard*                       MyHoverboard;                                     		// 0x0660 (0x0004) [0x0000000000000020]              ( CPF_Net )
	float                                              MaxAttachRange;                                   		// 0x0664 (0x0004) [0x0000000000000000]              
	float                                              CrossScaler;                                      		// 0x0668 (0x0004) [0x0000000000000000]              
	float                                              CrossScaleTime;                                   		// 0x066C (0x0004) [0x0000000000000000]              
	class UTexture2D*                                  CrossHairTexture;                                 		// 0x0670 (0x0004) [0x0000000000000000]              
...
{
public:
	float                                              JumpForceMag;                                     		// 0x0A90 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxJumpZVel;                                      		// 0x0A94 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              JumpCheckTraceDist;                               		// 0x0A98 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              JumpDelay;                                        		// 0x0A9C (0x0004) [0x0000000000000000]              
	float                                              LastJumpTime;                                     		// 0x0AA0 (0x0004) [0x0000000000000000]              
	float                                              DuckForceMag;                                     		// 0x0AA4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bDoBikeJump : 1;                                  		// 0x0AA8 (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	unsigned long                                      bHoldingDuck : 1;                                 		// 0x0AA8 (0x0004) [0x0000000000000020] [0x00000002] ( CPF_Net )
	unsigned long                                      bPressingAltFire : 1;                             		// 0x0AA8 (0x0004) [0x0000000000000000] [0x00000004] 
	class USoundCue*                                   JumpSound;                                        		// 0x0AAC (0x0004) [0x0000000000000000]              
	class USoundCue*                                   DuckSound;                                        		// 0x0AB0 (0x0004) [0x0000000000000000]              
	float                                              BladeBlur;                                        		// 0x0AB4 (0x0004) [0x0000000000000000]              
	float                                              DesiredBladeBlur;                                 		// 0x0AB8 (0x0004) [0x0000000000000000]              
	int                                                FanEffectIndex;                                   		// 0x0ABC (0x0004) [0x0000000000000000]              
	struct FName                                       FanEffectParameterName;                           		// 0x0AC0 (0x0008) [0x0000000000000000]              
	struct FName                                       FlameJetEffectParameterName;                      		// 0x0AC8 (0x0008) [0x0000000000000000]              
	float                                              FlameJetValue;                                    		// 0x0AD0 (0x0004) [0x0000000000000000]              
	float                                              DesiredFlameJetValue;                             		// 0x0AD4 (0x0004) [0x0000000000000000]              
	float                                              FullWheelSuspensionTravel;                        		// 0x0AD8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CrouchedWheelSuspensionTravel;                    		// 0x0ADC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SuspensionTravelAdjustSpeed;                      		// 0x0AE0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              FullWheelSuspensionStiffness;                     		// 0x0AE4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CrouchedWheelSuspensionStiffness;                 		// 0x0AE8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BoneOffsetZAdjust;                                		// 0x0AEC (0x0004) [0x0000000000000000]              
	float                                              CrouchedAirSpeed;                                 		// 0x0AF0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              FullAirSpeed;                                     		// 0x0AF4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
// 0x0130 (0x0BC0 - 0x0A90)
class AUTVehicle_Scorpion : public AUTVehicle
{
public:
	class UUTAnimBlendByWeapon*                        BladeBlend;                                       		// 0x0A90 (0x0004) [0x0000000000000000]              
	unsigned long                                      bBrakeLightOn : 1;                                		// 0x0A94 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bReverseLightOn : 1;                              		// 0x0A94 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bHeadlightsOn : 1;                                		// 0x0A94 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bBladesExtended : 1;                              		// 0x0A94 (0x0004) [0x0000000000000020] [0x00000008] ( CPF_Net )
	unsigned long                                      bLeftBladeBroken : 1;                             		// 0x0A94 (0x0004) [0x0000000000000020] [0x00000010] ( CPF_Net )
	unsigned long                                      bRightBladeBroken : 1;                            		// 0x0A94 (0x0004) [0x0000000000000020] [0x00000020] ( CPF_Net )
	unsigned long                                      bBoostersActivated : 1;                           		// 0x0A94 (0x0004) [0x0000000000000020] [0x00000040] ( CPF_Net )
	unsigned long                                      bSteeringLimited : 1;                             		// 0x0A94 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bScriptedBoosters : 1;                            		// 0x0A94 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bSelfDestructArmed : 1;                           		// 0x0A94 (0x0004) [0x0000000000000020] [0x00000200] ( CPF_Net )
	unsigned long                                      bTryToBoost : 1;                                  		// 0x0A94 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bWasThrottle : 1;                                 		// 0x0A94 (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bAISelfDestruct : 1;                              		// 0x0A94 (0x0004) [0x0000000000000000] [0x00001000] 
	float                                              BladeBreakPoint;                                  		// 0x0A98 (0x0004) [0x0000000000000000]              
	struct FName                                       BrakeLightParameterName;                          		// 0x0A9C (0x0008) [0x0000000000000000]              
	struct FName                                       ReverseLightParameterName;                        		// 0x0AA4 (0x0008) [0x0000000000000000]              
	struct FName                                       HeadLightParameterName;                           		// 0x0AAC (0x0008) [0x0000000000000000]              
	struct FName                                       RightBladeStartSocket;                            		// 0x0AB4 (0x0008) [0x0000000000000000]              
	struct FName                                       RightBladeEndSocket;                              		// 0x0ABC (0x0008) [0x0000000000000000]              
	struct FName                                       LeftBladeStartSocket;                             		// 0x0AC4 (0x0008) [0x0000000000000000]              
	struct FName                                       LeftBladeEndSocket;                               		// 0x0ACC (0x0008) [0x0000000000000000]              
	class UClass*                                      BladeDamageType;                                  		// 0x0AD4 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   BladeBreakSound;                                  		// 0x0AD8 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   BladeExtendSound;                                 		// 0x0ADC (0x0004) [0x0000000000000000]              
	class USoundCue*                                   BladeRetractSound;                                		// 0x0AE0 (0x0004) [0x0000000000000000]              
	float                                              BoosterForceMagnitude;                            		// 0x0AE4 (0x0004) [0x0000000000000000]              
	class AController*                                 SelfDestructInstigator;                           		// 0x0AE8 (0x0004) [0x0000000000000000]              
	float                                              BoosterCheckRadius;                               		// 0x0AEC (0x0004) [0x0000000000000000]              
	float                                              MaxBoostDuration;                                 		// 0x0AF0 (0x0004) [0x0000000000000000]              
	float                                              BoostStartTime;                                   		// 0x0AF4 (0x0004) [0x0000000000000000]              
	float                                              BoostChargeDuration;                              		// 0x0AF8 (0x0004) [0x0000000000000000]              
	float                                              BoostChargeTime;                                  		// 0x0AFC (0x0004) [0x0000000000000000]              
	class UAudioComponent*                             BoosterSound;                                     		// 0x0B00 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FTextureCoordinates                         BoostToolTipIconCoords;                           		// 0x0B04 (0x0010) [0x0000000000000000]              
	struct FTextureCoordinates                         EjectToolTipIconCoords;                           		// 0x0B14 (0x0010) [0x0000000000000000]              
	class UClass*                                      SelfDestructDamageType;                           		// 0x0B24 (0x0004) [0x0000000000000000]              
	float                                              BoostPowerSpeed;                                  		// 0x0B28 (0x0004) [0x0000000000000000]              
	float                                              BoostReleaseTime;                                 		// 0x0B2C (0x0004) [0x0000000000000000]              
	float                                              BoostReleaseDelay;                                		// 0x0B30 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SelfDestructSoundCue;                             		// 0x0B34 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SelfDestructReadyCue;                             		// 0x0B38 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SelfDestructWarningSound;                         		// 0x0B3C (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SelfDestructEnabledSound;                         		// 0x0B40 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SelfDestructEnabledLoop;                          		// 0x0B44 (0x0004) [0x0000000000000000]              
	class UCameraAnim*                                 RedBoostCamAnim;                                  		// 0x0B48 (0x0004) [0x0000000000000000]              
	class UCameraAnim*                                 BlueBoostCamAnim;                                 		// 0x0B4C (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SuspensionShiftSound;                             		// 0x0B50 (0x0004) [0x0000000000000000]              
	class UAudioComponent*                             SelfDestructEnabledComponent;                     		// 0x0B54 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UAudioComponent*                             SelfDestructWarningComponent;                     		// 0x0B58 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UAudioComponent*                             SelfDestructReadyComponent;                       		// 0x0B5C (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class USoundCue*                                   EjectSoundCue;                                    		// 0x0B60 (0x0004) [0x0000000000000000]              
	float                                              BoosterFOVAngle;                                  		// 0x0B64 (0x0004) [0x0000000000000000]              
	class UUTAnimBlendByWeapon*                        BoosterBlend;                                     		// 0x0B68 (0x0004) [0x0000000000000000]              
	float                                              ThrottleStartTime;                                		// 0x0B6C (0x0004) [0x0000000000000000]              
	float                                              BoostUprightTorqueFactor;                         		// 0x0B70 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BoostUprightMaxTorque;                            		// 0x0B74 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DefaultUprightTorqueFactor;                       		// 0x0B78 (0x0004) [0x0000000000000000]              
	float                                              DefaultUprightMaxTorque;                          		// 0x0B7C (0x0004) [0x0000000000000000]              
	class UPointLightComponent*                        LeftBoosterLight;                                 		// 0x0B80 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UPointLightComponent*                        RightBoosterLight;                                		// 0x0B84 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class ARB_ConstraintActor*                         BladeVictimConstraint[ 0x2 ];                     		// 0x0B88 (0x0008) [0x0000000000000000]              
	class UStaticMesh*                                 ScorpionHood;                                     		// 0x0B90 (0x0004) [0x0000000000000000]              
	float                                              RocketSpeed;                                      		// 0x0B94 (0x0004) [0x0000000000000000]              
	float                                              SelfDestructSpeedSquared;                         		// 0x0B98 (0x0004) [0x0000000000000000]              
	float                                              LockSuspensionTravel;                             		// 0x0B9C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LockSuspensionStiffness;                          		// 0x0BA0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BoostSteerFactors[ 0x3 ];                         		// 0x0BA4 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	class UParticleSystem*                             SelfDestructExplosionTemplate;                    		// 0x0BB0 (0x0004) [0x0000000000000000]              
	class UClass*                                      HatchGibClass;                                    		// 0x0BB4 (0x0004) [0x0000000000000000]              
	class UStaticMesh*                                 BrokenBladeMesh;                                  		// 0x0BB8 (0x0004) [0x0000000000000000]              
	float                                              LastBladeBoostTime;                               		// 0x0BBC (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70526 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70749 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70812 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70817 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 70861 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 71723 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 71787 ];
