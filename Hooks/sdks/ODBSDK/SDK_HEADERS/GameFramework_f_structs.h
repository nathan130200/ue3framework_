...
struct AGameAIController_eventAILog_Internal_Parms
{
	...
	// struct FString                                  ActionStr;                                        		// 0x001C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// struct FString                                  FinalStr;                                         		// 0x0028 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	// int                                             FileNameLength;                                   		// 0x0044 (0x0004) [0x0000000000000000]              
	// class UEngine*                                  Eng;                                              		// 0x0048 (0x0004) [0x0000000000000000]              
};
