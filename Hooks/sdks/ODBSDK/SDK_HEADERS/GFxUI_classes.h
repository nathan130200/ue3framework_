...
public:
	...
	unsigned long                                      bCaptureMouseInput : 1;                           		// 0x00C8 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bIgnoreMouseInput : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bIsSplitscreenLayoutModified : 1;                 		// 0x00C8 (0x0004) [0x0000000000002000] [0x00010000] ( CPF_Transient )
	unsigned long                                      bShowHardwareMouseCursor : 1;                     		// 0x00C8 (0x0004) [0x0000000000000000] [0x00020000] 
	unsigned long                                      bBlurLesserMovies : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00040000] 
	unsigned long                                      bHideLesserMovies : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00080000] 
	unsigned long                                      bIsPriorityBlurred : 1;                           		// 0x00C8 (0x0004) [0x0000000000000000] [0x00100000] 
	unsigned long                                      bIsPriorityHidden : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00200000] 
	unsigned long                                      bIgnoreVisibilityEffect : 1;                      		// 0x00C8 (0x0004) [0x0000000000000000] [0x00400000] 
	unsigned long                                      bIgnoreBlurEffect : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00800000] 
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32434 ];
