...
public:
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x01A99270 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x01535810 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x015335B0 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x02BC14F0 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x026CBCB0 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x02DBA390 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x01575E80 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x01575EC0 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x0150C830 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x0157AA10 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x01A99270 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x01571D30 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x01529E80 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x01531780 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x013A1DF0 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x02DBA390 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x015729D0 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x01570F40 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x01570F50 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x01572AA0 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x01571240 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x01570F80 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x01571270 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x02DBA390 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x02DBA390 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x01695960 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x01570F70 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x01570F80 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x01571270 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x01570F80 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x01571270 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x01575980 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x01572B90 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x01572D80 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x02DBA390 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x015240B0 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x01583560 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x013A1E10 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x013A1E40 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x013A1E70 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x025334D0 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x013A1F50 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x025334D0 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x01695960 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x01695960 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x02DBA390 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x025334D0 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x01A8C500 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x01A934C0 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x01524130 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x0152D020 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x026CBCB0 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x026CBCB0 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x0150C6B0 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x01533300 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x01574DF0 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x02D37A30 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x015711F0 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x01577800 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x014F2CB0 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x01582B50 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x02DBA390 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x025334D0 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x013A1D30 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x013A1D50 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x015895F0 (0x104)
	virtual void VirtualFunction66 ( );																			// 0x01570FB0 (0x108)
	virtual void VirtualFunction67 ( );																			// 0x015300D0 (0x10C)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x01528E50 (0x110)
};
