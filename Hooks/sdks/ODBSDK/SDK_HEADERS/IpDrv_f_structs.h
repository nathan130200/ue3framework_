...
struct UMeshBeaconClient_execDebugRender_Parms
{
	...
	// float                                           Offset;                                           		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
{
	class UCanvas*                                     Canvas;                                           		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FUniqueNetId                                CurOptimalHostId;                                 		// 0x0004 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	// int                                             ClientIdx;                                        		// 0x000C (0x0004) [0x0000000000000000]              
	// int                                             HistoryIdx;                                       		// 0x0010 (0x0004) [0x0000000000000000]              
	// struct FUniqueNetId                             NetId;                                            		// 0x0014 (0x0008) [0x0000000000000000]              
	// float                                           XL;                                               		// 0x001C (0x0004) [0x0000000000000000]              
	// float                                           YL;                                               		// 0x0020 (0x0004) [0x0000000000000000]              
	// float                                           Offset;                                           		// 0x0024 (0x0004) [0x0000000000000000]              
};
