...
{
public:
	unsigned char                                      UnknownData00[ 0xB ];                             		// 0x05F5 (0x000B) MISSED OFFSET
...
// 0x002B (0x0620 - 0x05F5)
class UASVSkelComponent : public USkeletalMeshComponent
{
public:
	unsigned char                                      UnknownData00[ 0x2B ];                            		// 0x05F5 (0x002B) MISSED OFFSET
...
// 0x001B (0x0610 - 0x05F5)
class UPhATSkeletalMeshComponent : public USkeletalMeshComponent
{
public:
	unsigned char                                      UnknownData00[ 0x1B ];                            		// 0x05F5 (0x001B) MISSED OFFSET
