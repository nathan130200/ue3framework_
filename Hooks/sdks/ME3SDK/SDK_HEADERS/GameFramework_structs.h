...
struct FScreenShakeAnimStruct
{
	...
	class UCameraAnim*                                 Anim_Left;                                        		// 0x0004 (0x0004) [0x0000000000000000]              
	class UCameraAnim*                                 Anim_Right;                                       		// 0x0008 (0x0004) [0x0000000000000000]              
	class UCameraAnim*                                 Anim_Rear;                                        		// 0x000C (0x0004) [0x0000000000000000]              
	float                                              AnimPlayRate;                                     		// 0x0010 (0x0004) [0x0000000000000000]              
	float                                              AnimScale;                                        		// 0x0014 (0x0004) [0x0000000000000000]              
	float                                              AnimBlendInTime;                                  		// 0x0018 (0x0004) [0x0000000000000000]              
	float                                              AnimBlendOutTime;                                 		// 0x001C (0x0004) [0x0000000000000000]              
	float                                              RandomSegmentDuration;                            		// 0x0020 (0x0004) [0x0000000000000000]              
	unsigned long                                      bUseDirectionalAnimVariants : 1;                  		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bRandomSegment : 1;                               		// 0x0024 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bSingleInstance : 1;                              		// 0x0024 (0x0004) [0x0000000000000000] [0x00000004] 
};
...
struct FTakeHitInfo
{
	...
	struct FVector                                     RadialDamageOrigin;                               		// 0x001C (0x000C) [0x0000000000000000]              
	class APawn*                                       instigatedBy;                                     		// 0x0028 (0x0004) [0x0000000000000000]              
	class UPhysicalMaterial*                           PhysicalMaterial;                                 		// 0x002C (0x0004) [0x0000000000000000]              
	float                                              Damage;                                           		// 0x0030 (0x0004) [0x0000000000000000]              
	unsigned char                                      HitBoneIndex;                                     		// 0x0034 (0x0001) [0x0000000000000000]              
};
...
{
	struct FString                                     PropertyValue;                                    		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FName                                       PropertyName;                                     		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bModifyProperty : 1;                              		// 0x0014 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
};
