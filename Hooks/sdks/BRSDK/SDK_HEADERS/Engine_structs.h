...
struct FImpactInfo
{
	...
	float                                              DistanceTraveled;                                 		// 0x0050 (0x0004) [0x0000000000100000]              
};
...
struct FRBCollisionChannelContainer
{
	...
	unsigned long                                      ClientOnly : 1;                                   		// 0x0000 (0x0004) [0x0000000000000003] [0x00000400] ( CPF_Edit | CPF_Const )
...
struct FBeastPrimPropertiesContainer
{
	...
	unsigned long                                      VisibleForEye : 1;                                		// 0x0000 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      VisibleForReflections : 1;                        		// 0x0000 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      VisibleForRefractions : 1;                        		// 0x0000 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      VisibleForGI : 1;                                 		// 0x0000 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      ReceiveShadows : 1;                               		// 0x0000 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
...
struct FOnlinePartyMember
{
	...
	unsigned long                                      bIsPlayingThisGame : 1;                           		// 0x001C (0x0004) [0x0000000000000002] [0x00000010] ( CPF_Const )
	struct FQWord                                      SessionId;                                        		// 0x0020 (0x0008) [0x0000000000000002]              ( CPF_Const )
	int                                                Data1;                                            		// 0x0028 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                Data2;                                            		// 0x002C (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                Data3;                                            		// 0x0030 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                Data4;                                            		// 0x0034 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
struct FOnlineFriendMessage
{
	...
	struct FString                                     RecievingPlayerNick;                              		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
// ScriptStruct Engine.OnlineSubsystem.BuddyImageIndexContainer
// 0x0010
struct FBuddyImageIndexContainer
{
	struct FString                                     nick;                                             		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                Index;                                            		// 0x000C (0x0004) [0x0000000000000000]              
};

// ScriptStruct Engine.OnlineSubsystem.RequestEntry
// 0x001C
struct FRequestEntry
{
	...
	struct FUniqueNetId                                Id;                                               		// 0x0010 (0x0008) [0x0000000000000000]              
	unsigned long                                      IsApproved : 1;                                   		// 0x0018 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FOnlineFriend
{
	...
	int                                                nImageIndex;                                      		// 0x0030 (0x0004) [0x0000000000000000]              
	unsigned long                                      bImageRequested : 1;                              		// 0x0034 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
// ScriptStruct Engine.Controller.AwardCountInfo
// 0x000C
struct FAwardCountInfo
{
	int                                                Count;                                            		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                TotalMatchCount;                                  		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                LastChange;                                       		// 0x0008 (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct Engine.PostProcessVolume.PostProcessParameter
// 0x0028
struct FPostProcessParameter
{
	struct FName                                       MaterialName;                                     		// 0x0000 (0x0008) [0x0000000000000000]              
	struct FName                                       ParameterName;                                    		// 0x0008 (0x0008) [0x0000000000000000]              
	unsigned char                                      ParameterType;                                    		// 0x0010 (0x0001) [0x0000000000000000]              
	struct FLinearColor                                VectorValue;                                      		// 0x0014 (0x0010) [0x0000000000000000]              
...
struct FPostProcessSettings
{
	...
	unsigned long                                      bEnableBloom : 1;                                 		// 0x0004 (0x0004) [0x0000000000000001] [0x00000100] ( CPF_Edit )
	unsigned long                                      bEnableDOF : 1;                                   		// 0x0004 (0x0004) [0x0000000000000001] [0x00000200] ( CPF_Edit )
	unsigned long                                      bTwoLayerSimpleDepthOfField : 1;                  		// 0x0004 (0x0004) [0x0000000000000000] [0x00000400] 
	...
	TArray< struct FPostProcessParameter >             ParameterArray;                                   		// 0x00E0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FSeqVarLink
{
	...
	TArray< class USequenceVariable* >                 ExternallyLinkedVariables;                        		// 0x0010 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     LinkDesc;                                         		// 0x001C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	class UProperty*                                   CachedProperty;                                   		// 0x0048 (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	unsigned long                                      bAllowAnyType : 1;                                		// 0x004C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bMoving : 1;                                      		// 0x004C (0x0004) [0x0000000000002000] [0x00000002] ( CPF_Transient )
	unsigned long                                      bClampedMax : 1;                                  		// 0x004C (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bClampedMin : 1;                                  		// 0x004C (0x0004) [0x0000000000000000] [0x00000008] 
	int                                                OverrideDelta;                                    		// 0x0050 (0x0004) [0x0000000000000000]              
};
...
struct FOnlineGameSearchResult
{
	...
	struct FPointer                                    SBServerPointer;                                  		// 0x0008 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
};
...
// ScriptStruct Engine.AudioDevice.SoundClassVolume
// 0x000C
struct FSoundClassVolume
{
	struct FName                                       SoundClass;                                       		// 0x0000 (0x0008) [0x0000000000001001]              ( CPF_Edit | CPF_Native )
	float                                              Volume;                                           		// 0x0008 (0x0004) [0x0000000000001001]              ( CPF_Edit | CPF_Native )
};
...
{
	unsigned long                                      bShowSocketMesh : 1;                              		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FName                                       DisplayName;                                      		// 0x0004 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       SocketName;                                       		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              SocketMeshScale;                                  		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class USkeletalMesh*                               PreviewSkelMesh;                                  		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UStaticMesh*                                 PreviewStaticMesh;                                		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FNxDestructibleParameters
{
	...
	int                                                DebrisDepth;                                      		// 0x0080 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                EssentialDepth;                                   		// 0x0084 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DebrisLifetimeMin;                                		// 0x0088 (0x0004) [0x0000000020000000]              ( CPF_Deprecated )
	float                                              DebrisLifetimeMax;                                		// 0x008C (0x0004) [0x0000000020000000]              ( CPF_Deprecated )
	float                                              DebrisMaxSeparationMin;                           		// 0x0090 (0x0004) [0x0000000020000000]              ( CPF_Deprecated )
	float                                              DebrisMaxSeparationMax;                           		// 0x0094 (0x0004) [0x0000000020000000]              ( CPF_Deprecated )
	struct FBox                                        ValidBounds;                                      		// 0x0098 (0x001C) [0x0000000020000000]              ( CPF_Deprecated )
	float                                              MaxChunkSpeed;                                    		// 0x00B4 (0x0004) [0x0000000020000000]              ( CPF_Deprecated )
	float                                              MassScaleExponent;                                		// 0x00B8 (0x0004) [0x0000000020000000]              ( CPF_Deprecated )
	struct FNxDestructibleParametersFlag               Flags;                                            		// 0x00BC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              GrbVolumeLimit;                                   		// 0x00C0 (0x0004) [0x0000000020000000]              ( CPF_Deprecated )
	float                                              GrbParticleSpacing;                               		// 0x00C4 (0x0004) [0x0000000020000000]              ( CPF_Deprecated )
	float                                              FractureImpulseScale;                             		// 0x00C8 (0x0004) [0x0000000020000000]              ( CPF_Deprecated )
	TArray< struct FNxDestructibleDepthParameters >    DepthParameters;                                  		// 0x00CC (0x000C) [0x0000000000400041]              ( CPF_Edit | CPF_EditConstArray | CPF_NeedCtorLink )
};
...
struct FBeastMaterialPropertiesContainer
{
	...
	unsigned long                                      UseOverrides : 1;                                 		// 0x0014 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FLinearColor                                OverrideColor;                                    		// 0x0018 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	float                                              OverrideScale;                                    		// 0x0028 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FLightmassWorldInfoSettings
{
	...
	unsigned long                                      bEnableImageReflectionShadowing : 1;              		// 0x0020 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
...
// ScriptStruct Engine.GameEngine.BannedID
// 0x0018
struct FBannedID
{
	...
	int                                                BanRemovalTime;                                   		// 0x0014 (0x0004) [0x0000000000000000]              
};
...
struct FBeastMaterialInstancePropertiesOverrides
{
	...
	unsigned long                                      UseOverrides : 1;                                 		// 0x0000 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      OverrideColor : 1;                                		// 0x0000 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      OverrideScale : 1;                                		// 0x0000 (0x0004) [0x0000000000000000] [0x00000200] 
};
...
struct FBeastMaterialInstancePropertiesContainer
{
	...
	struct FLinearColor                                OverrideColor;                                    		// 0x0018 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	float                                              OverrideScale;                                    		// 0x0028 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FBeastMaterialInstancePropertiesOverrides   Overrides;                                        		// 0x002C (0x0004) [0x0000000000000000]              
};
...
{
	struct FPostProcessSettings                        Settings;                                         		// 0x0000 (0x00EC) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bBlendingIn : 1;                                  		// 0x00EC (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bBlendingOut : 1;                                 		// 0x00EC (0x0004) [0x0000000000000000] [0x00000002] 
	float                                              CurrentBlendInTime;                               		// 0x00F0 (0x0004) [0x0000000000000000]              
	float                                              CurrentBlendOutTime;                              		// 0x00F4 (0x0004) [0x0000000000000000]              
	float                                              BlendInDuration;                                  		// 0x00F8 (0x0004) [0x0000000000000000]              
	float                                              BlendOutDuration;                                 		// 0x00FC (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x0100 (0x0004) [0x0000000000000000]              
};
...
{
	struct FPostProcessSettings                        LastSettings;                                     		// 0x0000 (0x00EC) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FPostProcessSettings                        NewSettings;                                      		// 0x00EC (0x00EC) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class APostProcessVolume*                          LastVolumeUsed;                                   		// 0x01D8 (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x01DC (0x0004) [0x0000000000000000]              
	float                                              LastBlendTime;                                    		// 0x01E0 (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct Engine.OnlinePlayerStorage.KeyBindDup
// 0x0018
struct FKeyBindDup
{
...
// ScriptStruct Engine.OnlinePlayerStorage.VideoSettingsStructDup
// 0x0034
struct FVideoSettingsStructDup
{
...
{
	struct FUniqueNetId                                PlayerID;                                         		// 0x0000 (0x0008) [0x0000000000000000]              
	struct FSettingsData                               Rank;                                             		// 0x0008 (0x000C) [0x0000000000000000]              
	struct FString                                     NickName;                                         		// 0x0014 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
// ScriptStruct Engine.SkeletalMesh.BoneProperty
// 0x000C
struct FBoneProperty
{
	struct FName                                       BoneName;                                         		// 0x0000 (0x0008) [0x0000000000020003]              ( CPF_Edit | CPF_Const | CPF_EditConst )
	class UPhysicalMaterial*                           PhysMaterial;                                     		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
// ScriptStruct Engine.SkyLightComponent.BeastSkyLightPropertiesContainer
// 0x000C
struct FBeastSkyLightPropertiesContainer
{
	class UTexture*                                    Texture;                                          		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Rotation;                                         		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BlurForGI;                                        		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
