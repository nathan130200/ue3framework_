...
// ScriptStruct GFxUI.GFxMoviePlayer.TGFxValue
// 0x0004
struct FTGFxValue
{
	struct FPointer                                    pValue;                                           		// 0x0000 (0x0004) [0x0000000000001000]              ( CPF_Native )
};
...
// ScriptStruct GFxUI.GFxObject.TGFxScriptDelegate
// 0x000C
struct FTGFxScriptDelegate
{
	class UGFxObject*                                  Object;                                           		// 0x0000 (0x0004) [0x0000000000000000]              
	struct FName                                       MemberName;                                       		// 0x0004 (0x0008) [0x0000000000000000]              
};
...
struct FEventData
{
	...
	struct FString                                     Type;                                             		// 0x0004 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                Data;                                             		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                mouseIndex;                                       		// 0x0014 (0x0004) [0x0000000000000000]              
	int                                                Button;                                           		// 0x0018 (0x0004) [0x0000000000000000]              
	int                                                Index;                                            		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                lastIndex;                                        		// 0x0020 (0x0004) [0x0000000000000000]              
};
