...
// [0x00020401] ( FUNC_Final | FUNC_Native )
struct UGFxMoviePlayer_execAddFocusIgnoreKeyS_Parms
{
...
// [0x00022002] 
struct UGFxObject_execLocalizeFromPath_Parms
{
	struct FString                                     inPath;                                           		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     ReturnValue;                                      		// 0x000C (0x000C) [0x0000000000400580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
	// struct FString                                  tmpString;                                        		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// TArray< struct FString >                        tokens;                                           		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};

// Function GFxUI.GFxObject.LocalizedToFlash
// [0x00022002] 
struct UGFxObject_execLocalizedToFlash_Parms
{
	struct FString                                     sSource;                                          		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     ReturnValue;                                      		// 0x000C (0x000C) [0x0000000000400580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
};
...
// [0x00020802] ( FUNC_Event )
struct UGFxObject_eventCreateCallback_Parms
{
	class UGFxObject*                                  pObj;                                             		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FName                                       MemberName;                                       		// 0x0004 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	int                                                ReturnValue;                                      		// 0x000C (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
