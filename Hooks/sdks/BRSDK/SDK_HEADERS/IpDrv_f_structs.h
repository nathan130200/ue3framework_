...
// [0x00020002] 
struct UOnlineGameInterfaceImpl_execClearUpdateServerItemCompleteDelegate_Parms
{
	struct FScriptDelegate                             UpdateServerItemCompleteDelegate;                 		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	// int                                             RemoveIndex;                                      		// 0x000C (0x0004) [0x0000000000000000]              
};

// Function IpDrv.OnlineGameInterfaceImpl.AddUpdateServerItemCompleteDelegate
// [0x00020002] 
struct UOnlineGameInterfaceImpl_execAddUpdateServerItemCompleteDelegate_Parms
{
	struct FScriptDelegate                             UpdateServerItemCompleteDelegate;                 		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
...
// [0x00120000] 
struct UOnlineGameInterfaceImpl_execOnUpdateServerItemComplete_Parms
{
	unsigned long                                      bWasSuccessful : 1;                               		// 0x0000 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
};
