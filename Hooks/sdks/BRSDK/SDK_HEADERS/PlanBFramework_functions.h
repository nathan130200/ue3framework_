...
// Function PlanBFramework.PBBasePawn.StopAndResetAllAnimations
// [0x00020102] 
// Parameters infos:

void APBBasePawn::StopAndResetAllAnimations ( )
{
	...
	this->ProcessEvent ( pFnStopAndResetAllAnimations, &StopAndResetAllAnimations_Parms, NULL );
};
...
// Function PlanBFramework.PBBasePawn.GoIntoRagdollNextFrame
// [0x00020102] 
// Parameters infos:

void APBBasePawn::GoIntoRagdollNextFrame ( )
{
	...
	this->ProcessEvent ( pFnGoIntoRagdollNextFrame, &GoIntoRagdollNextFrame_Parms, NULL );
};
...
// Function PlanBFramework.PBBasePawn.TestSkeletonOverlap
// [0x00020501] ( FUNC_Final | FUNC_Native )
// Parameters infos:
// bool                           ReturnValue                    ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )

bool APBBasePawn::TestSkeletonOverlap ( )
{
	...
	pFnTestSkeletonOverlap->FunctionFlags |= ~0x400;

	this->ProcessEvent ( pFnTestSkeletonOverlap, &TestSkeletonOverlap_Parms, NULL );

	pFnTestSkeletonOverlap->FunctionFlags |= 0x400;

	return TestSkeletonOverlap_Parms.ReturnValue;
};
