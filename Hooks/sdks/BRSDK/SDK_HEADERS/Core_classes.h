...
public:
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00BE4250 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x00471E30 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x0046FEA0 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00E14200 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x00608C60 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x00DBA910 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x004AC5F0 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x004AC630 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x00446CF0 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x00BE4250 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x004B19B0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x00BE4250 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x004A8780 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x00464990 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x0046DFB0 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x004319B0 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x00DBA910 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x004A9040 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x004B36B0 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x004ADC70 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x004A9120 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x004A7C50 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x004A7C90 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x004A7C20 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x00DBA910 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00DBA910 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x00E13540 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x004A7C80 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x004A7C90 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x004A7C20 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x004A7C90 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x004A7C20 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x004AC0F0 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x004A9210 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x004A9400 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x00DBA910 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x0045EAE0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x004BB360 (0x94)
	...
	virtual void VirtualFunction41 ( );																			// 0x00C95690 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x00404230 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x00C95690 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x00E13540 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x00E13540 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x00DBA910 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x00C95690 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x0095C8E0 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x009682F0 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x0045EB60 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x00468D00 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x00608C60 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x00608C60 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x00446B70 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x0046FBF0 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x004AB230 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x00889600 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x004A7C00 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x004AD350 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x0042FB50 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x004BA910 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x00C95690 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x00401760 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x00401780 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x004C1AC0 (0x104)
	virtual void VirtualFunction66 ( );																			// 0x004A7FB0 (0x108)
	virtual void VirtualFunction67 ( );																			// 0x0046CA00 (0x10C)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x00463940 (0x110)
};
