...
public:
	...
	struct FString GuidToString ( struct FGuid InGuid );
	struct FGuid ParseGuid ( struct FString GuidString );
	void eventPreEditChange ( class UProperty* PropertyAboutToChange );
	void eventPostEditChange ( class UProperty* ChangedProperty );
	struct FGuid CreateGuid ( );
	void SaveOutermostPackage ( );
	struct FString GetHumanReadableName ( );
	struct FString WhirlpoolHash ( struct FString Message, struct FString Challenge );
	struct FGuid StrToGuid ( struct FString guidStr );
	struct FString GuidToStr ( struct FGuid guidToConvert );
	void CloseInGamePropertyWindow ( int iWindowPointer );
	int OpenInGamePropertyWindowSize ( int X, int Y, int SizeX, int SizeY, unsigned long bExpandCategories );
	int OpenInGamePropertyWindow ( );
	void Warn ( struct FString S, unsigned long bIsTrue );
	void Log ( struct FString S, struct FName T );
	struct FString GetCountryLanguageCode ( );
	...
	void AGClosestPointOnSegment ( struct FVector Point, struct FVector StartPoint, struct FVector EndPoint, struct FVector* OutClosestPoint );
	bool GetDistanceWithinConeSegment ( struct FVector Point, struct FVector ConeStartPoint, struct FVector ConeLine, float RadiusAtStart, float RadiusAtEnd, float* PercentageOut );
	...
	struct FString FloatToString ( float fFloat, int nDigitsAfterComma );
	class UClass* FindClassByName ( struct FName ClassName, class UClass* baseClass );
	bool CallFunction ( struct FName functionName, unsigned long bGlobal );
	bool FindFunction ( struct FName functionName, unsigned long bGlobal );
	bool IsArchetype ( );
	bool IsInEditor ( );
	bool IsUTracing ( );
	...
	struct FRotator RInterpTo ( struct FRotator Current, struct FRotator Target, float DeltaTime, float InterpSpeed, unsigned long bConstantInterpSpeed, unsigned long bNormalize, unsigned long bShortestPath );
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00CBF4D0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x00471750 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x0046F800 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00E13970 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x009FFC60 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x00969460 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x004ABB90 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x004ABBD0 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x00446DF0 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x00CBF4D0 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x004B0EB0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x00CBF4D0 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x004A7D20 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x00464C70 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x0046D910 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x00431B80 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x00969460 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x004A85E0 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x004B2BB0 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x004AD250 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x004A86C0 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x004A7220 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x004A7260 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x004A71F0 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x00969460 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00969460 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x00E4BDF0 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x004A7250 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x004A7260 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x004A71F0 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x004A7260 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x004A71F0 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x004AB690 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x004A87B0 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x004A89A0 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x00969460 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x0045EDB0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x004BA7C0 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x00403610 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x00403640 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x00403670 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x011BDED0 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x00404330 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x011BDED0 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x00E4BDF0 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x00E4BDF0 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x00969460 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x011BDED0 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x0095BD30 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x009677A0 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x0045EE30 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x00468CC0 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x009FFC60 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x009FFC60 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x00446C70 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x0046F550 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x004AA7D0 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x00E50640 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x004A71D0 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x004AC8F0 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x0042FDA0 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x004B9D70 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x011BDED0 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x00401790 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x004017B0 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x004C0F10 (0x104)
	virtual void VirtualFunction66 ( );																			// 0x004A7580 (0x108)
	virtual void VirtualFunction67 ( );																			// 0x0046C3B0 (0x10C)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x00463C10 (0x110)
};
