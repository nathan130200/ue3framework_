...
{
public:
	unsigned char                                      LinkMode;                                         		// 0x01C8 (0x0001) [0x0000000000000000]              
	unsigned char                                      InLineMode;                                       		// 0x01C9 (0x0001) [0x0000000000000000]              
	unsigned char                                      OutLineMode;                                      		// 0x01CA (0x0001) [0x0000000000000000]              
	unsigned char                                      ReceiveMode;                                      		// 0x01CB (0x0001) [0x0000000000000000]              
	struct FPointer                                    Socket;                                           		// 0x01CC (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                Port;                                             		// 0x01D0 (0x0004) [0x0000000000000002]              ( CPF_Const )
	...
	int                                                DataPending;                                      		// 0x01DC (0x0004) [0x0000000000000002]              ( CPF_Const )
...
public:
	...
	bool StringToIpAddr ( struct FString ToIpAddrStr, struct FIpAddr* Addr );
...
{
public:
	unsigned char                                      LinkState;                                        		// 0x01E0 (0x0001) [0x0000000000000000]              
	struct FIpAddr                                     RemoteAddr;                                       		// 0x01E4 (0x0008) [0x0000000000000000]              
	class UClass*                                      AcceptClass;                                      		// 0x01EC (0x0004) [0x0000000000000000]              
	TArray< unsigned char >                            SendFIFO;                                         		// 0x01F0 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     RecvBuf;                                          		// 0x01FC (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
public:
	...
	int ReadText ( struct FString* ReadTextStr );
	int SendBinary ( int Count, unsigned char* B );
	int SendText ( struct FString SendTextStr );
	bool IsConnected ( );
	bool Close ( );
...
{
public:
	TArray< struct FString >                           NewsData;                                         		// 0x0040 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FNewsCacheEntry >                   NewsItems;                                        		// 0x004C (0x000C) [0x0000000000444000]              ( CPF_Config | CPF_GlobalConfig | CPF_NeedCtorLink )
	TArray< struct FScriptDelegate >                   ReadNewsDelegates;                                		// 0x0058 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bNeedsTicking : 1;                                		// 0x0064 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
	unsigned long                                      bInitialized : 1;                                 		// 0x0064 (0x0004) [0x0000000000000000] [0x00000002] 
	struct FScriptDelegate                             __OnReadNewsCompleted__Delegate;                  		// 0x0068 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	bool AlwaysTreatDownloadsAsUnicode ( );
	struct FString GetOptions ( unsigned long bIsUnicode );
	...
	void ClearNewsItem ( unsigned char NewsType );
	void AddNewsItem ( struct FString NewsUrl, struct FString Filename, unsigned char NewsType, struct FString RefreshDate );
};

UClass* UOnlineNewsInterfaceMcp::pClassPointer = NULL;

// Class IpDrv.OnlineNewsInterfaceRavaged
// 0x0000 (0x0074 - 0x0074)
class UOnlineNewsInterfaceRavaged : public UOnlineNewsInterfaceMcp
{
public:
...
UClass* UOnlineNewsInterfaceRavaged::pClassPointer = NULL;
...
public:
	...
	int                                                MaxLocalTalkers;                                  		// 0x0104 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxRemoteTalkers;                                 		// 0x0108 (0x0004) [0x0000000000004000]              ( CPF_Config )
	unsigned long                                      bIsUsingSpeechRecognition : 1;                    		// 0x010C (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
...
{
public:
	unsigned long                                      AllowPlayerPortUnreach : 1;                       		// 0x0198 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	unsigned long                                      LogPortUnreach : 1;                               		// 0x019C (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	unsigned char                                      UnknownData00[ 0x14 ];                            		// 0x01A0 (0x0014) MISSED OFFSET
...
public:
	...
	struct FString                                     WebRequestUserName;                               		// 0x0054 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32589 ];
...
// 0x014C (0x0354 - 0x0208)
class AWebServer : public ATcpLink
{
public:
	struct FString                                     ServerName;                                       		// 0x0208 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Applications[ 0xA ];                              		// 0x0214 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ApplicationPaths[ 0xA ];                          		// 0x028C (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	unsigned long                                      bEnabled : 1;                                     		// 0x0304 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	int                                                ListenPort;                                       		// 0x0308 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxConnections;                                   		// 0x030C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                DefaultApplication;                               		// 0x0310 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ExpirationSeconds;                                		// 0x0314 (0x0004) [0x0000000000004000]              ( CPF_Config )
	struct FString                                     ServerURL;                                        		// 0x0318 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebApplication*                             ApplicationObjects[ 0xA ];                        		// 0x0324 (0x0028) [0x0000000000000000]              
	int                                                ConnectionCount;                                  		// 0x034C (0x0004) [0x0000000000000000]              
	int                                                ConnID;                                           		// 0x0350 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32592 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32608 ];
...
class UMcpGroupsBase : public UObject
{
public:
	struct FString                                     McpGroupsManagerClassName;                        		// 0x003C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     RequestProtocol;                                  		// 0x0048 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     RequestBaseUrl;                                   		// 0x0054 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     CreateGroupUrl;                                   		// 0x0060 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     DeleteGroupUrl;                                   		// 0x006C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     QueryGroupsUrl;                                   		// 0x0078 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     QueryGroupMembersUrl;                             		// 0x0084 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     AddGroupMembersUrl;                               		// 0x0090 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     RemoveGroupMembersUrl;                            		// 0x009C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     DeleteAllGroupsUrl;                               		// 0x00A8 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     AcceptGroupInviteUrl;                             		// 0x00B4 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     RejectGroupInviteUrl;                             		// 0x00C0 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FMcpGroupList >                     GroupLists;                                       		// 0x00CC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnCreateGroupComplete__Delegate;                		// 0x00D8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnDeleteGroupComplete__Delegate;                		// 0x00E4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnQueryGroupsComplete__Delegate;                		// 0x00F0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnQueryGroupMembersComplete__Delegate;          		// 0x00FC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnAddGroupMembersComplete__Delegate;            		// 0x0108 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnRemoveGroupMembersComplete__Delegate;         		// 0x0114 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnDeleteAllGroupsComplete__Delegate;            		// 0x0120 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnQueryGroupInvitesComplete__Delegate;          		// 0x012C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnAcceptGroupInviteComplete__Delegate;          		// 0x0138 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32678 ];
...
{
public:
	struct FScriptDelegate                             __OnQueryGroupsRequestComplete__Delegate;         		// 0x0144 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnQueryGroupMembersRequestComplete__Delegate;   		// 0x0150 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnAddGroupMembersRequestComplete__Delegate;     		// 0x015C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnAcceptGroupInviteRequestComplete__Delegate;   		// 0x0168 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32797 ];
...
class UMcpIdMappingBase : public UObject
{
public:
	struct FString                                     McpIdMappingClassName;                            		// 0x003C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnAddMappingComplete__Delegate;                 		// 0x0048 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnQueryMappingsComplete__Delegate;              		// 0x0054 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32947 ];
...
{
public:
	TArray< struct FMcpIdMapping >                     AccountMappings;                                  		// 0x0060 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     AddMappingUrl;                                    		// 0x006C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     QueryMappingUrl;                                  		// 0x0078 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Protocol;                                         		// 0x0084 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Domain;                                           		// 0x0090 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32982 ];
...
class UMcpUserManagerBase : public UObject
{
public:
	struct FString                                     McpUserManagerClassName;                          		// 0x003C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnRegisterUserComplete__Delegate;               		// 0x0048 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnQueryUsersComplete__Delegate;                 		// 0x0054 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnDeleteUserComplete__Delegate;                 		// 0x0060 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33046 ];
	...
	void RegisterUser ( struct FString UDID, struct FString McpId );
...
{
public:
	TArray< struct FMcpUserStatus >                    UserStatuses;                                     		// 0x006C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     RegisterUserUrl;                                  		// 0x0078 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     QueryUserUrl;                                     		// 0x0084 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     QueryUsersUrl;                                    		// 0x0090 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     DeleteUserUrl;                                    		// 0x009C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Protocol;                                         		// 0x00A8 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Domain;                                           		// 0x00B4 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FRegisterUserRequest >              RegisterUserRequests;                             		// 0x00C0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UHttpRequestInterface* >             QueryUsersRequests;                               		// 0x00CC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UHttpRequestInterface* >             DeleteUserRequests;                               		// 0x00D8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33088 ];
...
public:
	...
	struct FString                                     ReceivedData;                                     		// 0x020C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	unsigned long                                      bDelayCleanup : 1;                                		// 0x0224 (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                RawBytesExpecting;                                		// 0x0228 (0x0004) [0x0000000000000000]              
	int                                                MaxValueLength;                                   		// 0x022C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxLineLength;                                    		// 0x0230 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ConnID;                                           		// 0x0234 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 36260 ];
