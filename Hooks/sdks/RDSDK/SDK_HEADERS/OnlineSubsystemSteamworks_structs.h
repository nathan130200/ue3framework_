...
// ScriptStruct OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.AuthorizePlayer
// 0x000C
struct FAuthorizePlayer
{
	struct FUniqueNetId                                UnAuthorizePlayerID;                              		// 0x0000 (0x0008) [0x0000000000000000]              
	float                                              UnAuthorizePlayerTime;                            		// 0x0008 (0x0004) [0x0000000000000000]              
};
