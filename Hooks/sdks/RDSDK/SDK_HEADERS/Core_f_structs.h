...
struct UObject_execHasDatePassed_Parms
{
	struct FString                                     Date;                                             		// 0x0000 (0x000C) [0x0000000000400182]              ( CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};

// Function Core.Object.AdminLog
// [0x00022401] ( FUNC_Final | FUNC_Native )
struct UObject_execAdminLog_Parms
{
	struct FString                                     msg;                                              		// 0x0000 (0x000C) [0x0000000000400880]              ( CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink )
};
...
struct UObject_execAdd_LinearColorLinearColor_Parms
{
