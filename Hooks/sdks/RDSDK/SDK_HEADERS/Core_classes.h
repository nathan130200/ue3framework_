...
public:
	...
	bool HasDatePassed ( struct FString* Date );
	void AdminLog ( struct FString msg );
	...
	struct FLinearColor Add_LinearColorLinearColor ( struct FLinearColor A, struct FLinearColor B );
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00C255C0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x0046E420 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x0046C470 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00718600 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x00AD13D0 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x01024720 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x004A87B0 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x004A87F0 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x00445C30 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x004AB880 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x00C255C0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x004A4B10 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x00462F50 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x0046A3C0 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x00431D40 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x01024720 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x004A5560 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x004A40D0 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x004A40E0 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x004A5630 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x004A4370 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x004A4110 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x004A43A0 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x01024720 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x01024720 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00E0CAD0 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x004A4100 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x004A4110 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x004A43A0 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x004A4110 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x004A43A0 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x004A8340 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x004A5720 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x004A5910 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x01024720 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x0045D470 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x004B5DF0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x00403060 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x00403090 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x004030C0 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x004BE460 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x004044C0 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x004BE460 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x00E0CAD0 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x00E0CAD0 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x01024720 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x004BE460 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x00957B60 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x0095E5F0 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x0045D4F0 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x00465B60 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x00AD13D0 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x00AD13D0 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x00445AB0 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x0046C1C0 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x004A7A10 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x00F32B90 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x004A4350 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x004A9EB0 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x0042FC20 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x004B50F0 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x004BE460 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x00401950 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x00401970 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x004BCB10 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x004A4140 (0x104)
	virtual void VirtualFunction66 ( );																			// 0x00468EA0 (0x108)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x0046B700 (0x10C)
};
