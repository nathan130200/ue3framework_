...
// ScriptStruct UDKBase.MobileHUDExt.CachedLastTouch
// 0x000C
struct FCachedLastTouch
{
	unsigned long                                      bTouchEventPending : 1;                           		// 0x0000 (0x0004) [0x0000000000000000] [0x00000001] 
...
struct FVehicleSeat
{
	...
	class UUDKExplosionLight*                          MuzzleFlashLight;                                 		// 0x0110 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	...
	class AUDKVehicleMovementEffect*                   SeatMovementEffect;                               		// 0x0120 (0x0004) [0x0000000000000000]              
