...
// [0x00020002] 
struct UOnlineGameInterfaceSteamworks_execJoinByIP_Parms
{
...
// [0x00020400] ( FUNC_Native )
struct UOnlineGameInterfaceSteamworks_execJoinByIPNative_Parms
{
	struct FString                                     JoinServerIP;                                     		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	int                                                JoinServerPort;                                   		// 0x000C (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
// [0x00020002] 
struct UOnlineGameInterfaceSteamworks_execOnJoinByIPComplete_Parms
{
	...
	// class APlayerController*                        P;                                                		// 0x000C (0x0004) [0x0000000000000000]              
	// class APlayerController*                        LP;                                               		// 0x0010 (0x0004) [0x0000000000000000]              
	// class AWorldInfo*                               WI;                                               		// 0x0014 (0x0004) [0x0000000000000000]              
...
// [0x00020400] ( FUNC_Native )
struct UOnlineSubsystemSteamworks_execIsOffline_Parms
{
	unsigned long                                      ReturnValue : 1;                                  		// 0x0000 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
// [0x00020400] ( FUNC_Native )
struct UOnlineSubsystemSteamworks_execPurchaseContent_Parms
{
	int                                                ContentIDValue;                                   		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0004 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};

// Function OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.HasContent
// [0x00020400] ( FUNC_Native )
struct UOnlineSubsystemSteamworks_execHasContent_Parms
{
	int                                                ContentIDValue;                                   		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0004 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
{
	struct FString                                     OnlineAccountUserName;                            		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
...
// [0x00020400] ( FUNC_Native )
struct UOnlineSubsystemSteamworks_execNotifyPlayerUnAuth_Parms
{
	struct FUniqueNetId                                unAuthPlayerUid;                                  		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
};

// Function OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.NotifyPlayerAuth
// [0x00020400] ( FUNC_Native )
struct UOnlineSubsystemSteamworks_execNotifyPlayerAuth_Parms
{
	struct FUniqueNetId                                authPlayerUid;                                    		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
};
