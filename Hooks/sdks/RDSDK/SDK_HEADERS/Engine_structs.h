...
{
	int                                                ContentIdNum;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
...
// ScriptStruct Engine.AccessControl.Ban
// 0x0054
struct FBan
{
	struct FString                                     Name;                                             		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Uid;                                              		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Reason;                                           		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     BannedBy;                                         		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     StartDate;                                        		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     EndDate;                                          		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     IP;                                               		// 0x0048 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};

// ScriptStruct Engine.AccessControl.WhiteListEntry
// 0x0018
struct FWhiteListEntry
{
	struct FString                                     Name;                                             		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Uid;                                              		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};

// ScriptStruct Engine.AccessControl.BlackListEntry
// 0x0018
struct FBlackListEntry
{
	struct FString                                     AdminName;                                        		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Reason;                                           		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};

// ScriptStruct Engine.AccessControl.UserAccount
// 0x0018
struct FUserAccount
{
...
struct FPendingClientAuth
{
	...
	int                                                AuthRetryCount;                                   		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
struct FMobilePostProcessSettings
{
	...
	float                                              Mobile_DOF_NearBlurFactor;                        		// 0x0030 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Mobile_DOF_FarBlurFactor;                         		// 0x0034 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FPostProcessSettings
{
	...
	struct FMobilePostProcessSettings                  MobilePostProcess;                                		// 0x011C (0x0038) [0x0000000000000001]              ( CPF_Edit )
};
...
// ScriptStruct Engine.PlayerController.UserAudioClassConfig
// 0x0010
struct FUserAudioClassConfig
{
...
// ScriptStruct Engine.Pawn.AttackerInfo
// 0x0008
...
struct FPostProcessSettingsOverride
{
	...
	unsigned long                                      bBlendingIn : 1;                                  		// 0x0154 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bBlendingOut : 1;                                 		// 0x0154 (0x0004) [0x0000000000000000] [0x00000002] 
...
// ScriptStruct Engine.SquadInfo.SquadLeaderBreadCrumb
// 0x0014
struct FSquadLeaderBreadCrumb
{
	struct FVector                                     BreadCrumbLoc;                                    		// 0x0000 (0x000C) [0x0000000000000000]              
	float                                              TimeCreated;                                      		// 0x000C (0x0004) [0x0000000000000000]              
