...
{
	struct FString                                     m_sDisplayPicture;                                		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sDisplayText;                                   		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sListID;                                        		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sRemoteEvent;                                   		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sWwiseSwitch;                                   		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_eDynamicMenuEntry;                              		// 0x003C (0x0004) [0x0000000000000000]              
	unsigned char                                      m_eCustomisationMode;                             		// 0x0040 (0x0001) [0x0000000000000000]              
	unsigned char                                      m_eGender;                                        		// 0x0041 (0x0001) [0x0000000000000000]              
};
...
struct FtUI_S_ItemFilter_Criteria
{
	...
	int                                                m_nModifierType;                                  		// 0x0010 (0x0004) [0x0000000000000000]              
	...
	int                                                m_nUnlockItemModifierType;                        		// 0x0024 (0x0004) [0x0000000000000000]              
...
{
	int                                                nRating;                                          		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                nTitleID;                                         		// 0x0004 (0x0004) [0x0000000000000000]              
	unsigned long                                      bCanWitnessPlayer : 1;                            		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bUnconscious : 1;                                 		// 0x0008 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bArrested : 1;                                    		// 0x0008 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bShowTitles : 1;                                  		// 0x0008 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bIgnored : 1;                                     		// 0x0008 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned char                                      eVoipStatus;                                      		// 0x000C (0x0001) [0x0000000000000000]              
	unsigned char                                      nThreat;                                          		// 0x000D (0x0001) [0x0000000000000000]              
	unsigned char                                      eColourProfile;                                   		// 0x000E (0x0001) [0x0000000000000000]              
};
...
// ScriptStruct APBUserInterface.cUIDataStore_Chat.ProfanityFilterEntry
// 0x000C
struct FProfanityFilterEntry
{
	struct FString                                     m_sProfanityFilterEntry;                          		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FConsoleCommand
{
	...
	struct FString                                     m_sFunctionName;                                  		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sSlashCommand;                                  		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sSyntaxExample;                                 		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_eConsoleCommand;                                		// 0x003C (0x0004) [0x0000000000000000]              
	int                                                m_nMaxArgCount;                                   		// 0x0040 (0x0004) [0x0000000000000000]              
	int                                                m_nMinArgCount;                                   		// 0x0044 (0x0004) [0x0000000000000000]              
	unsigned char                                      m_eCommandType;                                   		// 0x0048 (0x0001) [0x0000000000000000]              
	unsigned char                                      m_eWorksFromState;                                		// 0x0049 (0x0001) [0x0000000000000000]              
	unsigned long                                      m_bEnabled : 1;                                   		// 0x004C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bWorksInEditors : 1;                            		// 0x004C (0x0004) [0x0000000000000000] [0x00000002] 
};
...
struct FEmoteCommand
{
	...
	struct FString                                     m_sSlashCommand;                                  		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_eEmoteCommand;                                  		// 0x0024 (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     m_sDescription;                                   		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sFunctionName;                                  		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sSecondarySlashCommand;                         		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sSlashCommand;                                  		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sSyntaxExample;                                 		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sTag;                                           		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_eFilterColour;                                  		// 0x0048 (0x0004) [0x0000000000000000]              
	unsigned char                                      m_eChatMessageCategory;                           		// 0x004C (0x0001) [0x0000000000000000]              
	unsigned char                                      m_eWorksFromState;                                		// 0x004D (0x0001) [0x0000000000000000]              
	unsigned long                                      m_bDisplayNotification : 1;                       		// 0x0050 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bModePersists : 1;                              		// 0x0050 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      m_bValidCommand : 1;                              		// 0x0050 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      m_bValidFilter : 1;                               		// 0x0050 (0x0004) [0x0000000000000000] [0x00000008] 
};
...
struct FUIMeshViewerSetup
{
	...
	float                                              m_fCameraFOV;                                     		// 0x000C (0x0004) [0x0000000000000000]              
	float                                              m_fCameraPosX;                                    		// 0x0010 (0x0004) [0x0000000000000000]              
	float                                              m_fCameraPosY;                                    		// 0x0014 (0x0004) [0x0000000000000000]              
	float                                              m_fCameraPosZ;                                    		// 0x0018 (0x0004) [0x0000000000000000]              
	float                                              m_fMeshCentreX;                                   		// 0x001C (0x0004) [0x0000000000000000]              
	float                                              m_fMeshCentreY;                                   		// 0x0020 (0x0004) [0x0000000000000000]              
	float                                              m_fMeshCentreZ;                                   		// 0x0024 (0x0004) [0x0000000000000000]              
	...
	float                                              m_fMeshScale;                                     		// 0x0034 (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     m_sBaseURL;                                       		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sParameters;                                    		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sRegionDependantURL_INIKey;                     		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_eAPBSupportPages;                               		// 0x0024 (0x0004) [0x0000000000000000]              
...
struct FGroupListRow
{
	...
	float                                              m_fTextOpacity;                                   		// 0x001C (0x0004) [0x0000000000000000]              
	float                                              m_fBackgroundOpacity;                             		// 0x0020 (0x0004) [0x0000000000000000]              
	int                                                m_nRating;                                        		// 0x0024 (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bGroupLeader : 1;                               		// 0x0028 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bGroupMember : 1;                               		// 0x0028 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      m_bSideLeader : 1;                                		// 0x0028 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      m_bSideMember : 1;                                		// 0x0028 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      m_bValid : 1;                                     		// 0x0028 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned char                                      m_eStatus;                                        		// 0x002C (0x0001) [0x0000000000000000]              
	unsigned char                                      m_eVoipStatus;                                    		// 0x002D (0x0001) [0x0000000000000000]              
	unsigned char                                      m_nThreat;                                        		// 0x002E (0x0001) [0x0000000000000000]              
};
...
{
	int                                                m_eIconColour;                                    		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              m_fBackgroundOpacity;                             		// 0x0004 (0x0004) [0x0000000000000000]              
	float                                              m_fTextBackgroundOpacity;                         		// 0x0008 (0x0004) [0x0000000000000000]              
	unsigned char                                      m_eHUDUsables_DisplaySetting;                     		// 0x000C (0x0001) [0x0000000000000000]              
};
...
struct FtCharacterMeshData
{
	...
	class UMaterial*                                   m_pParentBodyMaterialCompressedNM;                		// 0x000C (0x0004) [0x0000000000100000]              
	class UObject*                                     m_pGolemDescriptor;                               		// 0x0010 (0x0004) [0x0000000000100000]              
};
...
struct FPopupDialog
{
	struct FString                                     m_sPopupBody;                                     		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_eChainedPopup;                                  		// 0x000C (0x0004) [0x0000000000000000]              
	int                                                m_eKnowledgeBaseURL;                              		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                m_eOptionalWaypoint;                              		// 0x0014 (0x0004) [0x0000000000000000]              
	int                                                m_ePopupDialog;                                   		// 0x0018 (0x0004) [0x0000000000000000]              
	int                                                m_ePosition;                                      		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                m_eUIWidgetHightlight_Aggregation;                		// 0x0020 (0x0004) [0x0000000000000000]              
	float                                              m_fDisplayTime;                                   		// 0x0024 (0x0004) [0x0000000000000000]              
	int                                                m_nTimesToShow;                                   		// 0x0028 (0x0004) [0x0000000000000000]              
	unsigned char                                      m_ePopupCategory;                                 		// 0x002C (0x0001) [0x0000000000000000]              
	unsigned long                                      m_bDoNotQueue : 1;                                		// 0x0030 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bFlushQueue : 1;                                		// 0x0030 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      m_bForceKnowledgebase : 1;                        		// 0x0030 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      m_bForChat : 1;                                   		// 0x0030 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      m_bSuppressCriminal : 1;                          		// 0x0030 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      m_bSuppressEnforcer : 1;                          		// 0x0030 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      m_bSuppressMain : 1;                              		// 0x0030 (0x0004) [0x0000000000000000] [0x00000040] 
};
...
{
	int                                                m_eHighlightColour;                               		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned char                                      m_ePopupDialogCategory;                           		// 0x0004 (0x0001) [0x0000000000000000]              
};
...
{
	int                                                m_eDialogShown;                                   		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_ePopupDialogTrigger;                            		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     m_sEventName;                                     		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_ePopupDialogTrigger;                            		// 0x000C (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     m_sWidget1;                                       		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sWidget2;                                       		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sWidget3;                                       		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sWidget4;                                       		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sWidget5;                                       		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_ePopupDialogUIHighlightAggregation;             		// 0x003C (0x0004) [0x0000000000000000]              
};
...
{
	int                                                nCharacterID;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                nMVP;                                             		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                nKills;                                           		// 0x0008 (0x0004) [0x0000000000000000]              
	int                                                nAssists;                                         		// 0x000C (0x0004) [0x0000000000000000]              
	int                                                nDeaths;                                          		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                nTargets;                                         		// 0x0014 (0x0004) [0x0000000000000000]              
	int                                                nArrests;                                         		// 0x0018 (0x0004) [0x0000000000000000]              
	int                                                nArrested;                                        		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                nCash;                                            		// 0x0020 (0x0004) [0x0000000000000000]              
	int                                                nCashAltPremium;                                  		// 0x0024 (0x0004) [0x0000000000000000]              
	int                                                nContactStanding;                                 		// 0x0028 (0x0004) [0x0000000000000000]              
	int                                                nContactStandingAltPremium;                       		// 0x002C (0x0004) [0x0000000000000000]              
	int                                                nMinutes;                                         		// 0x0030 (0x0004) [0x0000000000000000]              
	int                                                nSeconds;                                         		// 0x0034 (0x0004) [0x0000000000000000]              
	int                                                nThreat;                                          		// 0x0038 (0x0004) [0x0000000000000000]              
	int                                                nRating;                                          		// 0x003C (0x0004) [0x0000000000000000]              
	int                                                m_nPrimaryWeaponID;                               		// 0x0040 (0x0004) [0x0000000000000000]              
	int                                                m_aWeaponFnModIDs[ 0x3 ];                         		// 0x0044 (0x000C) [0x0000000000000000]              
	int                                                m_aCharacterFnModIDs[ 0x4 ];                      		// 0x0050 (0x0010) [0x0000000000000000]              
	TArray< int >                                      anMedals;                                         		// 0x0060 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      eFaction;                                         		// 0x006C (0x0001) [0x0000000000000000]              
	unsigned char                                      eContact;                                         		// 0x006D (0x0001) [0x0000000000000000]              
	unsigned long                                      bOurSide : 1;                                     		// 0x0070 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bMVP : 1;                                         		// 0x0070 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bHideContactStanding : 1;                         		// 0x0070 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bPlayerOnline : 1;                                		// 0x0070 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bIsFreeRider : 1;                                 		// 0x0070 (0x0004) [0x0000000000000000] [0x00000010] 
	struct FString                                     sPlayerName;                                      		// 0x0074 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FVideoReplayUIEntry
{
	struct FString                                     m_sDescription;                                   		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sDisplayName;                                   		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sVideoFileName;                                 		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_eVideoReplayUIEntry;                            		// 0x0024 (0x0004) [0x0000000000000000]              
};
...
struct FtMS_Stats_PlayerData
{
	...
	int                                                m_nContactStanding;                               		// 0x003C (0x0004) [0x0000000000000000]              
	int                                                m_nTime;                                          		// 0x0040 (0x0004) [0x0000000000000000]              
	int                                                m_nThreat;                                        		// 0x0044 (0x0004) [0x0000000000000000]              
	int                                                m_MedalsBitfield[ 0x7 ];                          		// 0x0048 (0x001C) [0x0000000000000000]              
};
...
struct FVehicleMenuEntry
{
	struct FString                                     m_sDisplayPicture;                                		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sDisplayText;                                   		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sMenuLevel;                                     		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sMenuTag;                                       		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sOptionalScene;                                 		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_eCameraAngle;                                   		// 0x003C (0x0004) [0x0000000000000000]              
	int                                                m_eVehicleMenuEntry;                              		// 0x0040 (0x0004) [0x0000000000000000]              
...
struct FVehicleUICameraAngle
{
	...
	float                                              m_fActorRotation;                                 		// 0x0004 (0x0004) [0x0000000000000000]              
	float                                              m_fCameraPosition;                                		// 0x0008 (0x0004) [0x0000000000000000]              
...
{
	struct FString                                     m_sDisplayImage;                                  		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sDisplayText;                                   		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sMenuLevel;                                     		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sMenuTag;                                       		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sMouseOverText;                                 		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     m_sOptionalScene;                                 		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_eWardrobeMenuEntry;                             		// 0x0048 (0x0004) [0x0000000000000000]              
};
