...
public:
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x11592ED0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x110F22D0 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x110F6570 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x10DDD2C0 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x111260F0 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x110EEBC0 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x10987C30 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x110DB9A0 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x110F1770 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x110DA700 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x11592ED0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x110DAB90 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x110F16E0 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x110F1BC0 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x110DC350 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x109106B0 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x10987C30 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x116B4740 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x110D9E70 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x1104DC10 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x110D9E80 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x110DA6E0 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x110DA6F0 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x10987C30 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x10987C30 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x110D9F60 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x110DA6E0 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x110DA6F0 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x110DA6E0 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x110DA6F0 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x110D9F70 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x110DA100 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x110DA3F0 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x110F10F0 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x110E0BD0 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x109106D0 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x10910710 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x10910740 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x10C95D30 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x10987C30 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x1122BDA0 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x1122BE10 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x110D8CE0 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x110F14B0 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x111260F0 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x111260F0 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x110EEE10 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x110F6810 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x110E7140 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x112AD070 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x110D8CC0 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x110E6D00 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x110E6DC0 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x10987C30 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x10C95D30 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x10910770 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x10910790 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x110E0220 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x110E02A0 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x110F0E00 (0xEC)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x110C27B0 (0xF0)
};
...
public:
	...
	TArray< struct FString >                           StrippedDataPaths;                                		// 0x00A0 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           ScriptPaths;                                      		// 0x00AC (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           FRScriptPaths;                                    		// 0x00B8 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           UBScriptPaths;                                    		// 0x00C4 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           SBScriptPaths;                                    		// 0x00D0 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           CutdownPaths;                                     		// 0x00DC (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FName >                             Suppress;                                         		// 0x00E8 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           Extensions;                                       		// 0x00F4 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           SeekFreePCExtensions;                             		// 0x0100 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           LocalizationPaths;                                		// 0x010C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     TextureFileCacheExtension;                        		// 0x0118 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
{
public:
	unsigned char                                      UnknownData00[ 0x170 ];                           		// 0x0040 (0x0170) MISSED OFFSET
...
// 0x0074 (0x0224 - 0x01B0)
class ULinkerSave : public ULinker
{
public:
	unsigned char                                      UnknownData00[ 0x74 ];                            		// 0x01B0 (0x0074) MISSED OFFSET
...
// 0x0470 (0x0620 - 0x01B0)
class ULinkerLoad : public ULinker
{
public:
	unsigned char                                      UnknownData00[ 0x470 ];                           		// 0x01B0 (0x0470) MISSED OFFSET
