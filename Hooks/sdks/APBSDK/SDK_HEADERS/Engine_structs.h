...
// ScriptStruct Engine.PostProcessVolume.BloomParameters
// 0x000C
struct FBloomParameters
{
	float                                              BloomScale;                                       		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BloomThreshold;                                   		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BloomBlurKernelSize;                              		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.PostProcessVolume.DOFParameters
// 0x0020
struct FDOFParameters
{
	float                                              ForegroundStartDistance;                          		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ForegroundEndDistance;                            		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BackgroundStartDistance;                          		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BackgroundEndDistance;                            		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxBlurForeground;                                		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxBlurBackground;                                		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BlurKernelSize;                                   		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                CircleOfConfusionDilation;                        		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.PostProcessVolume.MotionBlurParameters
// 0x0014
struct FMotionBlurParameters
{
	float                                              MaxVelocity;                                      		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Amount;                                           		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      FullMotionBlur : 1;                               		// 0x0008 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              CameraRotationThreshold;                          		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CameraTranslationThreshold;                       		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.PostProcessVolume.ToneMappingParameters
// 0x001C
struct FToneMappingParameters
{
	unsigned long                                      bIrisResponse : 1;                                		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              MiddleGrey;                                       		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Lwhite;                                           		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              AdaptionRate;                                     		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              AdaptionSlope;                                    		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinAdaptationIn;                                  		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxAdaptationIn;                                  		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct Engine.PostProcessVolume.ColourAdjustParameters
// 0x002C
struct FColourAdjustParameters
{
	float                                              Brightness;                                       		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Contrast;                                         		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Gamma;                                            		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Saturation;                                       		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     PerChannelPower;                                  		// 0x0010 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FLinearColor                                DesaturatedColour;                                		// 0x001C (0x0010) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FPostProcessSettings
{
	...
	unsigned long                                      Bloom_Override : 1;                               		// 0x0000 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	struct FBloomParameters                            BloomParameters;                                  		// 0x0004 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	float                                              Bloom_InterpolationDuration;                      		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      DOF_Override : 1;                                 		// 0x0014 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FDOFParameters                              DOFParameters;                                    		// 0x0018 (0x0020) [0x0000000000000001]              ( CPF_Edit )
	float                                              DOF_InterpolationDuration;                        		// 0x0038 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      MotionBlur_Override : 1;                          		// 0x003C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FMotionBlurParameters                       MotionBlurParameters;                             		// 0x0040 (0x0014) [0x0000000000000001]              ( CPF_Edit )
	float                                              MotionBlur_InterpolationDuration;                 		// 0x0054 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      ToneMapping_Override : 1;                         		// 0x0058 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FToneMappingParameters                      ToneMappingParameters;                            		// 0x005C (0x001C) [0x0000000000000001]              ( CPF_Edit )
	float                                              ToneMapping_InterpolationDuration;                		// 0x0078 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      ColourAdjust_Override : 1;                        		// 0x007C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FColourAdjustParameters                     ColourAdjustParameters;                           		// 0x0080 (0x002C) [0x0000000000000001]              ( CPF_Edit )
	float                                              ColourAdjust_InterpolationDuration;               		// 0x00AC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UTexture*                                    ColorGrading_LookupTable;                         		// 0x00B0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FLUTBlender                                 ColorGradingLUT;                                  		// 0x00B4 (0x0018) [0x0000000000402002]              ( CPF_Const | CPF_Transient | CPF_NeedCtorLink )
};
...
struct FUIStringNodeModifier
{
	...
	TArray< struct FModifierData >                     ModifierStack;                                    		// 0x0120 (0x000C) [0x0000000000502002]              ( CPF_Const | CPF_Transient | CPF_NeedCtorLink )
...
{
	struct FPostProcessSettings                        LastSettings;                                     		// 0x0000 (0x00CC) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class APostProcessVolume*                          LastVolumeUsed;                                   		// 0x00CC (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x00D0 (0x0004) [0x0000000000000000]              
	float                                              LastBlendTime;                                    		// 0x00D4 (0x0004) [0x0000000000000000]              
};
...
struct FVehicleState
{
	...
	unsigned char                                      ServerThrottle;                                   		// 0x0042 (0x0001) [0x0000000000000000]              
