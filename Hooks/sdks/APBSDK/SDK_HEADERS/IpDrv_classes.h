...
public:
	...
	unsigned char                                      UnknownData00[ 0x88 ];                            		// 0x0A8C (0x0088) MISSED OFFSET
...
// 0x001C (0x4FE8 - 0x4FCC)
class UTcpipConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[ 0x1C ];                            		// 0x4FCC (0x001C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[ 0xC8 ];                            		// 0x01D0 (0x00C8) MISSED OFFSET
