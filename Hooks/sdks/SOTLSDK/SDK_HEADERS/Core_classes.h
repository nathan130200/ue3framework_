...
// Enum Core.Subsystem.EGameSysSaveType
/*enum EGameSysSaveType
{
	GameSysSaveType_Profile                            = 0,
	GameSysSaveType_SaveGames                          = 1,
	GameSysSaveType_MAX                                = 2
};*/
...
public:
	...
	void PoppedState ( );
	void PushedState ( );
	void EndState ( struct FName NextStateName );
	void BeginState ( struct FName PreviousStateName );
	void DumpStateStack ( );
	...
	class UObject* GetObjectFromHandle ( struct FUObjectHandle Obj );
	struct FUObjectHandle GetHandleFromObject ( class UObject* Obj );
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00DCAE80 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x005CCFA0 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x00B1B6C0 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00CECBD0 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x00E32590 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x00449FA0 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x009D9710 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x006A84B0 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x00DDF080 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x0067B7C0 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x00DCAE80 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x00B71980 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x00520040 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x00F8D730 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x008E73D0 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x00C5B730 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x00449FA0 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x0078CBE0 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x007C27F0 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x00E6CEC0 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x00684C60 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x008003A0 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x00E8A960 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x009C68F0 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x00449FA0 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00449FA0 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x00C35C20 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x00E8A960 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x009C68F0 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x00E8A960 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x009C68F0 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x00F608E0 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x00A2F900 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x006F78C0 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x00449FA0 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x00CB84F0 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x00688DD0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x008AD0C0 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x005B2FF0 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x00C5CF70 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x00B7AD10 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x00E28D10 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x005B0800 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x005B0800 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x00449FA0 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x00E28D10 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x00D0CDD0 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x00640060 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x00835C20 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x00867ED0 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x00E32590 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x00E32590 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x00A1BB00 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x00D3EAE0 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x006B80C0 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x00BF5170 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x008E8B60 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x00AA3980 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x00B51F10 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x00449FA0 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x00E28D10 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x00E9A800 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x005614C0 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x006B0F70 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x00D62FF0 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x009C1990 (0x104)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x005AAF20 (0x108)
};
...
public:
	...
	TArray< struct FString >                           MobileScriptPaths;                                		// 0x00B4 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
{
public:
	unsigned char                                      UnknownData00[ 0x50 ];                            		// 0x0044 (0x0050) MISSED OFFSET
...
// Class Core.Class
// 0x00EC (0x01C8 - 0x00DC)
class UClass : public UState
{
public:
	unsigned char                                      UnknownData00[ 0xEC ];                            		// 0x00DC (0x00EC) MISSED OFFSET
