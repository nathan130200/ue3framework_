...
// ScriptStruct OnlineSubsystemSteamworks.OnlineLobbyInterfaceSteamworks.GameInviteInfo
// 0x0014
struct FGameInviteInfo
{
	struct FUniqueNetId                                LobbyUID;                                         		// 0x0000 (0x0008) [0x0000000000000002]              ( CPF_Const )
	struct FUniqueNetId                                FriendID;                                         		// 0x0008 (0x0008) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      bHasAlreadyAccepted : 1;                          		// 0x0010 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
};
