...
// [0x00420400] ( FUNC_Native )
struct UOnlineLobbyInterfaceSteamworks_execGetLobbyServer_Parms
{
	struct FUniqueNetId                                LobbyId;                                          		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	int                                                ServerIP;                                         		// 0x0008 (0x0004) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	int                                                ServerPort;                                       		// 0x000C (0x0004) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	struct FUniqueNetId                                ServerID;                                         		// 0x0010 (0x0008) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0018 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
// [0x00020400] ( FUNC_Native )
struct UOnlineLobbyInterfaceSteamworks_execClearSearchResults_Parms
{
};

// Function OnlineSubsystemSteamworks.OnlineLobbyInterfaceSteamworks.GetNumLobbyMembers
// [0x00020400] ( FUNC_Native )
struct UOnlineLobbyInterfaceSteamworks_execGetNumLobbyMembers_Parms
{
	struct FUniqueNetId                                LobbyId;                                          		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
...
// [0x00020400] ( FUNC_Native )
struct UOnlineLobbyInterfaceSteamworks_execGetLobbyMemberLimit_Parms
{
	struct FUniqueNetId                                LobbyId;                                          		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	int                                                ReturnValue;                                      		// 0x0008 (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
// [0x00020400] ( FUNC_Native )
struct UOnlineLobbyInterfaceSteamworks_execFindFriendLobbies_Parms
{
...
// [0x00020400] ( FUNC_Native )
struct UOnlineSubsystemSteamworks_execDoesRemoteFileExist_Parms
{
...
// [0x00020002] 
struct UOnlineSubsystemSteamworks_execClearDlcInstalledDelegate_Parms
{
	struct FScriptDelegate                             DlcInstalled;                                     		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	// int                                             RemoveIndex;                                      		// 0x000C (0x0004) [0x0000000000000000]              
};

// Function OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.AddDlcInstalledDelegate
// [0x00020002] 
struct UOnlineSubsystemSteamworks_execAddDlcInstalledDelegate_Parms
{
	struct FScriptDelegate                             DlcInstalled;                                     		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
...
// [0x00120000] 
struct UOnlineSubsystemSteamworks_execOnDlcInstalled_Parms
{
	int                                                AppID;                                            		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
