...
struct UUDKMobileInputZone_execProcessGameplayInput_Parms
{
	...
	unsigned long                                      ReturnValue : 1;                                  		// 0x0018 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	// struct FVector2D                                RelLocation;                                      		// 0x001C (0x0008) [0x0000000000000000]              
	// struct FVector2D                                ViewportSize;                                     		// 0x0024 (0x0008) [0x0000000000000000]              
	// class AActor*                                   TraceHitActor;                                    		// 0x002C (0x0004) [0x0000000000000000]              
	// int                                             PressIndex;                                       		// 0x0030 (0x0004) [0x0000000000000000]              
	// unsigned long                                   bRedundantInput : 1;                              		// 0x0034 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UUDKMobileInputZone_execTraceFromScreenToWorld_Parms
{
	...
	class AActor*                                      outHitActor;                                      		// 0x0008 (0x0004) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	struct FVector                                     OutHitLocation;                                   		// 0x000C (0x000C) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	struct FVector                                     Extent;                                           		// 0x0018 (0x000C) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
	// class AActor*                                   HitActor;                                         		// 0x0024 (0x0004) [0x0000000000000000]              
	// class AActor*                                   TestHitActor;                                     		// 0x0028 (0x0004) [0x0000000000000000]              
	// struct FVector                                  CameraLoc;                                        		// 0x002C (0x000C) [0x0000000000000000]              
	// struct FVector                                  CameraDir;                                        		// 0x0038 (0x000C) [0x0000000000000000]              
	// struct FVector                                  HitLocation;                                      		// 0x0044 (0x000C) [0x0000000000000000]              
	// struct FVector                                  TestHitLocation;                                  		// 0x0050 (0x000C) [0x0000000000000000]              
