...
public:
	...
	unsigned long                                      bFakeMobileTouches : 1;                           		// 0x007C (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	...
	unsigned long                                      bDisableWorldRendering : 1;                       		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bCloseOnLevelChange : 1;                          		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bOnlyOwnerFocusable : 1;                          		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bForceFullViewport : 1;                           		// 0x00C8 (0x0004) [0x0000000000000000] [0x00001000] 
	unsigned long                                      bDiscardNonOwnerInput : 1;                        		// 0x00C8 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bCaptureInput : 1;                                		// 0x00C8 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bCaptureMouseInput : 1;                           		// 0x00C8 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bIgnoreMouseInput : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00010000] 
	unsigned long                                      bIsSplitscreenLayoutModified : 1;                 		// 0x00C8 (0x0004) [0x0000000000002000] [0x00020000] ( CPF_Transient )
	unsigned long                                      bShowHardwareMouseCursor : 1;                     		// 0x00C8 (0x0004) [0x0000000000000000] [0x00040000] 
	unsigned long                                      bBlurLesserMovies : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00080000] 
	unsigned long                                      bHideLesserMovies : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00100000] 
	unsigned long                                      bIsPriorityBlurred : 1;                           		// 0x00C8 (0x0004) [0x0000000000000000] [0x00200000] 
	unsigned long                                      bIsPriorityHidden : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00400000] 
	unsigned long                                      bIgnoreVisibilityEffect : 1;                      		// 0x00C8 (0x0004) [0x0000000000000000] [0x00800000] 
	unsigned long                                      bIgnoreBlurEffect : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x01000000] 
	...
	int                                                SplitscreenLayoutYAdjust;                         		// 0x0158 (0x0004) [0x0000000000004000]              ( CPF_Config )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32564 ];
