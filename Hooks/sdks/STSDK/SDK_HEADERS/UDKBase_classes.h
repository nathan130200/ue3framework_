...
{
public:
	float                                              FOV;                                              		// 0x0604 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	unsigned long                                      bForceLoadTextures : 1;                           		// 0x0608 (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              ClearStreamingTime;                               		// 0x060C (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42318 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42319 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42335 ];
...
public:
	...
	class USoundCue*                                   GDCHack;                                          		// 0x06A0 (0x0004) [0x0000000000000000]              
	float                                              StuckThreshHold;                                  		// 0x06A4 (0x0004) [0x0000000000000000]              
	float                                              TapToMoveAutoPitchAmount;                         		// 0x06A8 (0x0004) [0x0000000000000000]              
	class UStaticMesh*                                 TapToMoveVisualMesh;                              		// 0x06AC (0x0004) [0x0000000000000000]              
	float                                              TapToMoveVisualMinDist;                           		// 0x06B0 (0x0004) [0x0000000000000000]              
	float                                              TapToMoveVisualRotateSpeed;                       		// 0x06B4 (0x0004) [0x0000000000000000]              
	float                                              TapToMoveVisualAnimDuration;                      		// 0x06B8 (0x0004) [0x0000000000000000]              
	struct FVector                                     TapToMoveDestination;                             		// 0x06BC (0x000C) [0x0000000000000000]              
	float                                              LastDistToDestination;                            		// 0x06C8 (0x0004) [0x0000000000000000]              
	float                                              TapToMoveVisualEffectStartTime;                   		// 0x06CC (0x0004) [0x0000000000000000]              
	float                                              TapToMoveVisualEffectEndTime;                     		// 0x06D0 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   TapToMoveSound;                                   		// 0x06D4 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   InvalidTapToMoveSound;                            		// 0x06D8 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   TapToMoveStopSound;                               		// 0x06DC (0x0004) [0x0000000000000000]              
	class AKActorSpawnable*                            TapToMoveVisualActor;                             		// 0x06E0 (0x0004) [0x0000000000000000]              
	unsigned char                                      TutorialStage;                                    		// 0x06E4 (0x0001) [0x0000000000000000]              
	class UMobileInputZone*                            TutorialLookZone;                                 		// 0x06E8 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42336 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42475 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42484 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42487 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42576 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42608 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42611 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42643 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42904 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42924 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43172 ];
...
{
public:
	float                                              HoldPlayerDistance;                               		// 0x0208 (0x0004) [0x0000000000000002]              ( CPF_Const )
	TArray< struct FActivePress >                      CurrentPresses;                                   		// 0x020C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FVector                                     TraceHitLocation;                                 		// 0x0218 (0x000C) [0x0000000000002000]              ( CPF_Transient )
	class AActor*                                      LastTappedActor;                                  		// 0x0224 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              TimeOfLastUntouch;                                		// 0x0228 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              PlayerTouchStartTime;                             		// 0x022C (0x0004) [0x0000000000002000]              ( CPF_Transient )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43547 ];
