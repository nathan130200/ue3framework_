...
struct FEventData
{
	...
	class UGFxObject*                                  Renderer;                                         		// 0x0008 (0x0004) [0x0000000000000000]              
	class UGFxObject*                                  Item;                                             		// 0x000C (0x0004) [0x0000000000000000]              
	struct FString                                     Type;                                             		// 0x0010 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                Data;                                             		// 0x001C (0x0004) [0x0000000000000000]              
	int                                                mouseIndex;                                       		// 0x0020 (0x0004) [0x0000000000000000]              
	int                                                Button;                                           		// 0x0024 (0x0004) [0x0000000000000000]              
	int                                                Index;                                            		// 0x0028 (0x0004) [0x0000000000000000]              
	int                                                lastIndex;                                        		// 0x002C (0x0004) [0x0000000000000000]              
};
