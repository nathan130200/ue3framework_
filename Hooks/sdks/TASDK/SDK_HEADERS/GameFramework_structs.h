...
struct FWeaponEvents
{
	...
	TArray< struct FGameEvents >                       EventsByWeaponClass;                              		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FGameEvents                                 TotalEvents;                                      		// 0x0000 (0x003C) [0x0000000000000000]              
	TArray< struct FGameEvents >                       EventsByDamageClass;                              		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FGameEvents                                 TotalEvents;                                      		// 0x0000 (0x003C) [0x0000000000000000]              
	TArray< struct FGameEvents >                       EventsByProjectileClass;                          		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FGameEvents                                 TotalEvents;                                      		// 0x0000 (0x003C) [0x0000000000000000]              
	TArray< struct FGameEvents >                       EventsByPawnClass;                                		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FTouchData
{
	...
	struct FVector2D                                   Location;                                         		// 0x0004 (0x0008) [0x0000000000000000]              
	float                                              TotalMoveDistance;                                		// 0x000C (0x0004) [0x0000000000000000]              
	struct FDouble                                     InitialDeviceTime;                                		// 0x0010 (0x0008) [0x0000000000000000]              
	float                                              TouchDuration;                                    		// 0x0018 (0x0004) [0x0000000000000000]              
	struct FDouble                                     MoveEventDeviceTime;                              		// 0x001C (0x0008) [0x0000000000000000]              
	float                                              MoveDeltaTime;                                    		// 0x0024 (0x0004) [0x0000000000000000]              
	unsigned long                                      bInUse : 1;                                       		// 0x0028 (0x0004) [0x0000000000000000] [0x00000001] 
	class UMobileInputZone*                            Zone;                                             		// 0x002C (0x0004) [0x0000000000000000]              
	unsigned char                                      State;                                            		// 0x0030 (0x0001) [0x0000000000000000]              
	TArray< struct FTouchDataEvent >                   Events;                                           		// 0x0034 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              LastActiveTime;                                   		// 0x0040 (0x0004) [0x0000000000000000]              
};
