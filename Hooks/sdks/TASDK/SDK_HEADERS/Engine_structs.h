...
struct FOnlineContent
{
	...
	int                                                DeviceID;                                         		// 0x0004 (0x0004) [0x0000000000000000]              
	struct FString                                     FriendlyName;                                     		// 0x0008 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Filename;                                         		// 0x0014 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     ContentPath;                                      		// 0x0020 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           ContentPackages;                                  		// 0x002C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           ContentFiles;                                     		// 0x0038 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FPostProcessSettings
{
	...
	unsigned long                                      bOverride_DOF_ModulateBlurColor : 1;              		// 0x0000 (0x0004) [0x0000000000000000] [0x00020000] 
	unsigned long                                      bOverride_DOF_FocusType : 1;                      		// 0x0000 (0x0004) [0x0000000000000000] [0x00040000] 
	unsigned long                                      bOverride_DOF_FocusInnerRadius : 1;               		// 0x0000 (0x0004) [0x0000000000000000] [0x00080000] 
	unsigned long                                      bOverride_DOF_FocusDistance : 1;                  		// 0x0000 (0x0004) [0x0000000000000000] [0x00100000] 
	unsigned long                                      bOverride_DOF_FocusPosition : 1;                  		// 0x0000 (0x0004) [0x0000000000000000] [0x00200000] 
	unsigned long                                      bOverride_DOF_InterpolationDuration : 1;          		// 0x0000 (0x0004) [0x0000000000000000] [0x00400000] 
	...
	unsigned long                                      bEnableMotionBlur : 1;                            		// 0x0004 (0x0004) [0x0000000000000001] [0x00000400] ( CPF_Edit )
	unsigned long                                      bEnableSceneEffect : 1;                           		// 0x0004 (0x0004) [0x0000000000000001] [0x00000800] ( CPF_Edit )
	unsigned long                                      bAllowAmbientOcclusion : 1;                       		// 0x0004 (0x0004) [0x0000000000000001] [0x00001000] ( CPF_Edit )
	unsigned long                                      bOverrideRimShaderColor : 1;                      		// 0x0004 (0x0004) [0x0000000000000001] [0x00002000] ( CPF_Edit )
	...
	struct FLUTBlender                                 ColorGradingLUT;                                  		// 0x00C4 (0x0018) [0x0000000000402002]              ( CPF_Const | CPF_Transient | CPF_NeedCtorLink )
};
...
{
	class UClass*                                      CommandClass;                                     		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              UtilityRating;                                    		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	struct FName                                       ActiveRootName;                                   		// 0x0000 (0x0008) [0x0000000000000002]              ( CPF_Const )
	class UAICommandNodeRoot*                          ActiveRoot;                                       		// 0x0008 (0x0004) [0x0000000000000000]              
	TArray< class UAICommandNodeBase* >                DisabledNodes;                                    		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FAITreeUtilityInfo >                LastUtilityRatingList;                            		// 0x0018 (0x000C) [0x0000000000402001]              ( CPF_Edit | CPF_Transient | CPF_NeedCtorLink )
	TArray< struct FAITreeUtilityInfo >                LastUtilityRatingListAtChange;                    		// 0x0024 (0x000C) [0x0000000000402001]              ( CPF_Edit | CPF_Transient | CPF_NeedCtorLink )
};
...
// ScriptStruct Engine.Pawn.LastHitInfoStruct
// 0x0014
struct FLastHitInfoStruct
{
	unsigned long                                      bDirectHit : 1;                                   		// 0x0000 (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              Amount;                                           		// 0x0004 (0x0004) [0x0000000000000000]              
	float                                              Distance;                                         		// 0x0008 (0x0004) [0x0000000000000000]              
	class AActor*                                      Causer;                                           		// 0x000C (0x0004) [0x0000000000000000]              
	class UClass*                                      Type;                                             		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
struct FStaticMeshComponentLODInfo
{
	...
	TArray< struct FVector >                           VertexColorPositions;                             		// 0x0020 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
};
...
// ScriptStruct Engine.Console.scrollbackData
// 0x0010
struct FscrollbackData
{
	struct FString                                     Text;                                             		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FColor                                      OverrideColor;                                    		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FCoverSlot
{
	...
	unsigned long                                      bSelected : 1;                                    		// 0x0070 (0x0004) [0x0000000000002000] [0x00100000] ( CPF_Transient )
	unsigned long                                      bFailedToFindSurface : 1;                         		// 0x0070 (0x0004) [0x0000000000022001] [0x00200000] ( CPF_Edit | CPF_Transient | CPF_EditConst )
};
...
struct FLightmassWorldInfoSettings
{
	...
	unsigned long                                      bEnableImageReflectionShadowing : 1;              		// 0x0020 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
...
struct FLandscapeLayerInfo
{
	...
	class UMaterialInstanceConstant*                   ThumbnailMIC;                                     		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct Engine.LandscapeComponent.LandscapeComponentAlphaInfo
// 0x0010
struct FLandscapeComponentAlphaInfo
{
	int                                                LayerIndex;                                       		// 0x0000 (0x0004) [0x0000000000000000]              
	TArray< unsigned char >                            AlphaValues;                                      		// 0x0004 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
};
...
{
	struct FPostProcessSettings                        Settings;                                         		// 0x0000 (0x00DC) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bBlendingIn : 1;                                  		// 0x00DC (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bBlendingOut : 1;                                 		// 0x00DC (0x0004) [0x0000000000000000] [0x00000002] 
	float                                              CurrentBlendInTime;                               		// 0x00E0 (0x0004) [0x0000000000000000]              
	float                                              CurrentBlendOutTime;                              		// 0x00E4 (0x0004) [0x0000000000000000]              
	float                                              BlendInDuration;                                  		// 0x00E8 (0x0004) [0x0000000000000000]              
	float                                              BlendOutDuration;                                 		// 0x00EC (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x00F0 (0x0004) [0x0000000000000000]              
};
...
{
	struct FPostProcessSettings                        LastSettings;                                     		// 0x0000 (0x00DC) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class APostProcessVolume*                          LastVolumeUsed;                                   		// 0x00DC (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x00E0 (0x0004) [0x0000000000000000]              
	float                                              LastBlendTime;                                    		// 0x00E4 (0x0004) [0x0000000000000000]              
};
...
struct FSoundClassProperties
{
	...
	unsigned long                                      bBassBoost : 1;                                   		// 0x001C (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
};
