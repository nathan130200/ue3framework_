...
// 0x0031 (0x02E5 - 0x02B4)
class AUDKGameObjective : public ANavigationPoint
{
public:
	TArray< class ANavigationPoint* >                  ShootSpots;                                       		// 0x02B4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bAllowOnlyShootable : 1;                          		// 0x02C0 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bUnderAttack : 1;                                 		// 0x02C0 (0x0004) [0x0000000000000020] [0x00000002] ( CPF_Net )
	struct FVector                                     HUDLocation;                                      		// 0x02C4 (0x000C) [0x0000000000000000]              
	class UTexture2D*                                  IconHudTexture;                                   		// 0x02D0 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FTextureCoordinates                         IconCoords;                                       		// 0x02D4 (0x0010) [0x0000000000000000]              
	unsigned char                                      DefenderTeamIndex;                                		// 0x02E4 (0x0001) [0x0000000000000020]              ( CPF_Net )
...
// 0x01D4 (0x0650 - 0x047C)
class AUDKPawn : public AGamePawn
{
public:
	unsigned long                                      bReadyToDoubleJump : 1;                           		// 0x047C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bRequiresDoubleJump : 1;                          		// 0x047C (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bCanDoubleJump : 1;                               		// 0x047C (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bNoJumpAdjust : 1;                                		// 0x047C (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bIsHoverboardAnimPawn : 1;                        		// 0x047C (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bFeigningDeath : 1;                               		// 0x047C (0x0004) [0x0000000000000020] [0x00000020] ( CPF_Net )
	unsigned long                                      bNotifyStopFalling : 1;                           		// 0x047C (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bIsInvisible : 1;                                 		// 0x047C (0x0004) [0x0000000000000020] [0x00000080] ( CPF_Net )
	unsigned long                                      bSmoothNetUpdates : 1;                            		// 0x047C (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bPuttingDownWeapon : 1;                           		// 0x047C (0x0004) [0x0000000000000020] [0x00000200] ( CPF_Net )
	unsigned long                                      bPlayingFeignDeathRecovery : 1;                   		// 0x047C (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bCanPlayFallingImpacts : 1;                       		// 0x047C (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bEnableFootPlacement : 1;                         		// 0x047C (0x0004) [0x0000000000000000] [0x00001000] 
	unsigned long                                      bPostRenderOtherTeam : 1;                         		// 0x047C (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bBlendOutTakeHitPhysics : 1;                      		// 0x047C (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bUpdateEyeheight : 1;                             		// 0x047C (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bTearOffGibs : 1;                                 		// 0x047C (0x0004) [0x0000000000000020] [0x00010000] ( CPF_Net )
	float                                              MaxDoubleJumpHeight;                              		// 0x0480 (0x0004) [0x0000000000000000]              
	int                                                MultiJumpRemaining;                               		// 0x0484 (0x0004) [0x0000000000000000]              
	int                                                MaxMultiJump;                                     		// 0x0488 (0x0004) [0x0000000000000000]              
	int                                                MultiJumpBoost;                                   		// 0x048C (0x0004) [0x0000000000000000]              
	float                                              CustomGravityScaling;                             		// 0x0490 (0x0004) [0x0000000000000020]              ( CPF_Net )
	struct FPlayEmoteInfo                              EmoteRepInfo;                                     		// 0x0494 (0x0010) [0x0000000000000020]              ( CPF_Net )
	float                                              LastEmoteTime;                                    		// 0x04A4 (0x0004) [0x0000000000000000]              
	float                                              MinTimeBetweenEmotes;                             		// 0x04A8 (0x0004) [0x0000000000000000]              
	unsigned char                                      BigTeleportCount;                                 		// 0x04AC (0x0001) [0x0000000000000020]              ( CPF_Net )
	unsigned char                                      WeaponOverlayFlags;                               		// 0x04AD (0x0001) [0x0000000000000020]              ( CPF_Net )
	struct FUTTakeHitInfo                              LastTakeHitInfo;                                  		// 0x04B0 (0x002C) [0x0000000000000020]              ( CPF_Net )
	float                                              LastTakeHitTimeout;                               		// 0x04DC (0x0004) [0x0000000000000000]              
	float                                              FireRateMultiplier;                               		// 0x04E0 (0x0004) [0x0000000000000020]              ( CPF_Net )
	float                                              HeadScale;                                        		// 0x04E4 (0x0004) [0x0000000000000020]              ( CPF_Net )
	float                                              MaxSmoothNetUpdateDist;                           		// 0x04E8 (0x0004) [0x0000000000000000]              
	float                                              NoSmoothNetUpdateDist;                            		// 0x04EC (0x0004) [0x0000000000000000]              
	float                                              SmoothNetUpdateTime;                              		// 0x04F0 (0x0004) [0x0000000000000000]              
	struct FVector                                     MeshTranslationOffset;                            		// 0x04F4 (0x000C) [0x0000000000000000]              
	float                                              OldZ;                                             		// 0x0500 (0x0004) [0x0000000000000000]              
	class UAudioComponent*                             PawnAmbientSound;                                 		// 0x0504 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class USoundCue*                                   PawnAmbientSoundCue;                              		// 0x0508 (0x0004) [0x0000000000000020]              ( CPF_Net )
	struct FDrivenWeaponPawnInfo                       DrivenWeaponPawn;                                 		// 0x050C (0x000C) [0x0000000000000020]              ( CPF_Net )
	class UAudioComponent*                             WeaponAmbientSound;                               		// 0x0518 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class USoundCue*                                   WeaponAmbientSoundCue;                            		// 0x051C (0x0004) [0x0000000000000020]              ( CPF_Net )
	class UMaterial*                                   ReplicatedBodyMaterial;                           		// 0x0520 (0x0004) [0x0000000000000020]              ( CPF_Net )
	TArray< class UMaterialInstanceConstant* >         BodyMaterialInstances;                            		// 0x0524 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UMaterialInterface*                          OverlayMaterialInstance;                          		// 0x0530 (0x0004) [0x0000000000000020]              ( CPF_Net )
	class USkelControlSingleBone*                      RootRotControl;                                   		// 0x0534 (0x0004) [0x0000000000000000]              
	class UAnimNodeAimOffset*                          AimNode;                                          		// 0x0538 (0x0004) [0x0000000000000000]              
	class UGameSkelCtrl_Recoil*                        GunRecoilNode;                                    		// 0x053C (0x0004) [0x0000000000000000]              
	class UGameSkelCtrl_Recoil*                        LeftRecoilNode;                                   		// 0x0540 (0x0004) [0x0000000000000000]              
	class UGameSkelCtrl_Recoil*                        RightRecoilNode;                                  		// 0x0544 (0x0004) [0x0000000000000000]              
	TArray< class AUDKBot* >                           Trackers;                                         		// 0x0548 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              BodyMatFadeDuration;                              		// 0x0554 (0x0004) [0x0000000000000000]              
	struct FLinearColor                                CurrentBodyMatColor;                              		// 0x0558 (0x0010) [0x0000000000000000]              
	float                                              RemainingBodyMatDuration;                         		// 0x0568 (0x0004) [0x0000000000000000]              
	float                                              ClientBodyMatDuration;                            		// 0x056C (0x0004) [0x0000000000000020]              ( CPF_Net )
	struct FLinearColor                                BodyMatColor;                                     		// 0x0570 (0x0010) [0x0000000000000000]              
	struct FRotator                                    CompressedBodyMatColor;                           		// 0x0580 (0x000C) [0x0000000000000020]              ( CPF_Net )
	float                                              StartFallImpactTime;                              		// 0x058C (0x0004) [0x0000000000000000]              
	struct FName                                       TorsoBoneName;                                    		// 0x0590 (0x0008) [0x0000000000000000]              
	class USoundCue*                                   FallImpactSound;                                  		// 0x0598 (0x0004) [0x0000000000000000]              
	float                                              FallSpeedThreshold;                               		// 0x059C (0x0004) [0x0000000000000000]              
	class UStaticMeshComponent*                        BlobShadow;                                       		// 0x05A0 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class USkeletalMeshComponent*                      OverlayMesh;                                      		// 0x05A4 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FName                                       LeftFootBone;                                     		// 0x05A8 (0x0008) [0x0000000000000000]              
	struct FName                                       RightFootBone;                                    		// 0x05B0 (0x0008) [0x0000000000000000]              
	struct FName                                       LeftFootControlName;                              		// 0x05B8 (0x0008) [0x0000000000000000]              
	struct FName                                       RightFootControlName;                             		// 0x05C0 (0x0008) [0x0000000000000000]              
	float                                              BaseTranslationOffset;                            		// 0x05C8 (0x0004) [0x0000000000000000]              
	float                                              CrouchTranslationOffset;                          		// 0x05CC (0x0004) [0x0000000000000000]              
	float                                              OldLocationZ;                                     		// 0x05D0 (0x0004) [0x0000000000000000]              
	float                                              ZSmoothingRate;                                   		// 0x05D4 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              MaxFootPlacementDistSquared;                      		// 0x05D8 (0x0004) [0x0000000000000000]              
	class USkelControlFootPlacement*                   LeftLegControl;                                   		// 0x05DC (0x0004) [0x0000000000000000]              
	class USkelControlFootPlacement*                   RightLegControl;                                  		// 0x05E0 (0x0004) [0x0000000000000000]              
	class USkelControlLimb*                            LeftHandIK;                                       		// 0x05E4 (0x0004) [0x0000000000000000]              
	class USkelControlLimb*                            RightHandIK;                                      		// 0x05E8 (0x0004) [0x0000000000000000]              
	struct FName                                       DamageParameterName;                              		// 0x05EC (0x0008) [0x0000000000000000]              
	struct FName                                       SaturationParameterName;                          		// 0x05F4 (0x0008) [0x0000000000000000]              
	float                                              LastPostRenderTraceTime;                          		// 0x05FC (0x0004) [0x0000000000000000]              
	float                                              TeamBeaconMaxDist;                                		// 0x0600 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              StartedFallingTime;                               		// 0x0604 (0x0004) [0x0000000000000000]              
	float                                              SlopeBoostFriction;                               		// 0x0608 (0x0004) [0x0000000000000000]              
	class UAnimNodeAimOffset*                          FlyingDirOffset;                                  		// 0x060C (0x0004) [0x0000000000000000]              
	int                                                MaxLeanRoll;                                      		// 0x0610 (0x0004) [0x0000000000000000]              
	float                                              FeignDeathPhysicsBlendOutSpeed;                   		// 0x0614 (0x0004) [0x0000000000000000]              
	float                                              SwimmingZOffset;                                  		// 0x0618 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SwimmingZOffsetSpeed;                             		// 0x061C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CrouchMeshZOffset;                                		// 0x0620 (0x0004) [0x0000000000000000]              
	float                                              TakeHitPhysicsBlendOutSpeed;                      		// 0x0624 (0x0004) [0x0000000000000000]              
	class UUDKSkeletalMeshComponent*                   ArmsMesh[ 0x2 ];                                  		// 0x0628 (0x0008) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	int                                                RootYaw;                                          		// 0x0630 (0x0004) [0x0000000000000000]              
	float                                              RootYawSpeed;                                     		// 0x0634 (0x0004) [0x0000000000000000]              
	int                                                MaxYawAim;                                        		// 0x0638 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector2D                                   CurrentSkelAim;                                   		// 0x063C (0x0008) [0x0000000000000000]              
	struct FVector                                     HUDLocation;                                      		// 0x0644 (0x000C) [0x0000000000000000]              
...
// 0x00C8 (0x0464 - 0x039C)
class AUDKBot : public AAIController
{
public:
	class AUDKSquadAI*                                 Squad;                                            		// 0x039C (0x0004) [0x0000000000000000]              
	class UUDKAIDecisionComponent*                     DecisionComponent;                                		// 0x03A0 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class AActor*                                      TemporaryFocus;                                   		// 0x03A4 (0x0004) [0x0000000000000000]              
	unsigned long                                      bExecutingWhatToDoNext : 1;                       		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bScriptSpecialJumpCost : 1;                       		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bForceRefreshRoute : 1;                           		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bTargetAlternateLoc : 1;                          		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bEnemyInfoValid : 1;                              		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bEnemyIsVisible : 1;                              		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bLeadTarget : 1;                                  		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bJumpOverWall : 1;                                		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bPlannedJump : 1;                                 		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bInDodgeMove : 1;                                 		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bEnemyAcquired : 1;                               		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bNeedDelayedLeaveVehicle : 1;                     		// 0x03A8 (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bAllowRouteReuse : 1;                             		// 0x03A8 (0x0004) [0x0000000000000000] [0x00001000] 
	unsigned long                                      bUsingSquadRoute : 1;                             		// 0x03A8 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bUsePreviousSquadRoute : 1;                       		// 0x03A8 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned char                                      ScriptedFireMode;                                 		// 0x03AC (0x0001) [0x0000000000000000]              
	float                                              EnemyVisibilityTime;                              		// 0x03B0 (0x0004) [0x0000000000000000]              
	class APawn*                                       VisibleEnemy;                                     		// 0x03B4 (0x0004) [0x0000000000000000]              
	class AVehicle*                                    LastBlockingVehicle;                              		// 0x03B8 (0x0004) [0x0000000000000000]              
	class APawn*                                       CurrentlyTrackedEnemy;                            		// 0x03BC (0x0004) [0x0000000000000000]              
	TArray< struct FEnemyPosition >                    SavedPositions;                                   		// 0x03C0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FVector                                     ImpactVelocity;                                   		// 0x03CC (0x000C) [0x0000000000000000]              
	int                                                AcquisitionYawRate;                               		// 0x03D8 (0x0004) [0x0000000000000000]              
	float                                              HearingThreshold;                                 		// 0x03DC (0x0004) [0x0000000000000000]              
	float                                              RespawnPredictionTime;                            		// 0x03E0 (0x0004) [0x0000000000000000]              
	float                                              WarningDelay;                                     		// 0x03E4 (0x0004) [0x0000000000000000]              
	class AProjectile*                                 WarningProjectile;                                		// 0x03E8 (0x0004) [0x0000000000000000]              
	struct FVector                                     MonitorStartLoc;                                  		// 0x03EC (0x000C) [0x0000000000000000]              
	class APawn*                                       MonitoredPawn;                                    		// 0x03F8 (0x0004) [0x0000000000000000]              
	float                                              MonitorMaxDistSq;                                 		// 0x03FC (0x0004) [0x0000000000000000]              
	struct FVector                                     LastSeenPos;                                      		// 0x0400 (0x000C) [0x0000000000000000]              
	struct FVector                                     LastSeeingPos;                                    		// 0x040C (0x000C) [0x0000000000000000]              
	float                                              LastSeenTime;                                     		// 0x0418 (0x0004) [0x0000000000000000]              
	float                                              TrackingReactionTime;                             		// 0x041C (0x0004) [0x0000000000000000]              
	float                                              BaseTrackingReactionTime;                         		// 0x0420 (0x0004) [0x0000000000000000]              
	struct FVector                                     TrackedVelocity;                                  		// 0x0424 (0x000C) [0x0000000000000000]              
	class ANavigationPoint*                            SquadRouteGoal;                                   		// 0x0430 (0x0004) [0x0000000000000000]              
	class APawn*                                       BlockedAimTarget;                                 		// 0x0434 (0x0004) [0x0000000000000000]              
	float                                              LastIterativeCheck;                               		// 0x0438 (0x0004) [0x0000000000000000]              
	float                                              AimUpdateFrequency;                               		// 0x043C (0x0004) [0x0000000000000000]              
	float                                              LastAimUpdateTime;                                		// 0x0440 (0x0004) [0x0000000000000000]              
	float                                              ErrorUpdateFrequency;                             		// 0x0444 (0x0004) [0x0000000000000000]              
	float                                              LastErrorUpdateTime;                              		// 0x0448 (0x0004) [0x0000000000000000]              
	float                                              CurrentAimError;                                  		// 0x044C (0x0004) [0x0000000000000000]              
	float                                              DodgeLandZ;                                       		// 0x0450 (0x0004) [0x0000000000000000]              
	class AActor*                                      FearSpots[ 0x2 ];                                 		// 0x0454 (0x0008) [0x0000000000000000]              
	float                                              DodgeToGoalPct;                                   		// 0x045C (0x0004) [0x0000000000000000]              
	float                                              MultiJumpZ;                                       		// 0x0460 (0x0004) [0x0000000000000000]              
...
{
public:
	class ATeamInfo*                                   Team;                                             		// 0x01DC (0x0004) [0x0000000000000020]              ( CPF_Net )
	class ANavigationPoint*                            LastAnchor;                                       		// 0x01E0 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              LastValidAnchorTime;                              		// 0x01E4 (0x0004) [0x0000000000000000]              
	class USkeletalMeshComponent*                      SkelMesh;                                         		// 0x01E8 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	unsigned long                                      bHome : 1;                                        		// 0x01EC (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	class AUDKGameObjective*                           HomeBase;                                         		// 0x01F0 (0x0004) [0x0000000000000020]              ( CPF_Net )
	struct FVector                                     HomeBaseOffset;                                   		// 0x01F4 (0x000C) [0x0000000000000000]              
	class AActor*                                      OldBase;                                          		// 0x0200 (0x0004) [0x0000000000000000]              
	class AActor*                                      OldBaseBase;                                      		// 0x0204 (0x0004) [0x0000000000000000]              
	struct FVector                                     HUDLocation;                                      		// 0x0208 (0x000C) [0x0000000000000000]              
...
{
public:
	float                                              DistFromCamera;                                   		// 0x01E8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AUDKPlayerController*                        Cam;                                              		// 0x01EC (0x0004) [0x0000000000000000]              
...
{
public:
	TArray< struct FAttachedExplosionLight >           RelativeExplosionLights;                          		// 0x0234 (0x000C) [0x0000000000480000]              ( CPF_Component | CPF_NeedCtorLink )
...
{
public:
	class UClass*                                      TypeToForce;                                      		// 0x0248 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bIgnoreHoverboards : 1;                           		// 0x024C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bDenyExit : 1;                                    		// 0x024C (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bBlockPawns : 1;                                  		// 0x024C (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bBlockSpectators : 1;                             		// 0x024C (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	class UArrowComponent*                             Arrow;                                            		// 0x0250 (0x0004) [0x000000000408000B]              ( CPF_Edit | CPF_Const | CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FVector                                     ArrowDirection;                                   		// 0x0254 (0x000C) [0x0000000000000000]              
	TArray< class AUDKVehicle* >                       TouchingVehicles;                                 		// 0x0260 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
// 0x0044 (0x0594 - 0x0550)
class AUDKHUD : public AMobileHUD
{
public:
	class UFont*                                       GlowFonts[ 0x2 ];                                 		// 0x0550 (0x0008) [0x0000000000000000]              
	float                                              PulseDuration;                                    		// 0x0558 (0x0004) [0x0000000000000000]              
	float                                              PulseSplit;                                       		// 0x055C (0x0004) [0x0000000000000000]              
	float                                              PulseMultiplier;                                  		// 0x0560 (0x0004) [0x0000000000000000]              
	struct FFontRenderInfo                             TextRenderInfo;                                   		// 0x0564 (0x0028) [0x0000000000000000]              
	class UFont*                                       ConsoleIconFont;                                  		// 0x058C (0x0004) [0x0000000000000000]              
	class UFont*                                       BindTextFont;                                     		// 0x0590 (0x0004) [0x0000000000000000]              
...
{
public:
	struct FVector                                     JumpVelocity;                                     		// 0x02B4 (0x000C) [0x0000000000000000]              
	class APathNode*                                   JumpTarget;                                       		// 0x02C0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class USoundCue*                                   JumpSound;                                        		// 0x02C4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              JumpTime;                                         		// 0x02C8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              JumpAirControl;                                   		// 0x02CC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UAudioComponent*                             JumpAmbientSound;                                 		// 0x02D0 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
...
{
public:
	unsigned long                                      bHasHealth : 1;                                   		// 0x02C8 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bDamageOnEncroachment : 1;                        		// 0x02C8 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bResetDOEWhenAsleep : 1;                          		// 0x02C8 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bTakeDamageOnEncroachment : 1;                    		// 0x02C8 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bBreakWhenCausingDamage : 1;                      		// 0x02C8 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bBroken : 1;                                      		// 0x02C8 (0x0004) [0x0000000000000000] [0x00000020] 
	int                                                Health;                                           		// 0x02CC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                EncroachDamage_Other;                             		// 0x02D0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                EncroachDamage_Self;                              		// 0x02D4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UClass*                                      DmgTypeClass;                                     		// 0x02D8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                DOEResetThreshold;                                		// 0x02DC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UParticleSystem*                             BrokenTemplate;                                   		// 0x02E0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AController*                                 InstigatorController;                             		// 0x02E4 (0x0004) [0x0000000000000000]              
	struct FScriptDelegate                             __OnBreakApart__Delegate;                         		// 0x02E8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnEncroach__Delegate;                           		// 0x02F4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	unsigned long                                      bIsRespawning : 1;                                		// 0x02D0 (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	unsigned long                                      bPulseBase : 1;                                   		// 0x02D0 (0x0004) [0x0000000000000020] [0x00000002] ( CPF_Net )
	unsigned long                                      bIsDisabled : 1;                                  		// 0x02D0 (0x0004) [0x0000000000000020] [0x00000004] ( CPF_Net )
	unsigned long                                      bFloatingPickup : 1;                              		// 0x02D0 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bRandomStart : 1;                                 		// 0x02D0 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bRotatingPickup : 1;                              		// 0x02D0 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bUpdatingPickup : 1;                              		// 0x02D0 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bDoVisibilityFadeIn : 1;                          		// 0x02D0 (0x0004) [0x0000000000000000] [0x00000080] 
	class UStaticMeshComponent*                        BaseMesh;                                         		// 0x02D4 (0x0004) [0x0000000004082008]              ( CPF_ExportObject | CPF_Transient | CPF_Component | CPF_EditInline )
	class UMaterialInstanceConstant*                   BaseMaterialInstance;                             		// 0x02D8 (0x0004) [0x0000000000000000]              
	struct FLinearColor                                BaseBrightEmissive;                               		// 0x02DC (0x0010) [0x0000000000000000]              
	struct FLinearColor                                BaseDimEmissive;                                  		// 0x02EC (0x0010) [0x0000000000000000]              
	float                                              BasePulseRate;                                    		// 0x02FC (0x0004) [0x0000000000000000]              
	float                                              BasePulseTime;                                    		// 0x0300 (0x0004) [0x0000000000000000]              
	float                                              PulseThreshold;                                   		// 0x0304 (0x0004) [0x0000000000000000]              
	struct FLinearColor                                BaseTargetEmissive;                               		// 0x0308 (0x0010) [0x0000000000000000]              
	struct FLinearColor                                BaseEmissive;                                     		// 0x0318 (0x0010) [0x0000000000000000]              
	struct FName                                       BaseMaterialParamName;                            		// 0x0328 (0x0008) [0x0000000000000000]              
	float                                              BobTimer;                                         		// 0x0330 (0x0004) [0x0000000000000000]              
	float                                              BobOffset;                                        		// 0x0334 (0x0004) [0x0000000000000000]              
	float                                              BobSpeed;                                         		// 0x0338 (0x0004) [0x0000000000000000]              
	float                                              BobBaseOffset;                                    		// 0x033C (0x0004) [0x0000000000000000]              
	float                                              YawRotationRate;                                  		// 0x0340 (0x0004) [0x0000000000000000]              
	struct FVector                                     PivotTranslation;                                 		// 0x0344 (0x000C) [0x0000000000000000]              
	struct FName                                       VisibilityParamName;                              		// 0x0350 (0x0008) [0x0000000000000000]              
	class UMaterialInstanceConstant*                   MIC_Visibility;                                   		// 0x0358 (0x0004) [0x0000000000000000]              
	class UMaterialInstanceConstant*                   MIC_VisibilitySecondMaterial;                     		// 0x035C (0x0004) [0x0000000000000000]              
	class UParticleSystemComponent*                    Glow;                                             		// 0x0360 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FName                                       GlowEmissiveParam;                                		// 0x0364 (0x0008) [0x0000000000000000]              
	class UPrimitiveComponent*                         Spinner;                                          		// 0x036C (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UUDKParticleSystemComponent*                 SpinningParticleEffects;                          		// 0x0370 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
...
public:
	...
	unsigned long                                      bDedicatedServerSpectator : 1;                    		// 0x05C0 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bAcuteHearing : 1;                                		// 0x05C0 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bConsolePlayer : 1;                               		// 0x05C0 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bPulseTeamColor : 1;                              		// 0x05C0 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bUsePhysicsRotation : 1;                          		// 0x05C0 (0x0004) [0x0000000000000000] [0x00000010] 
	struct FVector                                     ShakeOffset;                                      		// 0x05C4 (0x000C) [0x0000000000000000]              
	struct FRotator                                    ShakeRot;                                         		// 0x05D0 (0x000C) [0x0000000000000000]              
	struct FPostProcessSettings                        CamOverridePostProcess;                           		// 0x05DC (0x00DC) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FPostProcessSettings                        PostProcessModifier;                              		// 0x06B8 (0x00DC) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class AActor* >                            PotentiallyHiddenActors;                          		// 0x0794 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              VehicleCheckRadiusScaling;                        		// 0x07A0 (0x0004) [0x0000000000000000]              
	float                                              PulseTimer;                                       		// 0x07A4 (0x0004) [0x0000000000000000]              
...
{
public:
	unsigned long                                      bWideCheck : 1;                                   		// 0x0218 (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	unsigned long                                      bShuttingDown : 1;                                		// 0x0218 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bCheckProjectileLight : 1;                        		// 0x0218 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bNotBlockedByShield : 1;                          		// 0x0218 (0x0004) [0x0000000000000000] [0x00000008] 
	float                                              CheckRadius;                                      		// 0x021C (0x0004) [0x0000000000000000]              
	float                                              AccelRate;                                        		// 0x0220 (0x0004) [0x0000000000000000]              
	class AActor*                                      SeekTarget;                                       		// 0x0224 (0x0004) [0x0000000000000020]              ( CPF_Net )
	float                                              BaseTrackingStrength;                             		// 0x0228 (0x0004) [0x0000000000000000]              
	float                                              HomingTrackingStrength;                           		// 0x022C (0x0004) [0x0000000000000000]              
	struct FVector                                     InitialDir;                                       		// 0x0230 (0x000C) [0x0000000000000020]              ( CPF_Net )
	float                                              LastLockWarningTime;                              		// 0x023C (0x0004) [0x0000000000000000]              
	float                                              LockWarningInterval;                              		// 0x0240 (0x0004) [0x0000000000000000]              
	float                                              TerminalVelocity;                                 		// 0x0244 (0x0004) [0x0000000000000000]              
	float                                              Buoyancy;                                         		// 0x0248 (0x0004) [0x0000000000000000]              
	float                                              CustomGravityScaling;                             		// 0x024C (0x0004) [0x0000000000000000]              
	class AVehicle*                                    InstigatorBaseVehicle;                            		// 0x0250 (0x0004) [0x0000000000000020]              ( CPF_Net )
...
// 0x0014 (0x0518 - 0x0504)
class AUDKScout : public AScout
{
public:
	unsigned long                                      bRequiresDoubleJump : 1;                          		// 0x0504 (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              MaxDoubleJumpHeight;                              		// 0x0508 (0x0004) [0x0000000000000000]              
	class UClass*                                      PrototypePawnClass;                               		// 0x050C (0x0004) [0x0000000000000000]              
	struct FName                                       SizePersonFindName;                               		// 0x0510 (0x0008) [0x0000000000000000]              
...
{
public:
	unsigned long                                      bScriptSpecifyEndAnchor : 1;                      		// 0x02B4 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bScriptNotifyAnchorFindingResult : 1;             		// 0x02B4 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bAnchorMustBeReachable : 1;                       		// 0x02B4 (0x0004) [0x0000000000000000] [0x00000004] 
...
{
public:
	class ATeamInfo*                                   Team;                                             		// 0x01DC (0x0004) [0x0000000000000000]              
...
{
public:
	class AUDKGameObjective*                           SquadObjective;                                   		// 0x01E0 (0x0004) [0x0000000000000020]              ( CPF_Net )
	class ANavigationPoint*                            RouteObjective;                                   		// 0x01E4 (0x0004) [0x0000000000000000]              
	TArray< class ANavigationPoint* >                  ObjectiveRouteCache;                              		// 0x01E8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class ANavigationPoint* >                  PreviousObjectiveRouteCache;                      		// 0x01F4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class AUDKBot*                                     PendingSquadRouteMaker;                           		// 0x0200 (0x0004) [0x0000000000000000]              
	int                                                SquadRouteIteration;                              		// 0x0204 (0x0004) [0x0000000000000000]              
	TArray< struct FAlternateRoute >                   SquadRoutes;                                      		// 0x0208 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                MaxSquadRoutes;                                   		// 0x0214 (0x0004) [0x0000000000000000]              
...
{
public:
	unsigned char                                      TeamNumber;                                       		// 0x02BC (0x0001) [0x0000000000000001]              ( CPF_Edit )
	TArray< class UTexture2D* >                        TeamSprites;                                      		// 0x02C0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	class USceneCaptureComponent*                      PortalCaptureComponent;                           		// 0x02DC (0x0004) [0x00000000040A0009]              ( CPF_Edit | CPF_ExportObject | CPF_EditConst | CPF_Component | CPF_EditInline )
	class UTextureRenderTarget2D*                      TextureTarget;                                    		// 0x02E0 (0x0004) [0x0000000000000000]              
	int                                                TextureResolutionX;                               		// 0x02E4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                TextureResolutionY;                               		// 0x02E8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AActor*                                      PortalViewTarget;                                 		// 0x02EC (0x0004) [0x0000000000000000]              
	class UMaterialInterface*                          PortalMaterial;                                   		// 0x02F0 (0x0004) [0x0000000000000000]              
	class UMaterialInstanceConstant*                   PortalMaterialInstance;                           		// 0x02F4 (0x0004) [0x0000000000000000]              
	struct FName                                       PortalTextureParameter;                           		// 0x02F8 (0x0008) [0x0000000000000000]              
	class USoundCue*                                   TeleportingSound;                                 		// 0x0300 (0x0004) [0x0000000000000000]              
...
{
public:
	unsigned long                                      bShouldEject : 1;                                 		// 0x0608 (0x0004) [0x0000000000000000] [0x00000001] 
...
// 0x01AC (0x07B8 - 0x060C)
class AUDKVehicle : public AUDKVehicleBase
{
public:
	unsigned long                                      bEjectKilledBodies : 1;                           		// 0x060C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bHomingTarget : 1;                                		// 0x060C (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bFrontalCollision : 1;                            		// 0x060C (0x0004) [0x0000000000000002] [0x00000004] ( CPF_Const )
	unsigned long                                      bFrontalCollisionWithFixed : 1;                   		// 0x060C (0x0004) [0x0000000000000002] [0x00000008] ( CPF_Const )
	unsigned long                                      bNoZDampingInAir : 1;                             		// 0x060C (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bNoZDamping : 1;                                  		// 0x060C (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bIsDisabled : 1;                                  		// 0x060C (0x0004) [0x0000000000000020] [0x00000040] ( CPF_Net )
	unsigned long                                      bIsBurning : 1;                                   		// 0x060C (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bEjectPassengersWhenFlipped : 1;                  		// 0x060C (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bIsScraping : 1;                                  		// 0x060C (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bTakeWaterDamageWhileDriving : 1;                 		// 0x060C (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bIsInDestroyablePenetration : 1;                  		// 0x060C (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bDeadVehicle : 1;                                 		// 0x060C (0x0004) [0x0000000000000020] [0x00001000] ( CPF_Net )
	unsigned long                                      bJostleWhileDriving : 1;                          		// 0x060C (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bFloatWhenDriven : 1;                             		// 0x060C (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bAllowedExit : 1;                                 		// 0x060C (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bUseAlternatePaths : 1;                           		// 0x060C (0x0004) [0x0000000000000000] [0x00010000] 
	unsigned long                                      bShowLocked : 1;                                  		// 0x060C (0x0004) [0x0000000000000000] [0x00020000] 
	unsigned long                                      bTeamLocked : 1;                                  		// 0x060C (0x0004) [0x0000000000000020] [0x00040000] ( CPF_Net )
	unsigned long                                      bDisableRepulsorsAtMaxFallSpeed : 1;              		// 0x060C (0x0004) [0x0000000000000000] [0x00080000] 
	unsigned long                                      bTrickJumping : 1;                                		// 0x060C (0x0004) [0x0000000000000020] [0x00100000] ( CPF_Net )
	unsigned long                                      bGrab1 : 1;                                       		// 0x060C (0x0004) [0x0000000000000020] [0x00200000] ( CPF_Net )
	unsigned long                                      bGrab2 : 1;                                       		// 0x060C (0x0004) [0x0000000000000020] [0x00400000] ( CPF_Net )
	unsigned long                                      bForceSpinWarmup : 1;                             		// 0x060C (0x0004) [0x0000000000000020] [0x00800000] ( CPF_Net )
	float                                              RemainingBurn;                                    		// 0x0610 (0x0004) [0x0000000000000000]              
	TArray< struct FBurnOutDatum >                     BurnOutMaterialInstances;                         		// 0x0614 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UAudioComponent*                             TireAudioComp;                                    		// 0x0620 (0x0004) [0x00000000040A000B]              ( CPF_Edit | CPF_Const | CPF_ExportObject | CPF_EditConst | CPF_Component | CPF_EditInline )
	TArray< struct FMaterialSoundEffect >              TireSoundList;                                    		// 0x0624 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FName                                       CurrentTireMaterial;                              		// 0x0630 (0x0008) [0x0000000000000000]              
	float                                              MaxWheelEffectDistSq;                             		// 0x0638 (0x0004) [0x0000000000000000]              
	TArray< struct FMaterialParticleEffect >           WheelParticleEffects;                             		// 0x063C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              LastCheckUpsideDownTime;                          		// 0x0648 (0x0004) [0x0000000000000000]              
	float                                              FlippedCount;                                     		// 0x064C (0x0004) [0x0000000000000000]              
	class UAudioComponent*                             ScrapeSound;                                      		// 0x0650 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	float                                              FireDamageThreshold;                              		// 0x0654 (0x0004) [0x0000000000000000]              
	float                                              FireDamagePerSec;                                 		// 0x0658 (0x0004) [0x0000000000000000]              
	float                                              AccruedFireDamage;                                		// 0x065C (0x0004) [0x0000000000000000]              
	float                                              UpsideDownDamagePerSec;                           		// 0x0660 (0x0004) [0x0000000000000000]              
	float                                              OccupiedUpsideDownDamagePerSec;                   		// 0x0664 (0x0004) [0x0000000000000000]              
	float                                              WaterDamage;                                      		// 0x0668 (0x0004) [0x0000000000000000]              
	float                                              AccumulatedWaterDamage;                           		// 0x066C (0x0004) [0x0000000000000000]              
	TArray< int >                                      GroundEffectIndices;                              		// 0x0670 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              MaxGroundEffectDist;                              		// 0x067C (0x0004) [0x0000000000000000]              
	struct FName                                       GroundEffectDistParameterName;                    		// 0x0680 (0x0008) [0x0000000000000000]              
	class UParticleSystem*                             WaterGroundEffect;                                		// 0x0688 (0x0004) [0x0000000000000000]              
	struct FRotator                                    WeaponRotation;                                   		// 0x068C (0x000C) [0x0000000000000020]              ( CPF_Net )
	TArray< struct FVehicleSeat >                      Seats;                                            		// 0x0698 (0x000C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	int                                                SeatMask;                                         		// 0x06A4 (0x0004) [0x0000000000000020]              ( CPF_Net )
	TArray< struct FVehicleAnim >                      VehicleAnims;                                     		// 0x06A8 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FVehicleSound >                     VehicleSounds;                                    		// 0x06B4 (0x000C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	struct FName                                       DrivingAnim;                                      		// 0x06C0 (0x0008) [0x0000000000000000]              
	float                                              DestroyOnPenetrationThreshold;                    		// 0x06C8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DestroyOnPenetrationDuration;                     		// 0x06CC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TimeInDestroyablePenetration;                     		// 0x06D0 (0x0004) [0x0000000000000000]              
	float                                              LastDeathImpactTime;                              		// 0x06D4 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   LargeChunkImpactSound;                            		// 0x06D8 (0x0004) [0x0000000000000000]              
	class USoundCue*                                   MediumChunkImpactSound;                           		// 0x06DC (0x0004) [0x0000000000000000]              
	class USoundCue*                                   SmallChunkImpactSound;                            		// 0x06E0 (0x0004) [0x0000000000000000]              
	float                                              CustomGravityScaling;                             		// 0x06E4 (0x0004) [0x0000000000000021]              ( CPF_Edit | CPF_Net )
	TArray< struct FDamageParamScales >                DamageParamScaleLevels;                           		// 0x06E8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class UUDKSkelControl_Damage* >            DamageSkelControls;                               		// 0x06F4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FFDamageMorphTargets >              DamageMorphTargets;                               		// 0x0700 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UMaterialInstanceConstant*                   DamageMaterialInstance[ 0x2 ];                    		// 0x070C (0x0008) [0x0000000000000000]              
	struct FUTTakeHitInfo                              LastTakeHitInfo;                                  		// 0x0714 (0x002C) [0x0000000000000020]              ( CPF_Net )
	float                                              LastTakeHitTimeout;                               		// 0x0740 (0x0004) [0x0000000000000000]              
	TArray< struct FVehicleEffect >                    VehicleEffects;                                   		// 0x0744 (0x000C) [0x0000000000480001]              ( CPF_Edit | CPF_Component | CPF_NeedCtorLink )
	class AController*                                 KillerController;                                 		// 0x0750 (0x0004) [0x0000000000000020]              ( CPF_Net )
	float                                              LastJumpOutCheck;                                 		// 0x0754 (0x0004) [0x0000000000000000]              
	struct FName                                       WaterEffectType;                                  		// 0x0758 (0x0008) [0x0000000000000000]              
	TArray< int >                                      ContrailEffectIndices;                            		// 0x0760 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       ContrailColorParameterName;                       		// 0x076C (0x0008) [0x0000000000000000]              
	float                                              ObjectiveGetOutDist;                              		// 0x0774 (0x0004) [0x0000000000000000]              
	TArray< class AUDKBot* >                           Trackers;                                         		// 0x0778 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      Team;                                             		// 0x0784 (0x0001) [0x0000000000000020]              ( CPF_Net )
	float                                              ExtraReachDownThreshold;                          		// 0x0788 (0x0004) [0x0000000000000000]              
	float                                              ResetTime;                                        		// 0x078C (0x0004) [0x0000000000000000]              
	float                                              MinRunOverSpeed;                                  		// 0x0790 (0x0004) [0x0000000000000000]              
	float                                              LastRunOverWarningTime;                           		// 0x0794 (0x0004) [0x0000000000000000]              
	float                                              MinRunOverWarningAim;                             		// 0x0798 (0x0004) [0x0000000000000000]              
	float                                              TeamBeaconMaxDist;                                		// 0x079C (0x0004) [0x0000000000000000]              
	float                                              LastPostRenderTraceTime;                          		// 0x07A0 (0x0004) [0x0000000000000000]              
	float                                              ShowLockedMaxDist;                                		// 0x07A4 (0x0004) [0x0000000000000000]              
	struct FVector                                     HUDLocation;                                      		// 0x07A8 (0x000C) [0x0000000000000000]              
	class UParticleSystemComponent*                    HoverboardDust;                                   		// 0x07B4 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
...
// 0x000C (0x0618 - 0x060C)
class AUDKWeaponPawn : public AUDKVehicleBase
{
public:
	class AUDKVehicle*                                 MyVehicle;                                        		// 0x060C (0x0004) [0x0000000000000020]              ( CPF_Net )
	class AUDKWeapon*                                  MyVehicleWeapon;                                  		// 0x0610 (0x0004) [0x0000000000000020]              ( CPF_Net )
	int                                                MySeatIndex;                                      		// 0x0614 (0x0004) [0x0000000000000020]              ( CPF_Net )
...
{
public:
	struct FString                                     VehicleClassPath;                                 		// 0x02B4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bHasLockedVehicle : 1;                            		// 0x02C0 (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	unsigned long                                      bReplicateChildVehicle : 1;                       		// 0x02C0 (0x0004) [0x0000000000000000] [0x00000002] 
	class UClass*                                      VehicleClass;                                     		// 0x02C4 (0x0004) [0x0000000000000000]              
	class AUDKVehicle*                                 ChildVehicle;                                     		// 0x02C8 (0x0004) [0x0000000000000020]              ( CPF_Net )
	float                                              RespawnProgress;                                  		// 0x02CC (0x0004) [0x0000000000000000]              
	struct FVector                                     HUDLocation;                                      		// 0x02D0 (0x000C) [0x0000000000000000]              
	int                                                TeamNum;                                          		// 0x02DC (0x0004) [0x0000000000000000]              
...
{
public:
	class UStaticMeshComponent*                        AirEffect;                                        		// 0x01DC (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	float                                              MinVelocityForAirEffect;                          		// 0x01E0 (0x0004) [0x0000000000000000]              
	float                                              MaxVelocityForAirEffect;                          		// 0x01E4 (0x0004) [0x0000000000000000]              
	struct FName                                       AirEffectScalar;                                  		// 0x01E8 (0x0008) [0x0000000000000000]              
	float                                              AirMaxDelta;                                      		// 0x01F0 (0x0004) [0x0000000000000000]              
	float                                              AirCurrentLevel;                                  		// 0x01F4 (0x0004) [0x0000000000000000]              
...
{
public:
	class UMeshComponent*                              OverlayMesh;                                      		// 0x02CC (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	unsigned long                                      bLeadTarget : 1;                                  		// 0x02D0 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bConsiderProjectileAcceleration : 1;              		// 0x02D0 (0x0004) [0x0000000000000000] [0x00000002] 
	int                                                AmmoCount;                                        		// 0x02D4 (0x0004) [0x0000000000000020]              ( CPF_Net )
	unsigned char                                      HitEnemy;                                         		// 0x02D8 (0x0001) [0x0000000000000020]              ( CPF_Net )
	float                                              AimTraceRange;                                    		// 0x02DC (0x0004) [0x0000000000000000]              
	TArray< class AActor* >                            AimingTraceIgnoredActors;                         		// 0x02E0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	unsigned long                                      bIgnoreFlaggedProjectiles : 1;                    		// 0x01DC (0x0004) [0x0000000000000000] [0x00000001] 
