...
struct FPlaylist
{
	...
	unsigned long                                      bIsArbitrated : 1;                                		// 0x0050 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bDisableDedicatedServerSearches : 1;              		// 0x0050 (0x0004) [0x0000000000000000] [0x00000002] 
	TArray< struct FName >                             MapCycle;                                         		// 0x0054 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FInventorySwap >                    InventorySwaps;                                   		// 0x0060 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
