...
public:
	...
	struct FScriptDelegate                             __OnGameInviteAccepted__Delegate;                 		// 0x01E4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnRegisterPlayerComplete__Delegate;             		// 0x01F0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnUnregisterPlayerComplete__Delegate;           		// 0x01FC (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
