...
public:
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00C4D430 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x00464690 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x00462B70 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00CFA0D0 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x00568650 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x00C10330 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x00499720 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x00499780 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x0043F690 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x0049B6A0 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x00C4D430 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x00495970 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x00459CC0 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x00461150 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x004950D0 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x0042E150 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x00C10330 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x004962F0 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x00494E60 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x00499460 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x004963C0 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x00495030 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x00494E80 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x00495060 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x00C10330 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00C10330 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x00494E70 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x00494E80 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x00495060 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x00494E80 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x00495060 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x00497930 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x004964B0 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x00496660 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x00C10330 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x00454E20 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x004A2900 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x004063E0 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x00406410 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x00406440 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x004072E0 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x00590C20 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x00CE2300 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x00CE2300 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x00C10330 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x00590C20 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x008DD440 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x008E8530 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x00454EA0 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x0045D3B0 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x00568650 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x00568650 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x0043F580 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x00462A20 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x00497260 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x006F4B40 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x00495010 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x0042C5B0 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x004A22C0 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x00590C20 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x00403EE0 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x00403F00 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x004A3F60 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x00494E90 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x0045FEA0 (0x100)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x00458F50 (0x104)
};
...
public:
	...
	unsigned char										UnknownData001;		                              		// NOT AUTO-GENERATED PROPERTY 
