...
{
public:
	unsigned char                                      LinkMode;                                         		// 0x01DC (0x0001) [0x0000000000000000]              
	unsigned char                                      InLineMode;                                       		// 0x01DD (0x0001) [0x0000000000000000]              
	unsigned char                                      OutLineMode;                                      		// 0x01DE (0x0001) [0x0000000000000000]              
	unsigned char                                      ReceiveMode;                                      		// 0x01DF (0x0001) [0x0000000000000000]              
	struct FPointer                                    Socket;                                           		// 0x01E0 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                Port;                                             		// 0x01E4 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    RemoteSocket;                                     		// 0x01E8 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    PrivateResolveInfo;                               		// 0x01EC (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                DataPending;                                      		// 0x01F0 (0x0004) [0x0000000000000002]              ( CPF_Const )
...
{
public:
	unsigned char                                      LinkState;                                        		// 0x01F4 (0x0001) [0x0000000000000000]              
	struct FIpAddr                                     RemoteAddr;                                       		// 0x01F8 (0x0008) [0x0000000000000000]              
	class UClass*                                      AcceptClass;                                      		// 0x0200 (0x0004) [0x0000000000000000]              
	TArray< unsigned char >                            SendFIFO;                                         		// 0x0204 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     RecvBuf;                                          		// 0x0210 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32794 ];
...
// 0x014C (0x0368 - 0x021C)
class AWebServer : public ATcpLink
{
public:
	struct FString                                     ServerName;                                       		// 0x021C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Applications[ 0xA ];                              		// 0x0228 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ApplicationPaths[ 0xA ];                          		// 0x02A0 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	unsigned long                                      bEnabled : 1;                                     		// 0x0318 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	int                                                ListenPort;                                       		// 0x031C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxConnections;                                   		// 0x0320 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                DefaultApplication;                               		// 0x0324 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ExpirationSeconds;                                		// 0x0328 (0x0004) [0x0000000000004000]              ( CPF_Config )
	struct FString                                     ServerURL;                                        		// 0x032C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebApplication*                             ApplicationObjects[ 0xA ];                        		// 0x0338 (0x0028) [0x0000000000000000]              
	int                                                ConnectionCount;                                  		// 0x0360 (0x0004) [0x0000000000000000]              
	int                                                ConnID;                                           		// 0x0364 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32813 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 32832 ];
...
{
public:
	class AWebServer*                                  WebServer;                                        		// 0x021C (0x0004) [0x0000000000000000]              
	struct FString                                     ReceivedData;                                     		// 0x0220 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebRequest*                                 Request;                                          		// 0x022C (0x0004) [0x0000000000000000]              
	class UWebResponse*                                Response;                                         		// 0x0230 (0x0004) [0x0000000000000000]              
	class UWebApplication*                             Application;                                      		// 0x0234 (0x0004) [0x0000000000000000]              
	unsigned long                                      bDelayCleanup : 1;                                		// 0x0238 (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                RawBytesExpecting;                                		// 0x023C (0x0004) [0x0000000000000000]              
	int                                                MaxValueLength;                                   		// 0x0240 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxLineLength;                                    		// 0x0244 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ConnID;                                           		// 0x0248 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33811 ];
