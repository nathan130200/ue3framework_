...
struct FServerInfo
{
	...
	struct FString                                     ServerName;                                       		// 0x0020 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ServerDesc;                                       		// 0x002C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     MapName;                                          		// 0x0038 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     Ruleset;                                          		// 0x0044 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
