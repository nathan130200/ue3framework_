...
// ScriptStruct Core.ScriptStackObject.SSOCallerInfo
// 0x0008
struct FSSOCallerInfo
{
	int                                                TheControllerID;                                  		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      bServer : 1;                                      		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
