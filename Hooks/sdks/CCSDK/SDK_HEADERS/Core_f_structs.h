...
struct UObject_execPointInBox_Parms
{
	...
	struct FVector                                     Location;                                         		// 0x000C (0x000C) [0x0000000000000080]              ( CPF_Parm )
	struct FVector                                     Extent;                                           		// 0x0018 (0x000C) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0024 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	// struct FVector                                  MinBox;                                           		// 0x0028 (0x000C) [0x0000000000000000]              
	// struct FVector                                  MaxBox;                                           		// 0x0034 (0x000C) [0x0000000000000000]              
};
...
struct UObject_execGetMappedRangeValue_Parms
{
	...
	// float                                           ClampedPct;                                       		// 0x0018 (0x0004) [0x0000000000000000]              
};
...
struct UObject_execQuatSlerp_Parms
{
	...
	struct FQuat                                       ReturnValue;                                      		// 0x0028 (0x0010) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct UObject_execQuatFromRotator_Parms
{
	...
	struct FQuat                                       ReturnValue;                                      		// 0x000C (0x0010) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct UObject_execQuatFindBetween_Parms
{
	...
	struct FQuat                                       ReturnValue;                                      		// 0x0018 (0x0010) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct UScriptStackObject_execGetStackStartInfo_Parms
{
	struct FSSOCallerInfo                              CallerInfo;                                       		// 0x0000 (0x0008) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	int                                                RpcID;                                            		// 0x0008 (0x0004) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};

// Function Core.ScriptStackObject.GetStackStartInfoForRPC
// [0x00422400] ( FUNC_Native )
struct UScriptStackObject_execGetStackStartInfoForRPC_Parms
{
	int                                                OutcomingRPCId;                                   		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FSSOCallerInfo                              CallerInfo;                                       		// 0x0004 (0x0008) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	int                                                RpcID;                                            		// 0x000C (0x0004) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0010 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};

// Function Core.ScriptStackObject.GetFullScriptTraceString
// [0x00422400] ( FUNC_Native )
struct UScriptStackObject_execGetFullScriptTraceString_Parms
{
	struct FString                                     StackString;                                      		// 0x0000 (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};

// Function Core.ScriptStackObject.GetFullScriptTraceStringForRPC
// [0x00422400] ( FUNC_Native )
struct UScriptStackObject_execGetFullScriptTraceStringForRPC_Parms
{
	int                                                OutcomingRPCId;                                   		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FString                                     StackString;                                      		// 0x0004 (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
