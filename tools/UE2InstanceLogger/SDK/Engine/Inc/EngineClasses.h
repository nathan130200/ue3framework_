...
AUTOGENERATE_FUNCTION(AGameInfo,-1,execBrowseRelativeLocalURL);
AUTOGENERATE_FUNCTION(AGameInfo,-1,execExecuteWorldLogBatcher);
AUTOGENERATE_FUNCTION(AGameInfo,-1,execExecuteLocalLogBatcher);
