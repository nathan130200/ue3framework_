...
// Info
#define GAME_NAME				"Red Orchestra 2: Heroes of Stalingrad"
#define GAME_NAME_S				"RO2"
...
public:
	...
	class Object*			ObjectArchetype;                        // 0x0038 (0x04)
...
public:
	...
	public:
		...
		public:
			...
			unsigned char			UnknownData01[ 0x3C ];					// 0x0054 (0x3C)
		...
		public:
			...
			public:
				...
				unsigned char		UnknownData00[ 0x18 ];						// 0x0098 (0x18)
			...
			public:
				...
				{
				public:
					unsigned char			UnknownData00[ 0xF0 ];					// 0x00D8 (0xF0)
		...
		public:
			...
			{
			public:
				unsigned char			UnknownData00[ 0x8 ];						// 0x7C (0x08)
